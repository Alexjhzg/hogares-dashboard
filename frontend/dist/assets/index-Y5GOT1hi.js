...
import{_ as e,a as t,c as n,d as r,f as i,g as a,h as o,i as s,l as c,m as l,n as u,p as d,r as f,s as p,t as m,u as h,v as g,y as _}from"./core-VcZXWso8.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function v(e){return e.reduce((e,t)=>e+t,0)/e.length}function y(e){if(!e)return null;try{let t=String(e).trim().split(/\s+/);return t.length<2?null:[parseFloat(t[0]),parseFloat(t[1])]}catch{return null}}function b(e,t){if(!e||!t)return!1;let n=String(e).trim(),r=String(t).trim();return!!(n===r||n.padStart(3,`0`)===r.padStart(3,`0`)||n.endsWith(r)||r.endsWith(n))}var x,S=a((()=>{x=e=>document.getElementById(e)}));function C(e,t=`info`,n=2800){let r=w[t]||w.info,i=T[t]||T.info,a=document.createElement(`div`);a.className=[`fixed bottom-6 left-1/2 -translate-x-1/2 z-[999]`,`px-4 py-2.5 rounded-xl text-xs font-bold shadow-xl`,`text-white flex items-center gap-2 transition-opacity duration-300`,r].join(` `),a.setAttribute(`role`,`status`),a.setAttribute(`aria-live`,`polite`),a.innerHTML=`<span aria-hidden="true">${i}</span><span>${e}</span>`,document.body.appendChild(a),setTimeout(()=>{a.style.opacity=`0`,setTimeout(()=>a.remove(),300)},n)}var w,T,E=a((()=>{w={success:`bg-emerald-500`,warning:`bg-amber-500`,info:`bg-indigo-500`},T={success:`✓`,warning:`⚠`,info:`ℹ`}})),D=a((()=>{S(),E()}));function O(e){let t=x(`loadingOverlay`),n=x(`loadingMsg`);t&&(j&&=(clearTimeout(j),null),t.style.display=`flex`,setTimeout(()=>{t.style.opacity=`1`,t.style.pointerEvents=`all`},10),n&&(n.textContent=e))}function k(){let e=x(`loadingOverlay`);e&&(j&&clearTimeout(j),e.style.opacity=`0`,e.style.pointerEvents=`none`,j=setTimeout(()=>{e.style.display=`none`,j=null},500))}function A(e){let t=document.getElementById(`connectionStatus`),n=document.getElementById(`connectionDot`),r=document.getElementById(`connectionPing`);!t||!n||(e?(t.textContent=`Live Connection`,t.classList.remove(`text-amber-500`),t.classList.add(`text-emerald-400`),n.className=`relative inline-flex rounded-full h-2 w-2 bg-brand-emerald`,r&&(r.className=`animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-emerald opacity-75`)):(t.textContent=`Modo Offline - Datos Cacheados`,t.classList.remove(`text-emerald-400`,`text-slate-400`),t.classList.add(`text-amber-500`),n.className=`relative inline-flex rounded-full h-2 w-2 bg-amber-500`,r&&(r.className=`absolute inline-flex h-full w-full rounded-full bg-amber-500 opacity-20`)))}var j,M=a((()=>{D(),j=null})),N,P,F,I=a((()=>{N=`KoboDashboardDB`,P=`cacheStore`,F={async open(){return new Promise((e,t)=>{let n=indexedDB.open(N,1);n.onerror=()=>t(`Error opening DB`),n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(P)||t.createObjectStore(P)},n.onsuccess=t=>e(t.target.result)})},async get(e){try{let t=await this.open();return new Promise((n,r)=>{let i=t.transaction(P,`readonly`).objectStore(P).get(e);i.onsuccess=()=>n(i.result),i.onerror=()=>r(i.error)})}catch(e){return console.error(`IndexedDB Get Error:`,e),null}},async set(e,t){try{let n=await this.open();return new Promise((r,i)=>{let a=n.transaction(P,`readwrite`).objectStore(P).put(t,e);a.onsuccess=()=>r(),a.onerror=()=>i(a.error)})}catch(e){console.error(`IndexedDB Set Error:`,e)}}}}));async function R(){let e=await fetch(`/api/assets`);if(!e.ok)throw Error(`Error API (${e.status}) at fetchAssets`);return await e.json()}async function z(e,t=!1,n=``){if(!e)throw Error(`Missing UID in fetchSurveyData`);let r=new URLSearchParams;t&&r.set(`refresh`,`true`),n&&r.set(`next_uid`,n);let i=`/api/data/${e}${r.toString()?`?${r.toString()}`:``}`,a=await fetch(i);if(!a.ok)throw Error(`Error API (${a.status}) at fetchSurveyData`);return await a.json()}function ee(e){e&&fetch(`/api/prefetch/${e}`,{method:`POST`}).then(t=>{t.ok&&console.info(`[api/services] Prefetch scheduled → ${e}`)}).catch(t=>console.warn(`[api/services] Prefetch request failed → ${e}:`,t))}var te=a((()=>{m()}));async function ne(e){console.log(`api/index.js: Orchestrating loadAssets()...`),O(`Buscando formularios en KoboToolbox…`);let t=null;try{t=await R(),await F.set(`assets_cache`,t),A(!0)}catch(e){console.warn(`Network failure. Trying cache...`,e),t=await F.get(`assets_cache`),t&&A(!1)}if(!t){k(),x(`errorState`)&&(x(`errorState`).style.display=`flex`);let e=x(`statusBadge`);e&&(e.textContent=`Error de conexión`,e.classList.remove(`active`)),A(!1);return}let n=x(`assetSelect`);n&&(n.innerHTML=`<option value="">— Seleccionar encuesta —</option>`,t.forEach(e=>{let t=document.createElement(`option`);t.value=e.uid,t.textContent=e.name,n.appendChild(t)}),n.addEventListener(`change`,()=>{let e=n.options[n.selectedIndex];l.assetName=e?e.textContent.trim():``}));let r=x(`statusBadge`);r&&(r.textContent=`Formularios Listos`),window.lucide&&lucide.createIcons();let i=t.find(e=>e.name.toLowerCase().includes(`esca`)&&e.name.toLowerCase().includes(`v4`))||t.find(e=>e.name.toLowerCase().includes(`esca`)&&e.name.toLowerCase().includes(`v3`))||t[0];if(i){n&&(n.value=i.uid),l.assetName=i.name,e&&e(i.uid);let r=t.find(e=>e.uid!==i.uid);r&&ee(r.uid)}else k()}async function re(e,t,n=!1){if(!e)return;O(n?`Sincronizando con KoboToolbox…`:`Descargando datos desde el servidor…`);let r=x(`btnRefresh`);r&&(r.disabled=!0);let i=null,a=!1,o=x(`assetSelect`),s=o?[...o.options].map(e=>e.value).filter(Boolean):[],c=s.indexOf(e),u=c>=0&&c+1<s.length?s[c+1]:``;try{i=await z(e,n,u),await F.set(`data_cache_${e}`,i),A(!0)}catch(t){console.warn(`Network failure. Trying cache...`,t),n||(i=await F.get(`data_cache_${e}`),i&&(a=!0,A(!1)))}if(!i){alert(`Error: No se pudieron descargar los datos y no hay caché disponible.`),k(),r&&(r.disabled=!1);return}l.rawData=i.results||(Array.isArray(i)?i:[]),console.log(`api/index.js: Loaded ${l.rawData.length} records ${a?`(Offline Cache)`:``}`);let d=x(`statusBadge`);d&&(d.textContent=`${l.rawData.length} registros`),x(`errorState`)&&x(`errorState`).classList.add(`hidden`),x(`mainContent`)&&x(`mainContent`).classList.remove(`hidden`),O(`Renderizando dashboard...`),requestAnimationFrame(()=>{setTimeout(async()=>{t&&await t(),window.lucide&&lucide.createIcons(),requestAnimationFrame(()=>{setTimeout(()=>{k(),r&&(r.disabled=!1)},800)})},100)})}async function ie(){if(!l.planificacionData)try{let e=await fetch(`data/planificacion.json`);if(!e.ok)throw Error(`Error loading planificacion.json`);l.planificacionData=await e.json(),console.log(`api/index.js: Planned housing data loaded ✓`)}catch(e){console.error(`Failed to load planificacion.json:`,e)}}var ae=a((()=>{m(),D(),M(),I(),te(),window.loadAssets=()=>ne(e=>re(e,window.__onProcessData))}));function B(e,t,n=[],r=``){if(t&&e._backend_meta&&e._backend_meta[t]!=null&&e._backend_meta[t]!==``)return e._backend_meta[t];for(let t of n)if(e[t]!=null&&String(e[t]).trim()!==``)return e[t];return r}function oe(e){if(!e||typeof e!=`string`)return null;let t=e.match(/T(\d{2}):/);return t?parseInt(t[1],10):null}function se(e){if(!e||typeof e!=`string`)return null;let t=e.trim().split(` `);return t.length>=4?parseFloat(t[3]):null}function ce(e){let n=String(B(e,`cedula_encuestador`,[`S0/cedula_encuestador`,`v4_encuestador_cedula`,`cedula_encuestador`],`N/A`)).trim(),r=B(e,`nombre_encuestador`,[`S0/s0_nombreapellido`,`S0/_xm_s0_nombreapellido`,`_xm_cod_nom_y_ape`,`v4_encuestador_nombre`,`nombre_encuestador`]),i=r&&String(r).trim()&&String(r).trim().toLowerCase()!==`desconocido`?String(r).trim():t[n]||(n===`N/A`?`Desconocido`:`Encuestador ${n}`),a=e.start||``,o=e.end||``,s=B(e,``,[`ubicacion_final/hora_fin`,`ubicacion_final/hora_f`,`hora_f`]);s&&(o=!s.includes(`T`)&&a.includes(`T`)?`${a.split(`T`)[0]}T${s}`:s,e.end=o);let c=(e.today||e._submission_time||``).slice(0,10),u=(l.assetName||``).toUpperCase().includes(`EHM`)?`EHM`:`ESCA`,f=B(e,`control`,[`group_sh53u78/control`,`datos_mm111/control`]),p=B(e,`n_linea`,[`group_sh53u78/n_linea`,`datos_mm111/n_linea`]);if(!f&&e[`meta/instanceName`]){let t=String(e[`meta/instanceName`]).split(`-`);t.length>=4&&/^\d+$/.test(t[1])&&(f=t[1]),t.length>=4&&/^\d+$/.test(t[2])&&!p&&(p=t[2])}return f||=e._uuid||``,{cedula:n,nombre:i,start:a,end:o,fecha:c,hora:oe(a),hora_trans:oe(e._submission_time),formType:u,start_precision:se(e[`start-geopoint`]||e.start_geopoint),end_precision:se(e[`group_sh53u78/ubicacion_i`]||e[`end-geopoint`]),ent:B(e,`entidad`,[`S1/ent`,`datos_mm111/ent`]),mun:d(B(e,`municipio`,[`S1/mun`,`S1/S2/mun`])),par:B(e,`parroquia`,[`S1/par`,`S1/S2/par`]),nodo:B(e,`nodo`,[`S1/nodo`,`S1/S2/nodo`]),semana:B(e,`semana_raw`,[`group_sh53u78/semana`,`datos_mm111/semana`]),uso:e[`S1/Uso_de_la_Unidad_inmobiliaria`]||`N/A`,condicion:e[`Condici_n_de_ocupaci_n/condicion_de_ocupacion`]||`N/A`,control:f,lote:e[`group_sh53u78/lote`]||``,situacion_vivienda:e[`Condici_n_de_ocupaci_n/condicion_de_ocupacion`]===`ocupadas_con_ocupantes_ausentes`&&e[`Condici_n_de_ocupaci_n/situacion_vivienda`]===`otro_ausentes`?`otro_ausentes`:e[`Condici_n_de_ocupaci_n/vivienda_ocupada01`]||e[`Condici_n_de_ocupaci_n/situacion_vivienda`]||``,segmento:B(e,`segmento`,[`S1/segmento`,`S1/group_segmeto_sector/segmento`,`group_segmeto_sector/segmento`]),sector:B(e,`sector`,[`S1/sector`,`S1/group_segmeto_sector/sector`,`group_segmeto_sector/sector`]),manzana:B(e,`manzana`,[`S1/manzana`,`S1/S3/manzana`]),parcela:B(e,`parcela`,[`S1/parcela`,`S1/S3/parcela`]),edificacion:B(e,`edificacion`,[`S1/Edificaci_n`,`S1/edificacion`,`S1/S3/edificacion`]),lado_manz:B(e,`lado_manz`,[`S1/lado_manz`,`S1/S3/lado_manz`]),n_linea:p,n_serie:B(e,`n_serie`,[`group_sh53u78/n_serie`]),direccion:B(e,`nombre_sector`,[`S1/P_nomsect`,`S1/S3/sector_1`,`S1/S3/GP10_0b`,`S1/direccion`]),nota:e[`ubicacion_final/nota`]||``,residente:B(e,``,[`control_entrevista/nombre_informante`,`control_de_la_entrevista/nombre_informante`],`-`),observaciones:e[`ubicacion_final/observaciones`]||`-`,fecha_entrevista:e[`ubicacion_final/fecha_entrevista_1`]||c,descripcion:B(e,``,[`control_de_la_entrevista/in11`,`control_entrevista/in11`],`-`),nroCasa:B(e,``,[`control_de_la_entrevista/in10`,`control_entrevista/in10`],`-`)}}function le(e,t){if(!e||!t)return null;try{let n=new Date(e),r=new Date(t),i=Math.round((r-n)/6e4*10)/10;return i>=0&&i<=600?i:null}catch{return null}}var ue=a((()=>{m()}));function de(e,t){let n=0,r=0,i=0,a=Array.isArray(e.lista_hogar)?e.lista_hogar:Array.isArray(e[`datos_hogar/hogar`])?e[`datos_hogar/hogar`]:[];return a.forEach(e=>{let t=Array.isArray(e[`lista_hogar/lista_miembros`])?e[`lista_hogar/lista_miembros`]:Array.isArray(e[`datos_hogar/hogar/integrantes_hogar`])?e[`datos_hogar/hogar/integrantes_hogar`]:[];if(t.length>0)n+=t.length;else{let t=parseInt(e[`lista_hogar/personas_hogar`]||e[`lista_hogar/lista_miembros_count`]||e[`datos_hogar/hogar/integrantes_hogar_count`]||`0`,10);isNaN(t)||(n+=t)}t.forEach(e=>{let{hCount:t,mCount:n}=fe(e);r+=t,i+=n})}),{totalPers:n,totalHombres:r,totalMujeres:i,hogaresCount:a.length,hogaresRaw:a}}function fe(e){let t=0,n=0,r=Object.keys(e).find(e=>e.endsWith(`/sexo`)||e.endsWith(`:sexo`)||e===`sexo`||e.endsWith(`/C2`));if(r){let i=String(e[r]).trim().toLowerCase();[`1`,`sexo1`,`v`,`m`,`masculino`,`hombre`].includes(i)&&(t=1),[`2`,`sexo2`,`h`,`f`,`femenino`,`mujer`].includes(i)&&(n=1)}return{hCount:t,mCount:n}}var pe=a((()=>{}));function me(e){let t=y(e[`ubicacion_final/ubicacion_f`]||e.ubicacion_f),n=y(e[`group_sh53u78/ubicacion_i`]||e.ubicacion_i),r=null,i=null;if(n&&n[0])r=n[0],i=n[1];else if(t&&t[0])r=t[0],i=t[1];else if(e._geolocation&&e._geolocation.length>=2)r=e._geolocation[0],i=e._geolocation[1];else if(e[`S1/ubicacion`]){let t=e[`S1/ubicacion`].split(` `);t.length>=2&&(r=parseFloat(t[0]),i=parseFloat(t[1]))}return{lat:r,lng:i,ptIni:n,ptFin:t}}var he=a((()=>{D()}));function ge(e,t,n={}){let r={type:`Feature`};return(n.id===0||n.id)&&(r.id=n.id),n.bbox&&(r.bbox=n.bbox),r.properties=t||{},r.geometry=e,r}function V(e,t,n={}){if(!e)throw Error(`coordinates is required`);if(!Array.isArray(e))throw Error(`coordinates must be an Array`);if(e.length<2)throw Error(`coordinates must be at least 2 numbers long`);if(!Se(e[0])||!Se(e[1]))throw Error(`coordinates must contain numbers`);return ge({type:`Point`,coordinates:e},t,n)}function _e(e,t,n={}){for(let t of e){if(t.length<4)throw Error(`Each LinearRing of a Polygon must have 4 or more Positions.`);if(t[t.length-1].length!==t[0].length)throw Error(`First and last Position are not equivalent.`);for(let e=0;e<t[t.length-1].length;e++)if(t[t.length-1][e]!==t[0][e])throw Error(`First and last Position are not equivalent.`)}return ge({type:`Polygon`,coordinates:e},t,n)}function ve(e,t,n={}){if(e.length<2)throw Error(`coordinates must be an array of two or more positions`);return ge({type:`LineString`,coordinates:e},t,n)}function ye(e,t={}){let n={type:`FeatureCollection`};return t.id&&(n.id=t.id),t.bbox&&(n.bbox=t.bbox),n.features=e,n}function be(e,t=`kilometers`){let n=we[t];if(!n)throw Error(t+` units is invalid`);return e*n}function xe(e){return e%360*Math.PI/180}function Se(e){return!isNaN(e)&&e!==null&&!Array.isArray(e)}function Ce(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}var H,we,Te=a((()=>{H=6371008.8,we={centimeters:H*100,centimetres:H*100,degrees:360/(2*Math.PI),feet:H*3.28084,inches:H*39.37,kilometers:H/1e3,kilometres:H/1e3,meters:H,metres:H,miles:H/1609.344,millimeters:H*1e3,millimetres:H*1e3,nauticalmiles:H/1852,radians:1,yards:H*1.0936}}));function Ee(e){if(!e)throw Error(`coord is required`);if(!Array.isArray(e)){if(e.type===`Feature`&&e.geometry!==null&&e.geometry.type===`Point`)return[...e.geometry.coordinates];if(e.type===`Point`)return[...e.coordinates]}if(Array.isArray(e)&&e.length>=2&&!Array.isArray(e[0])&&!Array.isArray(e[1]))return[...e];throw Error(`coord must be GeoJSON Point or an Array of numbers`)}function De(e){if(Array.isArray(e))return e;if(e.type===`Feature`){if(e.geometry!==null)return e.geometry.coordinates}else if(e.coordinates)return e.coordinates;throw Error(`coords must be GeoJSON Feature, Geometry Object or an Array`)}function Oe(e){return e.type===`Feature`?e.geometry:e}function ke(e,t){return e.type===`FeatureCollection`?`FeatureCollection`:e.type===`GeometryCollection`?`GeometryCollection`:e.type===`Feature`&&e.geometry!==null?e.geometry.type:e.type}var Ae=a((()=>{}));function je(e,t,n={}){var r=Ee(e),i=Ee(t),a=xe(i[1]-r[1]),o=xe(i[0]-r[0]),s=xe(r[1]),c=xe(i[1]),l=Math.sin(a/2)**2+Math.sin(o/2)**2*Math.cos(s)*Math.cos(c);return be(2*Math.atan2(Math.sqrt(l),Math.sqrt(1-l)),n.units)}var Me=a((()=>{Ae(),Te()}));function Ne(e,t,n){if(e!==null)for(var r,i,a,o,s,c,l,u=0,d=0,f,p=e.type,m=p===`FeatureCollection`,h=p===`Feature`,g=m?e.features.length:1,_=0;_<g;_++){l=m?e.features[_].geometry:h?e.geometry:e,f=l?l.type===`GeometryCollection`:!1,s=f?l.geometries.length:1;for(var v=0;v<s;v++){var y=0,b=0;if(o=f?l.geometries[v]:l,o!==null){c=o.coordinates;var x=o.type;switch(u=n&&(x===`Polygon`||x===`MultiPolygon`)?1:0,x){case null:break;case`Point`:if(t(c,d,_,y,b)===!1)return!1;d++,y++;break;case`LineString`:case`MultiPoint`:for(r=0;r<c.length;r++){if(t(c[r],d,_,y,b)===!1)return!1;d++,x===`MultiPoint`&&y++}x===`LineString`&&y++;break;case`Polygon`:case`MultiLineString`:for(r=0;r<c.length;r++){for(i=0;i<c[r].length-u;i++){if(t(c[r][i],d,_,y,b)===!1)return!1;d++}x===`MultiLineString`&&y++,x===`Polygon`&&b++}x===`Polygon`&&y++;break;case`MultiPolygon`:for(r=0;r<c.length;r++){for(b=0,i=0;i<c[r].length;i++){for(a=0;a<c[r][i].length-u;a++){if(t(c[r][i][a],d,_,y,b)===!1)return!1;d++}b++}y++}break;case`GeometryCollection`:for(r=0;r<o.geometries.length;r++)if(Ne(o.geometries[r],t,n)===!1)return!1;break;default:throw Error(`Unknown Geometry Type`)}}}}}function Pe(e,t){var n,r,i,a,o,s,c,l,u,d,f=0,p=e.type===`FeatureCollection`,m=e.type===`Feature`,h=p?e.features.length:1;for(n=0;n<h;n++){for(s=p?e.features[n].geometry:m?e.geometry:e,l=p?e.features[n].properties:m?e.properties:{},u=p?e.features[n].bbox:m?e.bbox:void 0,d=p?e.features[n].id:m?e.id:void 0,c=s?s.type===`GeometryCollection`:!1,o=c?s.geometries.length:1,i=0;i<o;i++){if(a=c?s.geometries[i]:s,a===null){if(t(null,f,l,u,d)===!1)return!1;continue}switch(a.type){case`Point`:case`LineString`:case`MultiPoint`:case`Polygon`:case`MultiLineString`:case`MultiPolygon`:if(t(a,f,l,u,d)===!1)return!1;break;case`GeometryCollection`:for(r=0;r<a.geometries.length;r++)if(t(a.geometries[r],f,l,u,d)===!1)return!1;break;default:throw Error(`Unknown Geometry Type`)}}f++}}function Fe(e,t,n){var r=n;return Pe(e,function(e,i,a,o,s){r=i===0&&n===void 0?e:t(r,e,i,a,o,s)}),r}var Ie=a((()=>{}));function Le(e){return Fe(e,(e,t)=>e+Re(t),0)}function Re(e){let t=0,n;switch(e.type){case`Polygon`:return ze(e.coordinates);case`MultiPolygon`:for(n=0;n<e.coordinates.length;n++)t+=ze(e.coordinates[n]);return t;case`Point`:case`MultiPoint`:case`LineString`:case`MultiLineString`:return 0}return 0}function ze(e){let t=0;if(e&&e.length>0){t+=Math.abs(Be(e[0]));for(let n=1;n<e.length;n++)t-=Math.abs(Be(e[n]))}return t}function Be(e){let t=e.length-1;if(t<=2)return 0;let n=0,r=0;for(;r<t;){let i=e[r],a=e[r+1===t?0:r+1],o=e[r+2>=t?(r+2)%t:r+2],s=i[0]*He,c=a[1]*He,l=o[0]*He;n+=(l-s)*Math.sin(c),r++}return n*Ve}var Ve,He,Ue=a((()=>{Te(),Ie(),Ve=H*H/2,He=Math.PI/180}));function We(e,t,n,r,i){let a,o,s,c,l=t[0],u=r[0],d=0,f=0;u>l==u>-l?(a=l,l=t[++d]):(a=u,u=r[++f]);let p=0;if(d<e&&f<n)for(u>l==u>-l?(o=l+a,s=a-(o-l),l=t[++d]):(o=u+a,s=a-(o-u),u=r[++f]),a=o,s!==0&&(i[p++]=s);d<e&&f<n;)u>l==u>-l?(o=a+l,c=o-a,s=a-(o-c)+(l-c),l=t[++d]):(o=a+u,c=o-a,s=a-(o-c)+(u-c),u=r[++f]),a=o,s!==0&&(i[p++]=s);for(;d<e;)o=a+l,c=o-a,s=a-(o-c)+(l-c),l=t[++d],a=o,s!==0&&(i[p++]=s);for(;f<n;)o=a+u,c=o-a,s=a-(o-c)+(u-c),u=r[++f],a=o,s!==0&&(i[p++]=s);return(a!==0||p===0)&&(i[p++]=a),p}function Ge(e,t){let n=t[0];for(let r=1;r<e;r++)n+=t[r];return n}function U(e){return new Float64Array(e)}var W,G,Ke,qe=a((()=>{W=11102230246251565e-32,G=134217729,Ke=(3+8*W)*W}));function Je(e,t,n,r,i,a,o){let s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T=e-i,E=n-i,D=t-a,O=r-a;b=T*O,f=G*T,p=f-(f-T),m=T-p,f=G*O,h=f-(f-O),g=O-h,x=m*g-(b-p*h-m*h-p*g),S=D*E,f=G*D,p=f-(f-D),m=D-p,f=G*E,h=f-(f-E),g=E-h,C=m*g-(S-p*h-m*h-p*g),_=x-C,d=x-_,K[0]=x-(_+d)+(d-C),v=b+_,d=v-b,y=b-(v-d)+(_-d),_=y-S,d=y-_,K[1]=y-(_+d)+(d-S),w=v+_,d=w-v,K[2]=v-(w-d)+(_-d),K[3]=w;let k=Ge(4,K),A=Ze*o;if(k>=A||-k>=A||(d=e-T,s=e-(T+d)+(d-i),d=n-E,l=n-(E+d)+(d-i),d=t-D,c=t-(D+d)+(d-a),d=r-O,u=r-(O+d)+(d-a),s===0&&c===0&&l===0&&u===0)||(A=Qe*o+Ke*Math.abs(k),k+=T*u+O*s-(D*l+E*c),k>=A||-k>=A))return k;b=s*O,f=G*s,p=f-(f-s),m=s-p,f=G*O,h=f-(f-O),g=O-h,x=m*g-(b-p*h-m*h-p*g),S=c*E,f=G*c,p=f-(f-c),m=c-p,f=G*E,h=f-(f-E),g=E-h,C=m*g-(S-p*h-m*h-p*g),_=x-C,d=x-_,q[0]=x-(_+d)+(d-C),v=b+_,d=v-b,y=b-(v-d)+(_-d),_=y-S,d=y-_,q[1]=y-(_+d)+(d-S),w=v+_,d=w-v,q[2]=v-(w-d)+(_-d),q[3]=w;let j=We(4,K,4,q,$e);b=T*u,f=G*T,p=f-(f-T),m=T-p,f=G*u,h=f-(f-u),g=u-h,x=m*g-(b-p*h-m*h-p*g),S=D*l,f=G*D,p=f-(f-D),m=D-p,f=G*l,h=f-(f-l),g=l-h,C=m*g-(S-p*h-m*h-p*g),_=x-C,d=x-_,q[0]=x-(_+d)+(d-C),v=b+_,d=v-b,y=b-(v-d)+(_-d),_=y-S,d=y-_,q[1]=y-(_+d)+(d-S),w=v+_,d=w-v,q[2]=v-(w-d)+(_-d),q[3]=w;let M=We(j,$e,4,q,et);return b=s*u,f=G*s,p=f-(f-s),m=s-p,f=G*u,h=f-(f-u),g=u-h,x=m*g-(b-p*h-m*h-p*g),S=c*l,f=G*c,p=f-(f-c),m=c-p,f=G*l,h=f-(f-l),g=l-h,C=m*g-(S-p*h-m*h-p*g),_=x-C,d=x-_,q[0]=x-(_+d)+(d-C),v=b+_,d=v-b,y=b-(v-d)+(_-d),_=y-S,d=y-_,q[1]=y-(_+d)+(d-S),w=v+_,d=w-v,q[2]=v-(w-d)+(_-d),q[3]=w,tt[We(M,et,4,q,tt)-1]}function Ye(e,t,n,r,i,a){let o=(t-a)*(n-i),s=(e-i)*(r-a),c=o-s,l=Math.abs(o+s);return Math.abs(c)>=Xe*l?c:-Je(e,t,n,r,i,a,l)}var Xe,Ze,Qe,K,$e,et,tt,q,nt=a((()=>{qe(),Xe=(3+16*W)*W,Ze=(2+12*W)*W,Qe=(9+64*W)*W*W,K=U(4),$e=U(8),et=U(12),tt=U(16),q=U(4)})),rt=a((()=>{qe(),(7+56*W)*W,(3+28*W)*W,(26+288*W)*W*W,U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(8),U(8),U(8),U(4),U(8),U(8),U(16),U(12),U(192),U(192)})),it=a((()=>{qe(),(10+96*W)*W,(4+48*W)*W,(44+576*W)*W*W,U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(8),U(8),U(8),U(8),U(8),U(8),U(8),U(8),U(8),U(4),U(4),U(4),U(8),U(16),U(16),U(16),U(32),U(32),U(48),U(64),U(1152),U(1152)})),at=a((()=>{qe(),(16+224*W)*W,(5+72*W)*W,(71+1408*W)*W*W,U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(4),U(24),U(24),U(24),U(24),U(24),U(24),U(24),U(24),U(24),U(24),U(1152),U(1152),U(1152),U(1152),U(1152),U(2304),U(2304),U(3456),U(5760),U(8),U(8),U(8),U(16),U(24),U(48),U(48),U(96),U(192),U(384),U(384),U(384),U(768),U(96),U(96),U(96),U(1152)})),ot=a((()=>{nt(),rt(),it(),at()}));function st(e,t){var n,r,i=0,a,o,s,c,l,u,d,f=e[0],p=e[1],m=t.length;for(n=0;n<m;n++){r=0;var h=t[n],g=h.length-1;if(u=h[0],u[0]!==h[g][0]&&u[1]!==h[g][1])throw Error(`First and last coordinates in a ring must be the same`);for(o=u[0]-f,s=u[1]-p;r<g;r++){if(d=h[r+1],c=d[0]-f,l=d[1]-p,s===0&&l===0){if(c<=0&&o>=0||o<=0&&c>=0)return 0}else if(l>=0&&s<=0||l<=0&&s>=0){if(a=Ye(o,c,s,l,0,0),a===0)return 0;(a>0&&l>0&&s<=0||a<0&&l<=0&&s>0)&&i++}u=d,s=l,o=c}}return i%2!=0}var ct=a((()=>{ot()}));function lt(e,t,n={}){if(!e)throw Error(`point is required`);if(!t)throw Error(`polygon is required`);let r=Ee(e),i=Oe(t),a=i.type,o=t.bbox,s=i.coordinates;if(o&&ut(r,o)===!1)return!1;a===`Polygon`&&(s=[s]);let c=!1;for(var l=0;l<s.length;++l){let e=st(r,s[l]);if(e===0)return!n.ignoreBoundary;e&&(c=!0)}return c}function ut(e,t){return t[0]<=e[0]&&t[1]<=e[1]&&t[2]>=e[0]&&t[3]>=e[1]}var dt=a((()=>{ct(),Ae()}));function ft(e,t,n={}){let r=Ee(e),i=De(t);for(let e=0;e<i.length-1;e++){let t=!1;if(n.ignoreEndVertices&&(e===0&&(t=`start`),e===i.length-2&&(t=`end`),e===0&&e+1===i.length-1&&(t=`both`)),pt(i[e],i[e+1],r,t,n.epsilon===void 0?null:n.epsilon))return!0}return!1}function pt(e,t,n,r,i){let a=n[0],o=n[1],s=e[0],c=e[1],l=t[0],u=t[1],d=n[0]-s,f=n[1]-c,p=l-s,m=u-c,h=d*m-f*p;if(i!==null){if(Math.abs(h)>i)return!1}else if(h!==0)return!1;return Math.abs(p)===Math.abs(m)&&Math.abs(p)===0?r?!1:n[0]===e[0]&&n[1]===e[1]:r?r===`start`?Math.abs(p)>=Math.abs(m)?p>0?s<a&&a<=l:l<=a&&a<s:m>0?c<o&&o<=u:u<=o&&o<c:r===`end`?Math.abs(p)>=Math.abs(m)?p>0?s<=a&&a<l:l<a&&a<=s:m>0?c<=o&&o<u:u<o&&o<=c:r===`both`?Math.abs(p)>=Math.abs(m)?p>0?s<a&&a<l:l<a&&a<s:m>0?c<o&&o<u:u<o&&o<c:!1:Math.abs(p)>=Math.abs(m)?p>0?s<=a&&a<=l:l<=a&&a<=s:m>0?c<=o&&o<=u:u<=o&&o<=c}var mt=a((()=>{Ae()})),ht=o(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self).RBush=r()})(e,function(){function e(e,r,i,a,o){(function e(n,r,i,a,o){for(;a>i;){if(a-i>600){var s=a-i+1,c=r-i+1,l=Math.log(s),u=.5*Math.exp(2*l/3),d=.5*Math.sqrt(l*u*(s-u)/s)*(c-s/2<0?-1:1);e(n,r,Math.max(i,Math.floor(r-c*u/s+d)),Math.min(a,Math.floor(r+(s-c)*u/s+d)),o)}var f=n[r],p=i,m=a;for(t(n,i,r),o(n[a],f)>0&&t(n,i,a);p<m;){for(t(n,p,m),p++,m--;o(n[p],f)<0;)p++;for(;o(n[m],f)>0;)m--}o(n[i],f)===0?t(n,i,m):t(n,++m,a),m<=r&&(i=m+1),r<=m&&(a=m-1)}})(e,r,i||0,a||e.length-1,o||n)}function t(e,t,n){var r=e[t];e[t]=e[n],e[n]=r}function n(e,t){return e<t?-1:+(e>t)}var r=function(e){e===void 0&&(e=9),this._maxEntries=Math.max(4,e),this._minEntries=Math.max(2,Math.ceil(.4*this._maxEntries)),this.clear()};function i(e,t,n){if(!n)return t.indexOf(e);for(var r=0;r<t.length;r++)if(n(e,t[r]))return r;return-1}function a(e,t){o(e,0,e.children.length,t,e)}function o(e,t,n,r,i){i||=m(null),i.minX=1/0,i.minY=1/0,i.maxX=-1/0,i.maxY=-1/0;for(var a=t;a<n;a++){var o=e.children[a];s(i,e.leaf?r(o):o)}return i}function s(e,t){return e.minX=Math.min(e.minX,t.minX),e.minY=Math.min(e.minY,t.minY),e.maxX=Math.max(e.maxX,t.maxX),e.maxY=Math.max(e.maxY,t.maxY),e}function c(e,t){return e.minX-t.minX}function l(e,t){return e.minY-t.minY}function u(e){return(e.maxX-e.minX)*(e.maxY-e.minY)}function d(e){return e.maxX-e.minX+(e.maxY-e.minY)}function f(e,t){return e.minX<=t.minX&&e.minY<=t.minY&&t.maxX<=e.maxX&&t.maxY<=e.maxY}function p(e,t){return t.minX<=e.maxX&&t.minY<=e.maxY&&t.maxX>=e.minX&&t.maxY>=e.minY}function m(e){return{children:e,height:1,leaf:!0,minX:1/0,minY:1/0,maxX:-1/0,maxY:-1/0}}function h(t,n,r,i,a){for(var o=[n,r];o.length;)if(!((r=o.pop())-(n=o.pop())<=i)){var s=n+Math.ceil((r-n)/i/2)*i;e(t,s,n,r,a),o.push(n,s,s,r)}}return r.prototype.all=function(){return this._all(this.data,[])},r.prototype.search=function(e){var t=this.data,n=[];if(!p(e,t))return n;for(var r=this.toBBox,i=[];t;){for(var a=0;a<t.children.length;a++){var o=t.children[a],s=t.leaf?r(o):o;p(e,s)&&(t.leaf?n.push(o):f(e,s)?this._all(o,n):i.push(o))}t=i.pop()}return n},r.prototype.collides=function(e){var t=this.data;if(!p(e,t))return!1;for(var n=[];t;){for(var r=0;r<t.children.length;r++){var i=t.children[r],a=t.leaf?this.toBBox(i):i;if(p(e,a)){if(t.leaf||f(e,a))return!0;n.push(i)}}t=n.pop()}return!1},r.prototype.load=function(e){if(!e||!e.length)return this;if(e.length<this._minEntries){for(var t=0;t<e.length;t++)this.insert(e[t]);return this}var n=this._build(e.slice(),0,e.length-1,0);if(this.data.children.length)if(this.data.height===n.height)this._splitRoot(this.data,n);else{if(this.data.height<n.height){var r=this.data;this.data=n,n=r}this._insert(n,this.data.height-n.height-1,!0)}else this.data=n;return this},r.prototype.insert=function(e){return e&&this._insert(e,this.data.height-1),this},r.prototype.clear=function(){return this.data=m([]),this},r.prototype.remove=function(e,t){if(!e)return this;for(var n,r,a,o=this.data,s=this.toBBox(e),c=[],l=[];o||c.length;){if(o||(o=c.pop(),r=c[c.length-1],n=l.pop(),a=!0),o.leaf){var u=i(e,o.children,t);if(u!==-1)return o.children.splice(u,1),c.push(o),this._condense(c),this}a||o.leaf||!f(o,s)?r?(n++,o=r.children[n],a=!1):o=null:(c.push(o),l.push(n),n=0,r=o,o=o.children[0])}return this},r.prototype.toBBox=function(e){return e},r.prototype.compareMinX=function(e,t){return e.minX-t.minX},r.prototype.compareMinY=function(e,t){return e.minY-t.minY},r.prototype.toJSON=function(){return this.data},r.prototype.fromJSON=function(e){return this.data=e,this},r.prototype._all=function(e,t){for(var n=[];e;)e.leaf?t.push.apply(t,e.children):n.push.apply(n,e.children),e=n.pop();return t},r.prototype._build=function(e,t,n,r){var i,o=n-t+1,s=this._maxEntries;if(o<=s)return a(i=m(e.slice(t,n+1)),this.toBBox),i;r||(r=Math.ceil(Math.log(o)/Math.log(s)),s=Math.ceil(o/s**(r-1))),(i=m([])).leaf=!1,i.height=r;var c=Math.ceil(o/s),l=c*Math.ceil(Math.sqrt(s));h(e,t,n,l,this.compareMinX);for(var u=t;u<=n;u+=l){var d=Math.min(u+l-1,n);h(e,u,d,c,this.compareMinY);for(var f=u;f<=d;f+=c){var p=Math.min(f+c-1,d);i.children.push(this._build(e,f,p,r-1))}}return a(i,this.toBBox),i},r.prototype._chooseSubtree=function(e,t,n,r){for(;r.push(t),!t.leaf&&r.length-1!==n;){for(var i=1/0,a=1/0,o=void 0,s=0;s<t.children.length;s++){var c=t.children[s],l=u(c),d=(f=e,p=c,(Math.max(p.maxX,f.maxX)-Math.min(p.minX,f.minX))*(Math.max(p.maxY,f.maxY)-Math.min(p.minY,f.minY))-l);d<a?(a=d,i=l<i?l:i,o=c):d===a&&l<i&&(i=l,o=c)}t=o||t.children[0]}var f,p;return t},r.prototype._insert=function(e,t,n){var r=n?e:this.toBBox(e),i=[],a=this._chooseSubtree(r,this.data,t,i);for(a.children.push(e),s(a,r);t>=0&&i[t].children.length>this._maxEntries;)this._split(i,t),t--;this._adjustParentBBoxes(r,i,t)},r.prototype._split=function(e,t){var n=e[t],r=n.children.length,i=this._minEntries;this._chooseSplitAxis(n,i,r);var o=this._chooseSplitIndex(n,i,r),s=m(n.children.splice(o,n.children.length-o));s.height=n.height,s.leaf=n.leaf,a(n,this.toBBox),a(s,this.toBBox),t?e[t-1].children.push(s):this._splitRoot(n,s)},r.prototype._splitRoot=function(e,t){this.data=m([e,t]),this.data.height=e.height+1,this.data.leaf=!1,a(this.data,this.toBBox)},r.prototype._chooseSplitIndex=function(e,t,n){for(var r,i,a,s,c,l,d,f=1/0,p=1/0,m=t;m<=n-t;m++){var h=o(e,0,m,this.toBBox),g=o(e,m,n,this.toBBox),_=(i=h,a=g,s=void 0,c=void 0,l=void 0,d=void 0,s=Math.max(i.minX,a.minX),c=Math.max(i.minY,a.minY),l=Math.min(i.maxX,a.maxX),d=Math.min(i.maxY,a.maxY),Math.max(0,l-s)*Math.max(0,d-c)),v=u(h)+u(g);_<f?(f=_,r=m,p=v<p?v:p):_===f&&v<p&&(p=v,r=m)}return r||n-t},r.prototype._chooseSplitAxis=function(e,t,n){var r=e.leaf?this.compareMinX:c,i=e.leaf?this.compareMinY:l;this._allDistMargin(e,t,n,r)<this._allDistMargin(e,t,n,i)&&e.children.sort(r)},r.prototype._allDistMargin=function(e,t,n,r){e.children.sort(r);for(var i=this.toBBox,a=o(e,0,t,i),c=o(e,n-t,n,i),l=d(a)+d(c),u=t;u<n-t;u++){var f=e.children[u];s(a,e.leaf?i(f):f),l+=d(a)}for(var p=n-t-1;p>=t;p--){var m=e.children[p];s(c,e.leaf?i(m):m),l+=d(c)}return l},r.prototype._adjustParentBBoxes=function(e,t,n){for(var r=n;r>=0;r--)s(t[r],e)},r.prototype._condense=function(e){for(var t=e.length-1,n=void 0;t>=0;t--)e[t].children.length===0?t>0?(n=e[t-1].children).splice(n.indexOf(e[t]),1):this.clear():a(e[t],this.toBBox)},r})}));function gt(e,t={}){var n=typeof t==`object`?t.mutate:t;if(!e)throw Error(`geojson is required`);var r=ke(e),i=[];switch(r){case`LineString`:i=_t(e,r);break;case`MultiLineString`:case`Polygon`:De(e).forEach(function(e){i.push(_t(e,r))});break;case`MultiPolygon`:De(e).forEach(function(e){var t=[];e.forEach(function(e){t.push(_t(e,r))}),i.push(t)});break;case`Point`:return e;case`MultiPoint`:var a={};De(e).forEach(function(e){var t=e.join(`-`);Object.prototype.hasOwnProperty.call(a,t)||(i.push(e),a[t]=!0)});break;default:throw Error(r+` geometry not supported`)}return e.coordinates?n===!0?(e.coordinates=i,e):{type:r,coordinates:i}:n===!0?(e.geometry.coordinates=i,e):ge({type:r,coordinates:i},e.properties,{bbox:e.bbox,id:e.id})}function _t(e,t){let n=De(e);if(n.length===2&&!vt(n[0],n[1]))return n;let r=[],i=0,a=1,o=2;for(r.push(n[i]);o<n.length;)ft(n[a],ve([n[i],n[o]]))?a=o:(r.push(n[a]),i=a,a++,o=a),o++;if(r.push(n[a]),t===`Polygon`||t===`MultiPolygon`){if(ft(r[0],ve([r[1],r[r.length-2]]))&&(r.shift(),r.pop(),r.push(r[0])),r.length<4)throw Error(`invalid polygon, fewer than 4 points`);if(!vt(r[0],r[r.length-1]))throw Error(`invalid polygon, first and last points not equal`)}return r}function vt(e,t){return e[0]===t[0]&&e[1]===t[1]}var yt=a((()=>{Te(),Ae(),mt()})),bt=e({default:()=>St});function xt(e,t){return e<t?-1:+(e>t)}var St,Ct=a((()=>{St=class{constructor(e=[],t=xt){if(this.data=e,this.length=this.data.length,this.compare=t,this.length>0)for(let e=(this.length>>1)-1;e>=0;e--)this._down(e)}push(e){this.data.push(e),this.length++,this._up(this.length-1)}pop(){if(this.length===0)return;let e=this.data[0],t=this.data.pop();return this.length--,this.length>0&&(this.data[0]=t,this._down(0)),e}peek(){return this.data[0]}_up(e){let{data:t,compare:n}=this,r=t[e];for(;e>0;){let i=e-1>>1,a=t[i];if(n(r,a)>=0)break;t[e]=a,e=i}t[e]=r}_down(e){let{data:t,compare:n}=this,r=this.length>>1,i=t[e];for(;e<r;){let r=(e<<1)+1,a=t[r],o=r+1;if(o<this.length&&n(t[o],a)<0&&(r=o,a=t[o]),n(a,i)>=0)break;t[e]=a,e=r}t[e]=i}}})),wt=o(((e,t)=>{t.exports=function(e,t,n,r){var i=e[0],a=e[1],o=!1;n===void 0&&(n=0),r===void 0&&(r=t.length);for(var s=(r-n)/2,c=0,l=s-1;c<s;l=c++){var u=t[n+c*2+0],d=t[n+c*2+1],f=t[n+l*2+0],p=t[n+l*2+1];d>a!=p>a&&i<(f-u)*(a-d)/(p-d)+u&&(o=!o)}return o}})),Tt=o(((e,t)=>{t.exports=function(e,t,n,r){var i=e[0],a=e[1],o=!1;n===void 0&&(n=0),r===void 0&&(r=t.length);for(var s=r-n,c=0,l=s-1;c<s;l=c++){var u=t[c+n][0],d=t[c+n][1],f=t[l+n][0],p=t[l+n][1];d>a!=p>a&&i<(f-u)*(a-d)/(p-d)+u&&(o=!o)}return o}})),Et=o(((e,t)=>{var n=wt(),r=Tt();t.exports=function(e,t,i,a){return t.length>0&&Array.isArray(t[0])?r(e,t,i,a):n(e,t,i,a)},t.exports.nested=r,t.exports.flat=n})),Dt=o(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?r(e):typeof define==`function`&&define.amd?define([`exports`],r):r((n||=self).predicates={})})(e,function(e){let t=134217729;function n(e,t,n,r,i){let a,o,s,c,l=t[0],u=r[0],d=0,f=0;u>l==u>-l?(a=l,l=t[++d]):(a=u,u=r[++f]);let p=0;if(d<e&&f<n)for(u>l==u>-l?(s=a-((o=l+a)-l),l=t[++d]):(s=a-((o=u+a)-u),u=r[++f]),a=o,s!==0&&(i[p++]=s);d<e&&f<n;)u>l==u>-l?(s=a-((o=a+l)-(c=o-a))+(l-c),l=t[++d]):(s=a-((o=a+u)-(c=o-a))+(u-c),u=r[++f]),a=o,s!==0&&(i[p++]=s);for(;d<e;)s=a-((o=a+l)-(c=o-a))+(l-c),l=t[++d],a=o,s!==0&&(i[p++]=s);for(;f<n;)s=a-((o=a+u)-(c=o-a))+(u-c),u=r[++f],a=o,s!==0&&(i[p++]=s);return a===0&&p!==0||(i[p++]=a),p}function r(e){return new Float64Array(e)}let i=r(4),a=r(8),o=r(12),s=r(16),c=r(4);e.orient2d=function(e,r,l,u,d,f){let p=(r-f)*(l-d),m=(e-d)*(u-f),h=p-m;if(p===0||m===0||p>0!=m>0)return h;let g=Math.abs(p+m);return Math.abs(h)>=33306690738754716e-32*g?h:-function(e,r,l,u,d,f,p){let m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M=e-d,N=l-d,P=r-f,F=u-f;v=(O=(x=M-(b=(y=t*M)-(y-M)))*(C=F-(S=(y=t*F)-(y-F)))-((D=M*F)-b*S-x*S-b*C))-(w=O-(A=(x=P-(b=(y=t*P)-(y-P)))*(C=N-(S=(y=t*N)-(y-N)))-((k=P*N)-b*S-x*S-b*C))),i[0]=O-(w+v)+(v-A),v=(E=D-((T=D+w)-(v=T-D))+(w-v))-(w=E-k),i[1]=E-(w+v)+(v-k),v=(j=T+w)-T,i[2]=T-(j-v)+(w-v),i[3]=j;let I=function(e,t){let n=t[0];for(let r=1;r<e;r++)n+=t[r];return n}(4,i),R=22204460492503146e-32*p;if(I>=R||-I>=R||(m=e-(M+(v=e-M))+(v-d),g=l-(N+(v=l-N))+(v-d),h=r-(P+(v=r-P))+(v-f),_=u-(F+(v=u-F))+(v-f),m===0&&h===0&&g===0&&_===0)||(R=11093356479670487e-47*p+33306690738754706e-32*Math.abs(I),(I+=M*_+F*m-(P*g+N*h))>=R||-I>=R))return I;v=(O=(x=m-(b=(y=t*m)-(y-m)))*(C=F-(S=(y=t*F)-(y-F)))-((D=m*F)-b*S-x*S-b*C))-(w=O-(A=(x=h-(b=(y=t*h)-(y-h)))*(C=N-(S=(y=t*N)-(y-N)))-((k=h*N)-b*S-x*S-b*C))),c[0]=O-(w+v)+(v-A),v=(E=D-((T=D+w)-(v=T-D))+(w-v))-(w=E-k),c[1]=E-(w+v)+(v-k),v=(j=T+w)-T,c[2]=T-(j-v)+(w-v),c[3]=j;let z=n(4,i,4,c,a);v=(O=(x=M-(b=(y=t*M)-(y-M)))*(C=_-(S=(y=t*_)-(y-_)))-((D=M*_)-b*S-x*S-b*C))-(w=O-(A=(x=P-(b=(y=t*P)-(y-P)))*(C=g-(S=(y=t*g)-(y-g)))-((k=P*g)-b*S-x*S-b*C))),c[0]=O-(w+v)+(v-A),v=(E=D-((T=D+w)-(v=T-D))+(w-v))-(w=E-k),c[1]=E-(w+v)+(v-k),v=(j=T+w)-T,c[2]=T-(j-v)+(w-v),c[3]=j;let ee=n(z,a,4,c,o);return v=(O=(x=m-(b=(y=t*m)-(y-m)))*(C=_-(S=(y=t*_)-(y-_)))-((D=m*_)-b*S-x*S-b*C))-(w=O-(A=(x=h-(b=(y=t*h)-(y-h)))*(C=g-(S=(y=t*g)-(y-g)))-((k=h*g)-b*S-x*S-b*C))),c[0]=O-(w+v)+(v-A),v=(E=D-((T=D+w)-(v=T-D))+(w-v))-(w=E-k),c[1]=E-(w+v)+(v-k),v=(j=T+w)-T,c[2]=T-(j-v)+(w-v),c[3]=j,s[n(ee,o,4,c,s)-1]}(e,r,l,u,d,f,g)},e.orient2dfast=function(e,t,n,r,i,a){return(t-a)*(n-i)-(e-i)*(r-a)},Object.defineProperty(e,`__esModule`,{value:!0})})})),Ot=o(((e,t)=>{var n=ht(),r=(Ct(),g(bt)),i=Et(),a=Dt().orient2d;r.default&&(r=r.default),t.exports=o,t.exports.default=o;function o(e,t,r){t=Math.max(0,t===void 0?2:t),r||=0;var i=h(e),a=new n(16);a.toBBox=function(e){return{minX:e[0],minY:e[1],maxX:e[0],maxY:e[1]}},a.compareMinX=function(e,t){return e[0]-t[0]},a.compareMinY=function(e,t){return e[1]-t[1]},a.load(e);for(var o=[],c=0,l;c<i.length;c++){var u=i[c];a.remove(u),l=_(u,l),o.push(l)}var d=new n(16);for(c=0;c<o.length;c++)d.insert(m(o[c]));for(var f=t*t,p=r*r;o.length;){var g=o.shift(),y=g.p,b=g.next.p,x=v(y,b);if(!(x<p)){var S=x/f;u=s(a,g.prev.p,y,b,g.next.next.p,S,d),u&&Math.min(v(u,y),v(u,b))<=S&&(o.push(g),o.push(_(u,g)),a.remove(u),d.remove(g),d.insert(m(g)),d.insert(m(g.next)))}}g=l;var C=[];do C.push(g.p),g=g.next;while(g!==l);return C.push(g.p),C}function s(e,t,n,i,a,o,s){for(var u=new r([],c),f=e.data;f;){for(var p=0;p<f.children.length;p++){var m=f.children[p],h=f.leaf?y(m,n,i):l(n,i,m);h>o||u.push({node:m,dist:h})}for(;u.length&&!u.peek().node.children;){var g=u.pop(),_=g.node,v=y(_,t,n),b=y(_,i,a);if(g.dist<v&&g.dist<b&&d(n,_,s)&&d(i,_,s))return _}f=u.pop(),f&&=f.node}return null}function c(e,t){return e.dist-t.dist}function l(e,t,n){if(u(e,n)||u(t,n))return 0;var r=b(e[0],e[1],t[0],t[1],n.minX,n.minY,n.maxX,n.minY);if(r===0)return 0;var i=b(e[0],e[1],t[0],t[1],n.minX,n.minY,n.minX,n.maxY);if(i===0)return 0;var a=b(e[0],e[1],t[0],t[1],n.maxX,n.minY,n.maxX,n.maxY);if(a===0)return 0;var o=b(e[0],e[1],t[0],t[1],n.minX,n.maxY,n.maxX,n.maxY);return o===0?0:Math.min(r,i,a,o)}function u(e,t){return e[0]>=t.minX&&e[0]<=t.maxX&&e[1]>=t.minY&&e[1]<=t.maxY}function d(e,t,n){for(var r=Math.min(e[0],t[0]),i=Math.min(e[1],t[1]),a=Math.max(e[0],t[0]),o=Math.max(e[1],t[1]),s=n.search({minX:r,minY:i,maxX:a,maxY:o}),c=0;c<s.length;c++)if(p(s[c].p,s[c].next.p,e,t))return!1;return!0}function f(e,t,n){return a(e[0],e[1],t[0],t[1],n[0],n[1])}function p(e,t,n,r){return e!==r&&t!==n&&f(e,t,n)>0!=f(e,t,r)>0&&f(n,r,e)>0!=f(n,r,t)>0}function m(e){var t=e.p,n=e.next.p;return e.minX=Math.min(t[0],n[0]),e.minY=Math.min(t[1],n[1]),e.maxX=Math.max(t[0],n[0]),e.maxY=Math.max(t[1],n[1]),e}function h(e){for(var t=e[0],n=e[0],r=e[0],a=e[0],o=0;o<e.length;o++){var s=e[o];s[0]<t[0]&&(t=s),s[0]>r[0]&&(r=s),s[1]<n[1]&&(n=s),s[1]>a[1]&&(a=s)}var c=[t,n,r,a],l=c.slice();for(o=0;o<e.length;o++)i(e[o],c)||l.push(e[o]);return S(l)}function _(e,t){var n={p:e,prev:null,next:null,minX:0,minY:0,maxX:0,maxY:0};return t?(n.next=t.next,n.prev=t,t.next.prev=n,t.next=n):(n.prev=n,n.next=n),n}function v(e,t){var n=e[0]-t[0],r=e[1]-t[1];return n*n+r*r}function y(e,t,n){var r=t[0],i=t[1],a=n[0]-r,o=n[1]-i;if(a!==0||o!==0){var s=((e[0]-r)*a+(e[1]-i)*o)/(a*a+o*o);s>1?(r=n[0],i=n[1]):s>0&&(r+=a*s,i+=o*s)}return a=e[0]-r,o=e[1]-i,a*a+o*o}function b(e,t,n,r,i,a,o,s){var c=n-e,l=r-t,u=o-i,d=s-a,f=e-i,p=t-a,m=c*c+l*l,h=c*u+l*d,g=u*u+d*d,_=c*f+l*p,v=u*f+d*p,y=m*g-h*h,b,x,S,C,w=y,T=y;y===0?(x=0,w=1,C=v,T=g):(x=h*v-g*_,C=m*v-h*_,x<0?(x=0,C=v,T=g):x>w&&(x=w,C=v+h,T=g)),C<0?(C=0,-_<0?x=0:-_>m?x=w:(x=-_,w=m)):C>T&&(C=T,-_+h<0?x=0:-_+h>m?x=w:(x=-_+h,w=m)),b=x===0?0:x/w,S=C===0?0:C/T;var E=(1-b)*e+b*n,D=(1-b)*t+b*r,O=(1-S)*i+S*o,k=(1-S)*a+S*s,A=O-E,j=k-D;return A*A+j*j}function x(e,t){return e[0]===t[0]?e[1]-t[1]:e[0]-t[0]}function S(e){e.sort(x);for(var t=[],n=0;n<e.length;n++){for(;t.length>=2&&f(t[t.length-2],t[t.length-1],e[n])<=0;)t.pop();t.push(e[n])}for(var r=[],i=e.length-1;i>=0;i--){for(;r.length>=2&&f(r[r.length-2],r[r.length-1],e[i])<=0;)r.pop();r.push(e[i])}return r.pop(),t.pop(),t.concat(r)}}));function kt(e,t={}){t.concavity=t.concavity||1/0;let n=[];if(Ne(e,e=>{n.push([e[0],e[1]])}),!n.length)return null;let r=(0,At.default)(n,t.concavity);return r.length>3?_e([r]):null}var At,jt=a((()=>{Te(),Ie(),At=_(Ot(),1)}));function Mt(e){if(!e)throw Error(`geojson is required`);switch(e.type){case`Feature`:return Nt(e);case`FeatureCollection`:return Ft(e);case`Point`:case`LineString`:case`Polygon`:case`MultiPoint`:case`MultiLineString`:case`MultiPolygon`:case`GeometryCollection`:return It(e);default:throw Error(`unknown GeoJSON type`)}}function Nt(e){let t={type:`Feature`};return Object.keys(e).forEach(n=>{switch(n){case`type`:case`properties`:case`geometry`:return;default:t[n]=e[n]}}),t.properties=Pt(e.properties),e.geometry==null?t.geometry=null:t.geometry=It(e.geometry),t}function Pt(e){let t={};return e&&Object.keys(e).forEach(n=>{let r=e[n];typeof r==`object`?r===null?t[n]=null:Array.isArray(r)?t[n]=r.map(e=>e):t[n]=Pt(r):t[n]=r}),t}function Ft(e){let t={type:`FeatureCollection`};return Object.keys(e).forEach(n=>{switch(n){case`type`:case`features`:return;default:t[n]=e[n]}}),t.features=e.features.map(e=>Nt(e)),t}function It(e){let t={type:e.type};return e.bbox&&(t.bbox=e.bbox),e.type===`GeometryCollection`?(t.geometries=e.geometries.map(e=>It(e)),t):(t.coordinates=Lt(e.coordinates),t)}function Lt(e){let t=e;return typeof t[0]==`object`?t.map(e=>Lt(e)):t.slice()}var Rt=a((()=>{})),zt=a((()=>{})),Bt=a((()=>{})),Vt=a((()=>{})),Ht=a((()=>{})),Ut=a((()=>{}));function Wt(e,t){var n=e[0]-t[0],r=e[1]-t[1];return n*n+r*r}function Gt(e,t,n){var r=t[0],i=t[1],a=n[0]-r,o=n[1]-i;if(a!==0||o!==0){var s=((e[0]-r)*a+(e[1]-i)*o)/(a*a+o*o);s>1?(r=n[0],i=n[1]):s>0&&(r+=a*s,i+=o*s)}return a=e[0]-r,o=e[1]-i,a*a+o*o}function Kt(e,t){for(var n=e[0],r=[n],i,a=1,o=e.length;a<o;a++)i=e[a],Wt(i,n)>t&&(r.push(i),n=i);return n!==i&&r.push(i),r}function qt(e,t,n,r,i){for(var a=r,o,s=t+1;s<n;s++){var c=Gt(e[s],e[t],e[n]);c>a&&(o=s,a=c)}a>r&&(o-t>1&&qt(e,t,o,r,i),i.push(e[o]),n-o>1&&qt(e,o,n,r,i))}function Jt(e,t){var n=e.length-1,r=[e[0]];return qt(e,0,n,t,r),r.push(e[n]),r}function Yt(e,t,n){if(e.length<=2)return e;var r=t===void 0?1:t*t;return e=n?e:Kt(e,r),e=Jt(e,r),e}function Xt(e,t={}){if(t??={},!Ce(t))throw Error(`options is invalid`);let n=t.tolerance??1,r=t.highQuality??!1,i=t.mutate??!1;if(!e)throw Error(`geojson is required`);if(n&&n<0)throw Error(`invalid tolerance`);return i!==!0&&(e=Mt(e)),Pe(e,function(e){Zt(e,n,r)}),e}function Zt(e,t,n){let r=e.type;if(r===`Point`||r===`MultiPoint`)return e;if(gt(e,{mutate:!0}),r!==`GeometryCollection`)switch(r){case`LineString`:e.coordinates=Yt(e.coordinates,t,n);break;case`MultiLineString`:e.coordinates=e.coordinates.map(e=>Yt(e,t,n));break;case`Polygon`:e.coordinates=Qt(e.coordinates,t,n);break;case`MultiPolygon`:e.coordinates=e.coordinates.map(e=>Qt(e,t,n))}return e}function Qt(e,t,n){return e.map(function(e){if(e.length<4)throw Error(`invalid polygon`);let r=t,i=Yt(e,r,n);for(;!$t(i)&&r>=2**-52;)r-=r*.01,i=Yt(e,r,n);return $t(i)?((i[i.length-1][0]!==i[0][0]||i[i.length-1][1]!==i[0][1])&&i.push(i[0]),i):e})}function $t(e){return e.length<3?!1:!(e.length===3&&e[2][0]===e[0][0]&&e[2][1]===e[0][1])}var en=a((()=>{yt(),Rt(),Ie(),Te()})),tn=a((()=>{Ue(),dt(),Rt(),zt(),jt(),Me(),Te(),Ae(),Ie(),Bt(),Vt(),Ht(),Ut(),en()}));function nn(e){let{r:t,normalized:n,durMin:r,totalPers:i,distance_m:a,dist_ini_fin:o,actualSeg:s,ptIni:c,isCompletada:l,hogaresRaw:u}=e,d=[];if(t._backend_meta&&t._backend_meta.flags){let e=t._backend_meta.flags;e.distance_gt_500m&&d.push(`FUERA_SEGMENTO`),e.hogar_count_mismatch&&d.push(`HOGARES_INCONSISTENTES`),e.integrantes_mismatch&&d.push(`INTEGRANTES_INCONSISTENTES`),e.wrong_segment&&d.push(`SEGMENTO_INCORRECTO`),e.far_from_control&&d.push(`CONTROL_DISTANTE`)}try{let e=y(t[`start-geopoint`]||t.start_geopoint)||(t._geolocation?.length>=2?[t._geolocation[0],t._geolocation[1]]:null);e&&c&&c[0]&&je([e[1],e[0]],[c[1],c[0]],{units:`meters`})>500&&d.push(`APERT_LEJOS`)}catch{}a!==null&&a>600&&!d.includes(`FUERA_SEGMENTO`)&&d.push(`FUERA_SEGMENTO`),o!==null&&o>30&&d.push(`DESPLAZAMIENTO_ANOMALO`),l&&r!==null&&(n.formType===`EHM`&&i===1&&r<10?d.push(`TIEMPO_CORTO_EHM`):n.formType!==`EHM`&&r<15?d.push(`TIEMPO_CORTO_ESCA`):r<15&&d.push(`TIEMPO_CORTO`)),l&&r!==null&&r>45&&d.push(`TIEMPO_LARGO`);let f=n.cedula;if(f&&f!==`N/A`){let e=f.replace(/\D/g,``);(e.length<6||e.length>9)&&d.push(`CEDULA_INVALIDA`)}u.forEach(e=>{(Array.isArray(e[`datos_hogar/hogar/integrantes_hogar`])?e[`datos_hogar/hogar/integrantes_hogar`]:[]).forEach(e=>{let t=e[`datos_hogar/hogar/integrantes_hogar/integrantes/cuanto_actividad`];if(t!=null&&t!==``){let e=Number(t);!isNaN(e)&&(e<1||e>9999999)&&(d.includes(`INGRESO_ANOMALO`)||d.push(`INGRESO_ANOMALO`))}})}),u.forEach(e=>{let t=e[`datos_hogar/hogar/productos_22/arranque`]||``,n=e[`datos_hogar/hogar/productos_22/productos`],r=Array.isArray(n)&&n.length>0;l&&r&&!t&&(d.includes(`ARRANQUE_INCONSISTENTE`)||d.push(`ARRANQUE_INCONSISTENTE`))});let p=n.segmento===`000`||n.segmento===`0`?n.sector:n.segmento;return s&&p&&(b(p,s)||d.push(`SEGMENTO_INCORRECTO`)),d}var rn=a((()=>{m(),D(),tn()}));function an(e){return e?String(e).toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]/g,``).trim():``}function on(e,t){let n=an(e||``),r=an(t||``);if(r===`ocupadaconocupantespresentes`||n===`ocupadaconocupantespresentes`||n.includes(`totalmenteencuestad`))return`Totalmente Encuestado`;if(r===`ocupadasconocupantesausentes`||n===`nadieenvivienda`||n===`ausentetemporalmente`||n===`rehusoentrevista`||n===`otroausentes`)return n===`nadieenvivienda`||n.includes(`nadieenvivienda`)?`Ocupantes Ausentes`:n===`ausentetemporalmente`||n.includes(`ausentetemporalmente`)?`Ausente Temporalmente`:n===`rehusoentrevista`||n.includes(`rehuso`)||n.includes(`rechaz`)?`Rechazada`:`Ocupantes Ausentes`;if(r===`desocupada`||n){if(n===`desocupadaestadoregular`||n.includes(`desocupadaestadoregular`))return`Vivienda Desocupada`;if(n===`inadecuadaeluso`||n.includes(`inadecuadaeluso`)||n.includes(`inadecuadaparaeluso`))return`Inadecuada para Uso`;if(n===`construyendose`||n.includes(`construyendose`)||n.includes(`construc`))return`Construccion`;if(n===`temporalmenteennegocio`||n.includes(`temporalmenteennegocio`))return`Temporalmente en Negocio`;if(n===`usovacacional`||n===`usovacasional`||n.includes(`usovacacional`)||n.includes(`usoocacional`))return`Uso Vacasional`;if(n===`demolida`||n.includes(`demolid`))return`Demolida`;if(n===`negocioalmacenpermanente`||n.includes(`negocioalmacen`)||n.includes(`negociopermanente`)||n.includes(`ferreteria`)||n.includes(`autolavado`)||n.includes(`comercio`)||n.includes(`taller`))return`Negocio Permanente`;if(n===`consolidada`||n.includes(`consolidada`))return`Consolidada`;if(n===`otrodesocupada`||n===`otro`||n.includes(`otro`))return`Otro (Especifique)`}return`Otro (Especifique)`}function sn(e){return cn[on(e,e)]||`NO DEFINIDO`}var cn,ln=a((()=>{cn={"Totalmente Encuestado":`TIPO E`,"Ocupantes Ausentes":`TIPO A`,"Ausente Temporalmente":`TIPO A`,Rechazada:`TIPO A`,"Informante No Calificado":`TIPO A`,Incompleta:`TIPO A`,Pendiente:`TIPO A`,"No Atiende Telefono":`TIPO A`,"Sin Entrevista":`TIPO A`,"Vivienda Desocupada":`TIPO B`,"Inadecuada para Uso":`TIPO B`,Construccion:`TIPO B`,"Temporalmente en Negocio":`TIPO B`,"Uso Vacasional":`TIPO B`,"Vivienda Ocasional":`TIPO B`,Demolida:`TIPO C`,"Negocio Permanente":`TIPO C`,Consolidada:`TIPO C`,"Otro (Especifique)":`TIPO C`,"Mal Listada":`TIPO C`,"No Existe":`TIPO C`,"Sin Listar":`TIPO C`,"Otra Condicion":`TIPO C`,"Otra Situacion":`TIPO C`,"No Existe Nro Telefonico":`TIPO C`}}));function un(e){if(!l.planificacionData||!l.planificacionData.por_semana||!e||e.size===0)return 0;let t=l.assetName&&l.assetName.toUpperCase().includes(`EHM`)?`EHM`:`ESCA`,n=0;return l.planificacionData.por_semana.forEach(r=>{if(r.programa!==t)return;let i=String(r.control).slice(-4).padStart(4,`0`);e.has(i)&&(n+=r.n_viviendas||0)}),n}var dn=a((()=>{m(),D()}));async function fn(){console.log(`data/index.js: Processing data pipeline (Optimized)...`),l.encMap={};let e=l.controlsIndex instanceof Map&&l.controlsIndex.size>0,t=l.rawData.length;for(let n=0;n<t;n+=500){let r=Math.min(n+500,t);for(let t=n;t<r;t++){let n=l.rawData[t],r=ce(n),i=n._backend_meta&&n._backend_meta.duration_minutes!==void 0?n._backend_meta.duration_minutes:le(r.start,r.end),{totalPers:a,totalHombres:o,totalMujeres:s,hogaresCount:c,hogaresRaw:u}=de(n,r.formType),{ptIni:d}=me(n),f=n._geo_meta||{},p=f.lat??null,m=f.lng??null,h=f.distance_m??null,g=f.dist_ini_fin??null,_=f.actual_seg??null,v=0;Array.isArray(u)&&u.forEach(e=>{let t=(Array.isArray(e[`lista_hogar/lista_miembros`])?e[`lista_hogar/lista_miembros`]:Array.isArray(e[`datos_hogar/hogar/integrantes_hogar`])?e[`datos_hogar/hogar/integrantes_hogar`]:[]).length;if(t===0){let n=parseInt(e[`lista_hogar/personas_hogar`]||e[`lista_hogar/lista_miembros_count`]||`0`,10);isNaN(n)||(t=n)}t===1&&v++});let y=n[`Condici_n_de_ocupaci_n/situacion_vivienda`]||null,b=n[`Condici_n_de_ocupaci_n/condicion_de_ocupacion`]||null,x=sn(r.situacion_vivienda||r.condicion),S=on(y,b),C=/totalment/i.test(r.nota)||x===`TIPO E`;if(n._meta={...r,durMin:i,totalPers:a,totalHombres:o,totalMujeres:s,hogares:c,hogaresUniPersonales:v,lat:p,lng:m,distance_m:h,dist_ini_fin:g,actual_seg:_,estado:C?`completada`:`no_efectiva`,tipo_vivienda:x,subtipo_vivienda:S,flag_distance_gt_500:h!==null&&h>500,flag_short_duration:i!==null&&i<10},n._meta.alertas=nn({r:n,normalized:r,durMin:i,totalPers:a,distance_m:h,dist_ini_fin:g,actualSeg:_,ptIni:d,isCompletada:C,hogaresRaw:u}),n._meta.hasAlerts=n._meta.alertas.length>0,e){let e=n._meta.control?n._meta.control.slice(-4):``,t=`${e}-${String(parseInt(n._meta.n_serie,10)||0)}-${String(parseInt(n._meta.n_linea,10)||0)}`,r=l.controlsIndex.has(t),i=l.validControls.has(e);n._meta._ls_ctrl_ok=i,n._meta._ls_serie_ok=r,n._meta._ls_linea_ok=r,r||n._meta.alertas.includes(`LINEA_SERIE_INVALIDA`)||(n._meta.alertas.push(`LINEA_SERIE_INVALIDA`),n._meta.hasAlerts=!0)}let{cedula:w,nombre:T,estado:E,mun:D,condicion:O,semana:k,control:A,tipo_vivienda:j,alertas:M}=n._meta;l.encMap[w]||(l.encMap[w]={cedula:w,nombre:T,encuestas:0,completadas:0,noEfectiva:0,tipoA:0,tipoB:0,tipoC:0,tipoE:0,alertasCount:0,duraciones:[],personas:0,municipios:new Set,condiciones:{},semanas:{},controlesSet:new Set});let N=l.encMap[w];N.encuestas++,E===`completada`?N.completadas++:N.noEfectiva++,j===`TIPO A`?N.tipoA++:j===`TIPO B`?N.tipoB++:j===`TIPO C`?N.tipoC++:j===`TIPO E`&&N.tipoE++,Array.isArray(M)&&M.length>0&&(N.alertasCount+=M.length),A&&N.controlesSet.add(String(A).slice(-4).padStart(4,`0`)),i!==null&&N.duraciones.push(i),N.personas+=a||0,N.municipios.add(D),N.condiciones[O]=(N.condiciones[O]||0)+1,k&&(N.semanas[k]||(N.semanas[k]=new Set),A&&N.semanas[k].add(A))}await new Promise(e=>setTimeout(e,0))}for(let e of Object.values(l.encMap)){let t=un(e.controlesSet),n=(t>0?t:e.encuestas)-(e.tipoB+e.tipoC);e.avgDur=e.duraciones.length?e.duraciones.reduce((e,t)=>e+t,0)/e.duraciones.length:0,e.planificadas=t,e.noRespuesta=e.tipoA,e.pctCompleta=e.encuestas>0?Math.round(e.completadas/e.encuestas*100):0,e.pctNoRespuesta=n>0?Math.round(e.tipoA/n*100):0,e.score=e.pctNoRespuesta;let r=Object.values(e.semanas||{});e.avgControlesSemana=r.length?Math.round(r.reduce((e,t)=>e+t.size,0)/r.length):0,e.totalSemanas=r.length}console.log(`data/index.js: Pipeline completed ✓`)}var pn=a((()=>{m(),ue(),pe(),he(),rn(),ln(),dn()}));function mn(){let e=x(`activeFiltersContainer`),t=x(`activeFiltersBadge`);if(!e||!t)return;let n=[{id:`filterEncuestador`,label:`Encuestador`},{id:`filterMunicipio`,label:`Municipio`},{id:`filterParroquia`,label:`Parroquia`},{id:`filterNodo`,label:`Nodo`},{id:`filterEstado`,label:`Estado`},{id:`filterCondicion`,label:`Condición`},{id:`filterSituacionVivienda`,label:`Sit. Viv`},{id:`filterUso`,label:`Uso`},{id:`filterSemana`,label:`Semana`},{id:`filterControl`,label:`Control`},{id:`filterAlerta`,label:`Alerta`},{id:`filterClasificacion`,label:`Clasif`},{id:`filterTasaNoRespuesta`,label:`No Resp Ctrl`},{id:`filterHoraTransmision`,label:`Hora Trans`},{id:`filterHoraInicio`,label:`Hora Inicio`}],r=0;e.innerHTML=``;let i=(t,n,i)=>{r++;let a=document.createElement(`button`);a.className=`group flex items-center gap-1.5 px-2.5 py-1 bg-brand-blue/10 hover:bg-brand-red/10 border border-brand-blue/30 hover:border-brand-red/30 text-brand-blue hover:text-brand-red rounded-lg text-[10px] font-bold transition-all`,a.innerHTML=`
    ...
    `,n.insertBefore(i,e.nextSibling);let c=i.querySelector(`.combobox-input`),l=i.querySelector(`.combobox-dropdown`),u=i.querySelector(`.combobox-arrow`),d=i.querySelector(`.combobox-clear`),f=-1;function p(t=``){let n=i.querySelector(`.combobox-list`);n.innerHTML=``;let r=t.toLowerCase().trim(),a=Array.from(e.options),o=0;if(a.forEach(t=>{let i=t.textContent,a=t.value;if(!(r&&a===``)&&i.toLowerCase().includes(r)){o++;let r=document.createElement(`div`);r.className=`combobox-option px-3 py-1.5 text-xs rounded-lg font-bold cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-all text-slate-700 dark:text-slate-300 flex items-center justify-between`,r.setAttribute(`data-value`,a),r.textContent=i;let s=t.getAttribute(`style`);s&&r.setAttribute(`style`,s),a===e.value&&r.classList.add(`bg-brand-blue/10`,`text-brand-blue`,`dark:bg-brand-blue/20`,`dark:text-brand-blue`),r.onclick=e=>{e.stopPropagation(),m(a,i)},n.appendChild(r)}}),o===0){let e=document.createElement(`div`);e.className=`px-3 py-2.5 text-xs text-slate-400 dark:text-slate-500 font-bold text-center italic`,e.textContent=`Sin coincidencias`,n.appendChild(e)}}function m(t,n){e.value=t,c.value=n,c.setAttribute(`readonly`,`true`),g(),t===``?d.classList.add(`hidden`):d.classList.remove(`hidden`),e.dispatchEvent(new Event(`change`))}function h(){i.classList.add(`combobox-open`,`z-[10000]`),n&&(n.style.zIndex=`10000`),l.classList.remove(`hidden`),u.classList.add(`rotate-180`),c.removeAttribute(`readonly`);let t=e.options[e.selectedIndex];c.placeholder=t?t.textContent:`Buscar...`,c.value=``,c.focus(),p(``),f=-1}function g(){i.classList.remove(`combobox-open`,`z-[10000]`,`z-[1000]`),n&&(n.style.zIndex=``),l.classList.add(`hidden`),u.classList.remove(`rotate-180`),c.setAttribute(`readonly`,`true`),c.placeholder=`Buscar...`;let t=e.options[e.selectedIndex];c.value=t?t.textContent:``,f=-1}function _(){return Array.from(i.querySelectorAll(`.combobox-option`))}function v(){_().forEach((e,t)=>{t===f?(e.classList.add(`bg-slate-100`,`dark:bg-slate-800/80`,`ring-1`,`ring-brand-blue/30`),e.scrollIntoView({block:`nearest`})):e.classList.remove(`bg-slate-100`,`dark:bg-slate-800/80`,`ring-1`,`ring-brand-blue/30`)})}i.querySelector(`.combobox-trigger`).onclick=e=>{d.contains(e.target)||(l.classList.contains(`hidden`)?h():g())},c.oninput=()=>{p(c.value),f=-1},c.onkeydown=e=>{if(l.classList.contains(`hidden`)){(e.key===`ArrowDown`||e.key===`Enter`)&&(e.preventDefault(),h());return}let t=_();if(e.key===`ArrowDown`)e.preventDefault(),f=Math.min(f+1,t.length-1),v();else if(e.key===`ArrowUp`)e.preventDefault(),f=Math.max(f-1,0),v();else if(e.key===`Enter`){if(e.preventDefault(),f>=0&&t[f]){let e=t[f].getAttribute(`data-value`),n=t[f].textContent;m(e,n)}else if(t.length>0){let e=t[0].getAttribute(`data-value`),n=t[0].textContent;m(e,n)}}else e.key===`Escape`&&(e.preventDefault(),g(),c.blur())},d.onclick=t=>{t.stopPropagation(),m(``,e.options[0]?e.options[0].textContent:`Todos`)},s!==``&&d.classList.remove(`hidden`);let y=e=>{i.contains(e.target)||g()};document.addEventListener(`click`,y);let b=()=>{let t=e.options[e.selectedIndex],n=e.value;c.value=t?t.textContent:``,n===``?d.classList.add(`hidden`):d.classList.remove(`hidden`)};e.addEventListener(`change`,b);let x=new MutationObserver(t=>{t.forEach(t=>{t.removedNodes.forEach(t=>{t===i&&(document.removeEventListener(`click`,y),e.removeEventListener(`change`,b),x.disconnect())})})});x.observe(n,{childList:!0})}var _n=a((()=>{D()}));function vn(){let e=x(`offCanvasFilters`),t=x(`filtersOverlay`);!e||!t||(e.classList.remove(`translate-x-full`),e.classList.add(`translate-x-0`,`translate-y-0`),t.classList.remove(`hidden`),setTimeout(()=>t.classList.remove(`opacity-0`),10))}function yn(){let e=x(`offCanvasFilters`),t=x(`filtersOverlay`);!e||!t||(e.classList.add(`translate-x-full`),e.classList.remove(`translate-x-0`,`translate-y-0`),t.classList.add(`opacity-0`),setTimeout(()=>t.classList.add(`hidden`),300))}function bn(){let e=x(`filterEncuestador`);if(!e)return;let n=e.value;e.innerHTML=`<option value="">Todos</option>`,Object.values(l.encMap).sort((e,t)=>(e.nombre||``).localeCompare(t.nombre||``)).forEach(n=>{let r=p.has(String(n.cedula).trim());if(l.filterINE&&!r||l.filterSEGEN&&r)return;let i=n.nombre&&n.nombre!==`Desconocido`?n.nombre:t[n.cedula]||`Encuestador ${n.cedula}`,a=document.createElement(`option`);a.value=n.cedula,a.textContent=`${i} (${n.cedula})${r?` [INE]`:` [SEGEN]`}`,a.style.color=r?`#10B981`:`#8B5CF6`,a.style.fontWeight=`bold`,e.appendChild(a)}),n&&(Array.from(e.options).some(e=>e.value===n)?e.value=n:e.value=``),gn(e)}function xn(){let e=x(`filterMunicipio`);x(`filterParroquia`),x(`filterNodo`),x(`filterControl`);let t=x(`filterSemana`);e&&e.addEventListener(`change`,()=>{let n=e.value;Sn(n,t?.value)}),t&&t.addEventListener(`change`,()=>{let n=t.value;Sn(e?.value,n)})}function Sn(e,t){let n=x(`filterParroquia`),r=x(`filterNodo`),i=x(`filterControl`),a=l.rawData.filter(n=>{let r=n._meta;return!(!r||e&&r.mun!==e||t&&r.semana!==t)}),o={},s={},c={};a.forEach(e=>{let t=e._meta;t.par&&t.par!==`N/A`&&(o[t.par]=(o[t.par]||0)+1),t.nodo&&t.nodo!==`N/A`&&(s[t.nodo]=(s[t.nodo]||0)+1),t.control&&(c[t.control]=(c[t.control]||0)+1)});let u=(e,t,n)=>{if(!e)return;let r=e.value;e.innerHTML=`<option value="">${n}</option>`,Object.entries(t).sort((e,t)=>e[0].localeCompare(t[0])).forEach(([t,n])=>{let r=document.createElement(`option`);r.value=t,r.textContent=`${t} (${n.toLocaleString(`es-VE`)})`,e.appendChild(r)}),r&&t[r]?e.value=r:e.value=``,gn(e)};u(n,o,`Todas las parroquias`),u(r,s,`Todos los nodos`),u(i,c,`Todos los controles`)}function Cn(){let e={enc:x(`filterEncuestador`),mun:x(`filterMunicipio`),con:x(`filterCondicion`),sit:x(`filterSituacionVivienda`),uso:x(`filterUso`),sem:x(`filterSemana`),ctrl:x(`filterControl`),par:x(`filterParroquia`),nodo:x(`filterNodo`),alerta:x(`filterAlerta`),htrans:x(`filterHoraTransmision`),hinicio:x(`filterHoraInicio`)};Object.values(e).forEach(e=>{if(e){if(e.id===`filterEncuestador`)return;let t=`Todos`;e.id===`filterAlerta`?t=`Todas las alertas`:e.id===`filterHoraTransmision`||e.id===`filterHoraInicio`?t=`Cualquier hora`:(e.id.includes(`Condicion`)||e.id.includes(`Semana`)||e.id.includes(`Parroquia`)||e.id.includes(`Municipio`))&&(t=`Todos`),e.innerHTML=`<option value="">${t}</option>`}}),e.alerta&&f.forEach(t=>{let n=document.createElement(`option`);n.value=t.code,n.textContent=t.label,e.alerta.appendChild(n)});let t={muns:{},sitVs:{},cons:{},usos:{},semanas:{},controles:{},pars:{},nodos:{},hTrans:{},hInicio:{}};bn(),l.rawData.forEach(e=>{let n=e._meta;n&&(n.mun&&n.mun!==`N/A`&&(t.muns[n.mun]=(t.muns[n.mun]||0)+1),n.situacion_vivienda&&(t.sitVs[n.situacion_vivienda]=(t.sitVs[n.situacion_vivienda]||0)+1),n.condicion&&n.condicion!==`N/A`&&(t.cons[n.condicion]=(t.cons[n.condicion]||0)+1),n.uso&&n.uso!==`N/A`&&(t.usos[n.uso]=(t.usos[n.uso]||0)+1),n.semana&&(t.semanas[n.semana]=(t.semanas[n.semana]||0)+1),n.control&&(t.controles[n.control]=(t.controles[n.control]||0)+1),n.par&&n.par!==`N/A`&&(t.pars[n.par]=(t.pars[n.par]||0)+1),n.nodo&&n.nodo!==`N/A`&&(t.nodos[n.nodo]=(t.nodos[n.nodo]||0)+1),n.hora_trans!==void 0&&n.hora_trans!==null&&(t.hTrans[n.hora_trans]=(t.hTrans[n.hora_trans]||0)+1),n.hora!==void 0&&n.hora!==null&&(t.hInicio[n.hora]=(t.hInicio[n.hora]||0)+1))});let n=(e,t,n)=>{e&&Object.entries(t).sort((e,t)=>e[0].localeCompare(t[0])).forEach(([t,r])=>{let i=document.createElement(`option`);i.value=t,i.textContent=`${n?n(t):t} (${r.toLocaleString(`es-VE`)})`,e.appendChild(i)})};n(e.mun,t.muns,e=>d(e)),n(e.par,t.pars),n(e.nodo,t.nodos),n(e.sem,t.semanas),n(e.ctrl,t.controles),n(e.sit,t.sitVs,e=>e.replace(/_/g,` `).toUpperCase()),n(e.con,t.cons,e=>e.replace(/_/g,` `).toUpperCase()),n(e.uso,t.usos,e=>e.replace(/_/g,` `).toUpperCase()),n(e.htrans,t.hTrans,e=>`${e}:00`),n(e.hinicio,t.hInicio,e=>`${e}:00`),[`filterMunicipio`,`filterParroquia`,`filterNodo`,`filterEstado`,`filterClasificacion`,`filterCondicion`,`filterSituacionVivienda`,`filterUso`,`filterSemana`,`filterControl`,`filterHoraInicio`,`filterHoraTransmision`,`filterAlerta`,`filterEncuestador`,`filterTasaNoRespuesta`].forEach(e=>{let t=x(e);t&&gn(t)}),xn()}var wn=a((()=>{m(),D(),_n()}));function Tn(e){Dn=e}function J(){bn();let e=x(`searchEncuesta`)?.value.toLowerCase()??``,t=x(`filterEncuestador`)?.value??``,n=x(`filterFechaInicio`)?.value??``,r=x(`filterFechaFin`)?.value??``,i=x(`filterSemana`)?.value??``,a=x(`filterControl`)?.value??``,o=x(`filterMunicipio`)?.value??``,s=x(`filterParroquia`)?.value??``,c=x(`filterNodo`)?.value??``,u=x(`filterEstado`)?.value??``,d=x(`filterSituacionVivienda`)?.value??``,f=x(`filterCondicion`)?.value??``,m=x(`filterUso`)?.value??``,h=x(`filterAlerta`)?.value??``,g=x(`filterHoraTransmision`)?.value??``,_=x(`filterHoraInicio`)?.value??``,v=x(`filterClasificacion`)?.value??``,y=x(`filterTasaNoRespuesta`)?.value??``,b=new Set;if(y!==``){let e={},t=l.assetName&&l.assetName.toUpperCase().includes(`EHM`)?`EHM`:`ESCA`;l.planificacionData?.por_semana&&l.planificacionData.por_semana.forEach(n=>{if(n.programa!==t)return;let r=String(n.control).replace(/\D/g,``).padStart(4,`0`);e[r]||(e[r]={planif:0,tipoA:0,tipoB:0,tipoC:0,totalCaptured:0}),e[r].planif+=n.n_viviendas||0}),l.rawData.forEach(t=>{let n=t._meta;if(!n||!n.control)return;let r=String(n.control).replace(/\D/g,``).padStart(4,`0`);e[r]||(e[r]={planif:0,tipoA:0,tipoB:0,tipoC:0,totalCaptured:0}),e[r].totalCaptured++,n.tipo_vivienda===`TIPO A`?e[r].tipoA++:n.tipo_vivienda===`TIPO B`?e[r].tipoB++:n.tipo_vivienda===`TIPO C`&&e[r].tipoC++}),Object.entries(e).forEach(([e,t])=>{let n=(t.planif>0?t.planif:t.totalCaptured)-(t.tipoB+t.tipoC),r=n>0?t.tipoA/n*100:t.tipoA>0?100:0;(y===`con_no_resp`&&r>0||y===`sin_no_resp`&&r===0)&&b.add(e)})}l.filtered=l.rawData.filter(x=>{let S=x._meta;if(!S||e&&!(S.nombre.toLowerCase().includes(e)||S.cedula.includes(e)||S.control.includes(e))||t&&S.cedula!==t||l.filterINE&&!p.has(String(S.cedula).trim())||l.filterSEGEN&&p.has(String(S.cedula).trim())||n&&S.fecha<n||r&&S.fecha>r||i&&S.semana!==i||a&&S.control!==a||o&&S.mun!==o||s&&S.par!==s||c&&S.nodo!==c)return!1;if(y!==``){let e=String(S.control).replace(/\D/g,``).padStart(4,`0`);if(!b.has(e))return!1}return!(u===`completada`&&S.estado!==`completada`||u===`no_efectiva`&&S.estado===`completada`||l.quickFilterMode===`efectivas`&&S.estado!==`completada`||l.quickFilterMode===`no_efectiva`&&S.estado===`completada`||l.quickFilterMode===`alertas`&&!S.hasAlerts||d&&S.situacion_vivienda!==d||f&&S.condicion!==f||m&&S.uso!==m||h&&!S.alertas.includes(h)||g!==``&&String(S.hora_trans)!==g||_!==``&&String(S.hora)!==_||v&&S.tipo_vivienda!==v)}),mn(),typeof Dn==`function`&&Dn(),document.dispatchEvent(new CustomEvent(`filtersApplied`))}function En(){[`filterEncuestador`,`filterFechaInicio`,`filterFechaFin`,`filterSemana`,`filterControl`,`filterMunicipio`,`filterParroquia`,`filterNodo`,`filterEstado`,`filterCondicion`,`filterSituacionVivienda`,`filterUso`,`filterAlerta`,`filterHoraTransmision`,`filterHoraInicio`,`filterClasificacion`,`filterTasaNoRespuesta`,`searchEncuesta`,`mm111SearchControl`].forEach(e=>{let t=x(e);if(t){t.value=``;let n=t.parentNode;if(n){let r=n.querySelector(`.combobox-container[data-select-id="${e}"]`);if(r){let e=r.querySelector(`.combobox-input`),n=r.querySelector(`.combobox-clear`),i=t.options[0];e&&(e.value=i?i.textContent:``),n&&n.classList.add(`hidden`)}}}}),l.filterINE=!1,l.filterSEGEN=!1,[`filterINE`,`filterSEGEN`].forEach(e=>{let t=x(e);t&&t.classList.remove(`active`,`bg-brand-emerald`,`bg-brand-purple`,`text-white`,`border-brand-emerald`,`border-brand-purple`)}),l.quickFilterMode=`all`,typeof window.setQuickFilter==`function`&&window.setQuickFilter(`all`),document.querySelectorAll(`.custom-preset-chip`).forEach(e=>{e.classList.remove(`ring-2`,`ring-indigo-400`,`bg-indigo-500/20`),e.classList.add(`bg-indigo-500/10`)}),J()}var Dn,On=a((()=>{m(),D(),hn(),wn(),Dn=()=>{}}));function kn(){try{let e=localStorage.getItem(Wn);return e?JSON.parse(e):[]}catch{return[]}}function An(e){try{localStorage.setItem(Wn,JSON.stringify(e))}catch{}}function jn(){let e={};return Kn.forEach(t=>{let n=x(t);e[t]=n?n.value:``}),e.filterINE=l.filterINE||!1,e.filterSEGEN=l.filterSEGEN||!1,e.quickFilterMode=l.quickFilterMode||`all`,e}function Mn(e){return Kn.some(t=>e[t]&&e[t]!==``)||e.filterINE||e.filterSEGEN||e.quickFilterMode&&e.quickFilterMode!==`all`}function Nn(e){let{filters:t}=e;Kn.forEach(e=>{let n=x(e);if(!n)return;n.value=t[e]||``;let r=n.parentNode?.querySelector(`.combobox-container`);if(r){let e=r.querySelector(`.combobox-input`),t=r.querySelector(`.combobox-clear`);if(e){let t=Array.from(n.options).find(e=>e.value===n.value);e.value=t?t.textContent:`Todos`}t&&t.classList.toggle(`hidden`,!n.value)}}),l.filterINE=t.filterINE||!1,l.filterSEGEN=t.filterSEGEN||!1,l.quickFilterMode=t.quickFilterMode||`all`,[`filterINE`,`filterSEGEN`].forEach(e=>{let t=x(e);if(!t)return;let n=l[e],r=e===`filterINE`?`bg-brand-emerald`:`bg-brand-purple`;t.classList.toggle(`active`,n),t.classList.toggle(r,n),t.classList.toggle(`text-white`,n)}),J(),Pn(e.id)}function Pn(e){document.querySelectorAll(`.custom-preset-chip`).forEach(t=>{let n=t.dataset.presetId===e;t.classList.toggle(`ring-2`,n),t.classList.toggle(`ring-indigo-400`,n),t.classList.toggle(`bg-indigo-500/20`,n),t.classList.toggle(`bg-indigo-500/10`,!n)})}function Fn(e,t){let n=kn();if(n.length>=Gn)return C(`Máximo de ${Gn} presets alcanzado. Elimina uno primero.`,`warning`),!1;let r=jn();if(!Mn(r))return C(`Aplica al menos un filtro antes de guardar.`,`warning`),!1;let i={id:`preset_${Date.now()}`,name:e.trim()||`Mi Preset`,icon:t||`bookmark`,filters:r,createdAt:new Date().toISOString()};return n.push(i),An(n),Ln(),C(`Preset "${i.name}" guardado.`,`success`),!0}function In(e){An(kn().filter(t=>t.id!==e)),Ln()}function Ln(){let e=x(`customPresetsContainer`);if(!e)return;let t=kn();if(e.innerHTML=``,t.length===0){e.classList.add(`hidden`);return}let n=document.createElement(`span`);n.className=`w-px h-4 bg-slate-300 dark:bg-slate-700 mx-1 self-center flex-none`,e.appendChild(n),t.forEach(t=>{let n=document.createElement(`button`);n.className=[`custom-preset-chip px-2.5 py-1 rounded-lg text-[10px] font-bold`,`bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400`,`border border-indigo-500/20 transition-all flex items-center gap-1.5`].join(` `),n.dataset.presetId=t.id,n.title=`Aplicar: ${t.name}`,n.innerHTML=`
        ...
        `,n.querySelector(`.preset-label`).textContent=t.name,n.addEventListener(`click`,e=>{if(e.target.closest(`.delete-preset-btn`)){e.stopPropagation(),In(t.id);return}Nn(t)}),e.appendChild(n)}),e.classList.remove(`hidden`),window.lucide&&lucide.createIcons({nodes:e.querySelectorAll(`[data-lucide]`)})}function Rn(){let e=x(`savePresetPopover`);e&&e.remove();let t=qn.map(e=>`<button type="button" class="icon-opt w-7 h-7 flex items-center justify-center rounded-md hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-slate-500" data-icon="${e}" title="${e}" aria-label="${e}">
    ...
    `,n}function zn(e,t){e.querySelectorAll(`.icon-opt`).forEach(e=>{e.classList.remove(`bg-indigo-100`,`text-indigo-500`),e.setAttribute(`aria-pressed`,`false`)}),t.classList.add(`bg-indigo-100`,`text-indigo-500`),t.setAttribute(`aria-pressed`,`true`)}function Bn(e){if(Jn){Vn();return}let t=Rn(),n=e.parentElement;[`relative`,`absolute`,`fixed`,`sticky`].includes(getComputedStyle(n).position)||(n.style.position=`relative`),n.appendChild(t),Jn=!0;let r=qn[0];window.lucide&&lucide.createIcons({nodes:Array.from(t.querySelectorAll(`[data-lucide]`))});let i=t.querySelector(`.icon-opt`);i&&zn(t,i),t.querySelector(`.icon-grid`).addEventListener(`click`,e=>{let n=e.target.closest(`.icon-opt`);n&&(zn(t,n),r=n.dataset.icon)});let a=t.querySelector(`.preset-name-input`),o=t.querySelector(`.confirm-save-btn`),s=t.querySelector(`.popover-close-btn`),c=()=>{Fn(a.value,r)&&Vn()};s.addEventListener(`click`,Vn),o.addEventListener(`click`,c),a.addEventListener(`keydown`,e=>{e.key===`Enter`&&c(),e.key===`Escape`&&Vn()}),setTimeout(()=>a.focus(),50),setTimeout(()=>document.addEventListener(`click`,Hn),100)}function Vn(){let e=x(`savePresetPopover`);e&&e.remove(),Jn=!1,document.removeEventListener(`click`,Hn)}function Hn(e){let t=x(`savePresetPopover`),n=x(`btnSavePreset`);t&&!t.contains(e.target)&&e.target!==n&&Vn()}function Un(){Ln();let e=x(`btnSavePreset`);e&&e.addEventListener(`click`,t=>{t.stopPropagation(),Bn(e)})}var Wn,Gn,Kn,qn,Jn,Yn=a((()=>{m(),D(),On(),Wn=`esca_custom_presets`,Gn=8,Kn=[`filterEncuestador`,`filterMunicipio`,`filterSemana`,`filterControl`,`filterParroquia`,`filterNodo`,`filterEstado`,`filterClasificacion`,`filterCondicion`,`filterSituacionVivienda`,`filterUso`,`filterAlerta`,`filterHoraTransmision`,`filterHoraInicio`,`filterTasaNoRespuesta`,`filterFechaInicio`,`filterFechaFin`],qn=[`bookmark`,`star`,`user`,`map-pin`,`calendar`,`filter`,`zap`,`flag`,`heart`,`target`,`briefcase`,`home`,`layers`,`tag`,`activity`],Jn=!1})),Xn=a((()=>{On(),wn(),hn(),Yn()})),Y,X,Zn,Qn,$n,er,tr=a((()=>{Y=(e,t)=>{if(!e)return null;if(e._meta&&e._meta[t]!==void 0&&e._meta[t]!==null)return e._meta[t];if(e[t]!==void 0&&e[t]!==null)return e[t];let n=String(t).split(`/`).map(e=>e.trim());for(let t of n)if(!(!t||t.includes(` `))&&e[t]!==void 0&&e[t]!==null)return e[t];return null},X=e=>e==null||e===``?`<span class="text-slate-500 font-medium italic">(No Registrado)</span>`:typeof e==`object`?`<pre class="text-[10px] bg-slate-950/20 p-2 rounded overflow-x-auto">${JSON.stringify(e,null,2)}</pre>`:`<span class="font-outfit font-bold text-slate-800 dark:text-slate-200 text-sm">${String(e)}</span>`,Zn=e=>{if(!e||typeof e!=`string`)return null;let t=e.trim().split(` `);return t.length>=2?{lat:parseFloat(t[0]),lng:parseFloat(t[1]),alt:t[2]?parseFloat(t[2]):null,acc:t[3]?parseFloat(t[3]):null}:null},Qn=(e,t)=>{if(!e||!t)return null;let n=e=>e*Math.PI/180,r=n(t.lat-e.lat),i=n(t.lng-e.lng),a=Math.sin(r/2)**2+Math.cos(n(e.lat))*Math.cos(n(t.lat))*Math.sin(i/2)**2;return 6371e3*2*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))},$n=(e,t)=>String(parseInt(e,10)||0).padStart(t,`0`),er=(e,t,n)=>`${String(e||``).trim().slice(-4)}-${String(parseInt(t,10)||0)}-${String(parseInt(n,10)||0)}`}));function nr(e){let{stEntidad:t,stMpio:n,stParr:i,valHeader:a,valLeftLabel:o,valLeftVal:s,segmentMatchStatus:c,actualSegClasses:l,actualSegText:u,actualSeg:d,stSect:f,stNodo:p,stEncuestador:m,stCedula:g,stFecha:_,stEstado:v,stDur:y,stControl:b,stLinea:x,stSerie:S,ctrlPanelHtml:C,stHogares:w,stPers:T,stCond:E,stUso:D,stSubtipo:O,stDist:k,hasAlerts:A,alertsHtml:j,hasMapData:M,isFlagged:N,walkedDistance:P,rawDist:F,durMin:I,declaredSeg:R,alertas:z}=e,ee=M?`
    ...
    `}var mr=a((()=>{m()}));function hr(e){let{displayLat:t,displayLng:n,declaredSeg:r,actualSeg:i,ptStart:a,ptIni:o,ptFin:c,ptMain:u,isFlagged:d,rec:f}=e,p=f&&f._meta?f._meta:{},m=p.control||Y(f,`control`)||Y(f,`group_sh53u78/control`)||``,h=p.n_serie||Y(f,`n_serie`)||Y(f,`group_sh53u78/n_serie`)||``,g=p.n_linea||Y(f,`n_linea`)||Y(f,`group_sh53u78/n_linea`)||``,_=er(m,h,g),v=String(m||``).trim().slice(-4);if(!l.detailMiniMapObj){l.detailMiniMapObj=L.map(`detailMap`,{zoomControl:!1,preferCanvas:!0}).setView([t,n],16);let e=L.tileLayer(`https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}`,{maxZoom:20,subdomains:[`mt0`,`mt1`,`mt2`,`mt3`],attribution:`&copy; Google`}),r=L.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`&copy; OpenStreetMap contributors`});e.addTo(l.detailMiniMapObj),l.detailMiniMapLayerControl=L.control.layers({"Google Satélite":e,OpenStreetMap:r},null,{position:`topright`}).addTo(l.detailMiniMapObj)}else if(l.detailMiniMapObj.setView([t,n],16),l.detailMiniMapObj.eachLayer(e=>{e instanceof L.TileLayer||l.detailMiniMapObj.removeLayer(e)}),l.detailMiniMapLayerControl){l.detailMiniMapObj.removeControl(l.detailMiniMapLayerControl);let e=L.tileLayer(`https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}`,{maxZoom:20,subdomains:[`mt0`,`mt1`,`mt2`,`mt3`],attribution:`&copy; Google`}),t=L.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`&copy; OpenStreetMap contributors`});l.detailMiniMapLayerControl=L.control.layers({"Google Satélite":e,OpenStreetMap:t},null,{position:`topright`}).addTo(l.detailMiniMapObj)}let y={};if(l.geoJSONData&&(y.Segmentos=L.geoJSON(l.geoJSONData,{style:e=>{let t=String(e.properties.cod_seg||`0`),n=String(e.properties.cod_seg)===String(r),i=s[t.split(``).reduce((e,t)=>e+t.charCodeAt(0),0)%s.length];return{color:n?`#FBBF24`:i,weight:n?2.5:1.5,opacity:.9,fillColor:n?`#FBBF24`:i,fillOpacity:n?.35:.15}},onEachFeature:(e,t)=>{let n=e.properties||{},a=n.cod_seg||n.id||`N/A`,o=n.cod_munici||n.mun||`N/A`,s=n.cod_parroq||n.par||`N/A`,c=String(a)===String(r),l=String(a)===String(i),u=String(a)===`000`||String(a)===`0`,d=or({cod:a,mun:o,par:s,declaredSeg:r,actualSeg:i,featureLabel:u?`Sector`:`Segmento`,displayId:u?n.cod_sc||`000`:a,isCurrent:c,isActual:l});t.bindPopup(d,{className:`custom-popup`,maxWidth:260})}}).addTo(l.detailMiniMapObj)),l.controlsData&&(y[`Vivienda Esperada`]=L.geoJSON(l.controlsData,{filter:e=>{let t=e.properties;if(er(t.CONTROL,t.SERIE,t.LINEA)===_)return!0;let n=String(t.CONTROL||``).trim().slice(-4),r=String(parseInt(t.LINEA,10)||0),i=String(parseInt(g,10)||0);return!!(v&&n===v&&(i!==`0`&&r===i||i===`0`))},pointToLayer:(e,t)=>L.circleMarker(t,{radius:7,fillColor:`#38BDF8`,color:`#ffffff`,weight:2,opacity:1,fillOpacity:1}),onEachFeature:(e,t)=>{t.bindPopup(ur(e.properties),{className:`custom-popup`})}}).addTo(l.detailMiniMapObj)),l.detailMiniMapLayerControl)for(let[e,t]of Object.entries(y))l.detailMiniMapLayerControl.addOverlay(t,e);let b=[],x=[],S=(e,t,n,r,i)=>{if(!e)return;let a=L.divIcon({className:`custom-minimap-marker`,html:`<div style="background-color:${t};width:14px;height:14px;border-radius:50%;border:2px solid white;box-shadow:0 0 10px ${t};"></div>`,iconSize:[14,14],iconAnchor:[7,7]}),o=e.acc?`<span class="text-brand-emerald">± ${e.acc}m</span>`:`<span class="text-slate-500">N/A</span>`,s=e.alt?`${e.alt}m s.n.m.`:`N/A`,c=r===`start`?i.start:i.end,u=sr(n,t,e,o,s,c?new Date(c).toLocaleTimeString():`N/A`);L.marker([e.lat,e.lng],{icon:a}).addTo(l.detailMiniMapObj).bindPopup(u,{className:`custom-popup-enrich`}),b.push([e.lat,e.lng]),x.push([e.lat,e.lng])};a&&S(a,`#3B82F6`,`Apertura de la Encuesta`,`start`,f),o&&S(o,`#10B981`,`Confirmación Inicial`,`start`,f),c&&S(c,`#F59E0B`,`Cierre de Encuesta`,`end`,f),!a&&!o&&!c&&u&&S(u,d?`#EF4444`:`#10B981`,`Ubicación Registrada`,`end`,f),x.length>1&&L.polyline(x,{color:`#94a3b8`,dashArray:`4, 4`,weight:2,opacity:.6}).addTo(l.detailMiniMapObj);let C=o||u;if(C){let e=d?`#EF4444`:`#10B981`;L.circle([C.lat,C.lng],{radius:500,color:e,fillColor:e,fillOpacity:.05,weight:1.5,dashArray:`6,5`,interactive:!1}).addTo(l.detailMiniMapObj)}if(b.length>0){let e=L.latLngBounds(b);b.length===1&&!d?l.detailMiniMapObj.setView(b[0],16):l.detailMiniMapObj.fitBounds(e,{padding:[40,40],maxZoom:18})}l.detailMiniMapObj.invalidateSize()}var gr=a((()=>{m(),cr(),mr(),tr()}));function _r(e){let t=document.querySelector(`#mainTabs .tab-btn.active`),n=t?t.getAttribute(`data-tab`):`tab-resumen`,r=[];n===`tab-inconsistencias`&&l.inconsistenciasTabulator?r=l.inconsistenciasTabulator.getData(`active`).map(e=>e._rec).filter(Boolean):l.detailTable&&(r=l.detailTable.getData(`active`).map(e=>e._rec).filter(Boolean)),(!r||r.length===0||!r.includes(e))&&(r=l.filtered&&l.filtered.includes(e)?l.filtered:l.rawData&&l.rawData.includes(e)?l.rawData:[e]),xr=r,Sr=r.indexOf(e)}function vr(e){let t=Sr+e;if(t>=0&&t<xr.length){let e=xr[t];yr(e)}}function yr(e){let t=x(`detailModal`),n=x(`detailModalBody`);if(!t||!n||!e)return;if(_r(e),l.detailMiniMapObj){try{l.detailMiniMapObj.remove()}catch(e){console.error(`[Modal] Error removing previous map object:`,e)}l.detailMiniMapObj=null}let r=x(`detailModalRecordIndex`);r&&(r.textContent=`${Sr+1} / ${xr.length}`);let i=x(`btnDetailPrev`),a=x(`btnDetailNext`);i&&(i.disabled=Sr<=0),a&&(a.disabled=Sr>=xr.length-1);let o=e._meta||{},s={stEntidad:X(o.ent||e[`S1/ent`]||e.ent||null),stMpio:X(d(o.mun||null)),stParr:X(o.par||null),stSect:X(o.sector||null),stNodo:X(o.nodo||null),stEncuestador:X(o.nombre||e[`S0/s0_nombreapellido`]||null),stCedula:X(o.cedula===`N/A`?null:o.cedula),stFecha:X(o.fecha||e.today||e._submission_time||null),stDur:X((()=>{let e=o.durMin;return e==null?null:`${parseFloat(e).toFixed(2)} min`})()),declaredSeg:o.segmento||e[`S1/segmento`]||e[`S1/group_segmeto_sector/segmento`]||null,actualSeg:o.actual_seg||null,rawControl:String(o.control||e[`group_sh53u78/control`]||``),rawSerie:String(o.n_serie||``),rawLinea:String(o.n_linea||``),stHogares:X(o.hogares??null),stPers:X(o.totalPers??null),stUso:X(o.uso||null),stCond:X(o.condicion||null),stSubtipo:o.subtipo_vivienda||null,alertas:o.alertas||[],hasAlerts:o.hasAlerts||!1,isFlagged:o.flag_distance_gt_500,durMin:o.durMin??null,rawDist:o.distance_m??null,m:o};s.isRural=s.declaredSeg===`000`||s.declaredSeg===`0`,s.valHeader=s.isRural?`Validación de Sector`:`Validación de Segmento`,s.valLeftLabel=s.isRural?`Sector Declarado`:`Declarado`,s.valLeftVal=s.isRural?Y(e,`sector`)||Y(e,`S1/sector`)||`000`:s.declaredSeg||`N/A`,s.stControl=X(s.rawControl||null),s.stLinea=X(s.rawLinea||null),s.stSerie=X(s.rawSerie||null),s.stEstado=s.m.estado===`completada`?`<span class="px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-widest bg-brand-green/20 text-brand-green border border-brand-green/30">Completada (Efectiva)</span>`:`<span class="px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-widest bg-brand-orange/20 text-brand-orange border border-brand-orange/30">No Efectiva</span>`;let c=er(s.rawControl,s.rawSerie,s.rawLinea),u=l.controlsIndex instanceof Map?l.controlsIndex.get(c):null,f=l.controlsIndex instanceof Map&&l.controlsIndex.size>0,p=s.rawControl?String(s.rawControl).trim().slice(-4):``,m=l.controlDetails instanceof Map?l.controlDetails.get(p):null,h=m?m.combos:[];s.ctrlPanelHtml=ir({m:s.m,rawControl:s.rawControl,rawSerie:s.rawSerie,rawLinea:s.rawLinea,_padM:$n,hasCtrlIndex:f,ctrlEntry:u,ctrlKey:c,validCombos:h});let g=Zn(e[`start-geopoint`]),_=Zn(e[`group_sh53u78/ubicacion_i`]||e.ubicacion_i),v=Zn(e[`ubicacion_final/ubicacion_f`]||e.ubicacion_f),y=e.lat||s.m.lat||(e._geolocation?e._geolocation[0]:null),S=e.lng||s.m.lng||(e._geolocation?e._geolocation[1]:null),C=y&&S?{lat:parseFloat(y),lng:parseFloat(S)}:null;if(s.walkedDistance=_&&v?Qn(_,v):null,s.stDist=s.walkedDistance===null?`<span class="text-slate-500 font-medium italic">N/A</span>`:`<span class="font-outfit font-black ${s.walkedDistance>30?`text-brand-red`:`text-brand-emerald`}">${Math.round(s.walkedDistance)} metros</span>`,s.hasMapData=g||_||v||C,s.segmentMatchStatus=!s.valLeftVal||!s.actualSeg?`<i data-lucide="minus" class="text-slate-400 w-4 h-4"></i>`:b(s.valLeftVal,s.actualSeg)?`<i data-lucide="check" class="text-brand-emerald w-5 h-5"></i>`:`<i data-lucide="x" class="text-brand-red w-5 h-5"></i>`,s.actualSegClasses=s.actualSeg&&!b(s.valLeftVal,s.actualSeg)?`bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800/30`:`bg-slate-100 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700`,s.actualSegText=s.actualSeg&&!b(s.valLeftVal,s.actualSeg)?`text-brand-red`:`text-slate-800 dark:text-slate-200`,s.alertsHtml=rr(s.alertas,s.m),n.innerHTML=nr(s)+ar(e),window.lucide&&lucide.createIcons({root:n}),l.lastFocused=document.activeElement,t.classList.remove(`hidden`),window.innerWidth<768){let e=x(`detailModalPane`);e&&e.classList.contains(`max-w-7xl`)&&typeof window.toggleDetailModalExpand==`function`&&window.toggleDetailModalExpand()}setTimeout(()=>{t.querySelector(`#detailModalPane`)?.classList.remove(`scale-95`,`opacity-0`)},10),s.hasMapData&&setTimeout(()=>{hr({displayLat:C?C.lat:_?_.lat:g?g.lat:v.lat,displayLng:C?C.lng:_?_.lng:g?g.lng:v.lng,declaredSeg:s.declaredSeg,actualSeg:s.actualSeg,ptStart:g,ptIni:_,ptFin:v,ptMain:C,isFlagged:s.isFlagged,rec:e})},300)}function br(){let e=x(`detailModal`);e&&(e.querySelector(`#detailModalPane`)?.classList.add(`scale-95`,`opacity-0`),setTimeout(()=>{e.classList.add(`hidden`);let t=x(`detailModalPane`),n=x(`detailModalExpandIcon`),r=x(`detailModalBody`);if(t?.classList.contains(`max-w-none`)&&(t.classList.remove(`w-full`,`max-w-none`,`h-full`,`rounded-none`),t.classList.add(`max-w-7xl`,`w-11/12`,`rounded-2xl`,`p-0`),n&&n.setAttribute(`data-lucide`,`maximize`),r&&(r.classList.remove(`flex-1`,`max-h-none`),r.classList.add(`max-h-[75vh]`))),l.detailMiniMapObj&&=(l.detailMiniMapObj.remove(),null),l.lastFocused?.focus)try{l.lastFocused.focus()}catch{}},300))}var xr,Sr,Cr=a((()=>{m(),D(),tr(),cr(),gr(),xr=[],Sr=-1,window.toggleDetailModalExpand=function(){let e=x(`detailModalPane`),t=x(`detailModalExpandIcon`),n=x(`detailMapWrapper`),r=x(`detailModalBody`);!e||!t||(e.classList.contains(`max-w-7xl`)?(e.classList.remove(`max-w-7xl`,`w-11/12`,`rounded-2xl`,`p-0`),e.classList.add(`w-full`,`max-w-none`,`h-full`,`rounded-none`),t.setAttribute(`data-lucide`,`minimize`),n&&(n.classList.remove(`h-48`,`sm:h-64`,`md:h-96`),n.classList.add(`h-[60vh]`,`md:h-[75vh]`)),r&&(r.classList.remove(`max-h-[75vh]`),r.classList.add(`flex-1`,`max-h-none`))):(e.classList.remove(`w-full`,`max-w-none`,`h-full`,`rounded-none`),e.classList.add(`max-w-7xl`,`w-11/12`,`rounded-2xl`,`p-0`),t.setAttribute(`data-lucide`,`maximize`),n&&(n.classList.remove(`h-[60vh]`,`md:h-[75vh]`),n.classList.add(`h-48`,`sm:h-64`,`md:h-96`)),r&&(r.classList.remove(`flex-1`,`max-h-none`),r.classList.add(`max-h-[75vh]`))),window.lucide&&window.lucide.createIcons(),l.detailMiniMapObj&&setTimeout(()=>l.detailMiniMapObj.invalidateSize(),350))},window.viewTraceByRecord=function(e){let t=l.rawData.find(t=>t._uuid===e||t.uuid===e);t?yr(t):console.warn(`[Modal] Registro con UUID ${e} no encontrado.`)},window.closeDetailModal=br})),wr,Tr,Er,Dr,Or,kr,Ar,jr,Mr=a((()=>{m(),wr=e=>{let t=e.getValue();return`<span style="color:${t===`completada`?`#10B981`:`#F59E0B`};font-weight:700;font-size:10px;letter-spacing:0.02em">${t===`completada`?`EFECTIVA`:`NO EFECTIVA`}</span>`},Tr=e=>{let t=e.getValue();return t===null?`—`:`<span style="color:${t<15?`#EF4444`:t<25?`#F59E0B`:`#10B981`};font-weight:800;font-family:Outfit,sans-serif;">${parseFloat(t).toFixed(2)}m</span>`},Er=e=>{let t=e.getValue();return!t||t.length===0?`<span style="color:var(--text-muted);font-size:10px">—</span>`:t.map(e=>{let t=u[e],n=t?t.label:e;return`<span title="${t?t.detail.replace(/\n/g,` `):``}" style="display:inline-flex;align-items:center;gap:3px;background:rgba(239,68,68,0.15);color:#EF4444;border:1px solid rgba(239,68,68,0.3);border-radius:4px;padding:1px 5px;font-size:9px;font-weight:700;letter-spacing:0.02em;margin-right:3px;white-space:nowrap;">⚠ ${n}</span>`}).join(``)},Dr=e=>{let t=e.getData(),n=p.has(t.cedula)?`<span style="background:#3B82F6;color:white;font-size:8px;font-weight:900;padding:1px 4px;border-radius:4px;margin-left:6px;vertical-align:middle;">INE</span>`:``;return`<div><div style="font-weight:800;color:currentColor;font-size:12px;line-height:1.3;">${t.nombre||`Sin Nombre`}${n}</div><div style="font-size:9px;color:#94a3b8;font-weight:600;">${t.cedula||`N/A`}</div></div>`},Or=e=>{let t=e.getValue(),n=t>=80?`#10B981`:t>=50?`#F59E0B`:`#EF4444`;return`<div style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:4px 0">
    ...
    </div>`},Ar=e=>{let t=e.getData(),n=t.tipoA||0,r=t.tipoB||0,i=t.tipoC||0,a=t.tipoE===void 0?t.completadas||0:t.tipoE;return`<div style="display:flex;align-items:center;gap:4px;justify-content:center;">
        ...
        <span title="Tipo E (Efectivas): ${a}" style="background:rgba(16,185,129,0.15);color:#10B981;border:1px solid rgba(16,185,129,0.3);font-size:9px;font-weight:800;padding:1px 5px;border-radius:4px;">E: ${a}</span>
    </div>`},jr=e=>{let t=e.getValue();if(!t)return`<span style="color:var(--text-muted);font-size:10px">—</span>`;let n=r[t]||r.DEFAULT;return`<span style="display:inline-flex;align-items:center;background:${n.colorBg};color:${n.color};border:1px solid ${n.color}44;border-radius:6px;padding:2px 6px;font-size:9px;font-weight:800;letter-spacing:0.03em;white-space:nowrap;">${t}</span>`}}));function Nr(e=[]){l.detailTable||(l.detailTable=new Tabulator(`#detailGrid`,{data:e,layout:`fitColumns`,height:`100%`,pagination:!0,paginationSize:25,paginationSizeSelector:[10,25,50,100],movableColumns:!0,responsiveLayout:`collapse`,clipboard:!0,placeholder:`<div style="padding:40px;text-align:center;color:var(--text-muted);font-size:14px;font-family:Inter,sans-serif;">Cargando base de datos...</div>`,columnHeaderVertAlign:`bottom`,columns:[{formatter:`responsiveCollapse`,width:30,minWidth:30,hozAlign:`center`,headerSort:!1,resizable:!1,responsive:0},{title:`Identificación`,columns:[{title:`Cédula`,field:`cedula`,headerFilter:`input`,minWidth:90,responsive:0},{title:`Nombre`,field:`nombre`,headerFilter:`input`,minWidth:140,responsive:0},{title:`Control`,field:`control`,headerFilter:`input`,width:85,responsive:0},{title:`Serie`,field:`serie`,headerFilter:`input`,width:60,responsive:2},{title:`Línea`,field:`linea`,headerFilter:`input`,width:60,responsive:2}]},{title:`Contexto`,columns:[{title:`Fecha`,field:`fecha`,headerFilter:`input`,width:90,sorter:`date`,responsive:1},{title:`Municipio`,field:`mun`,headerFilter:`input`,width:90,responsive:2},{title:`Parroquia`,field:`par`,headerFilter:`input`,width:90,responsive:4},{title:`Segm.`,field:`segmento`,headerFilter:`input`,width:70,hozAlign:`center`,responsive:4},{title:`Sect.`,field:`sector`,headerFilter:`input`,width:70,hozAlign:`center`,responsive:4}]},{title:`Métricas`,columns:[{title:`Estado`,field:`estado`,width:100,responsive:0,formatter:wr,headerFilter:`list`,headerFilterParams:{valuesLookup:!0,clearable:!0}},{title:`Subtipo`,field:`subtipo`,minWidth:160,responsive:1,formatter:jr,headerFilter:`list`,headerFilterParams:{valuesLookup:!0,clearable:!0}},{title:`Dur.`,field:`durMin`,width:70,hozAlign:`center`,responsive:2,formatter:Tr},{title:`Alertas`,field:`alertas`,minWidth:160,headerSort:!1,responsive:2,formatter:Er}]},{title:`Social`,columns:[{title:`Hog.`,field:`hogares`,width:50,hozAlign:`center`,responsive:4},{title:`Pers.`,field:`personas`,width:50,hozAlign:`center`,responsive:4}]}],rowFormatter:e=>{let t=e.getData();t.estado===`completada`?e.getElement().classList.add(`row-complete`):t.estado===`no_efectiva`&&e.getElement().classList.add(`row-no-efectiva`),t.hasAlerts&&e.getElement().classList.add(`row-flagged`)}}),l.detailTable.on(`rowClick`,(e,t)=>{let n=t.getData()._rec;n&&yr(n)}))}function Pr(e=l.filtered){let t=e.map(e=>{let t=e._meta||{};return{_rec:e,id:t.control||e._uuid,cedula:t.cedula||``,nombre:t.nombre||``,control:t.control||``,serie:t.n_serie||``,linea:t.n_linea||``,fecha:t.fecha||``,mun:d(t.mun||``),par:t.par||``,nodo:t.nodo||``,segmento:t.segmento||``,sector:t.sector||``,subtipo:t.subtipo_vivienda||``,estado:t.estado||``,durMin:t.durMin,alertas:t.alertas||[],hasAlerts:t.hasAlerts||!1,hogares:t.hogares||0,personas:t.totalPers||0}});if(!l.detailTable)Nr(t);else try{l.detailTable.setData(t).then(()=>{l.detailTable.redraw(!0)})}catch(e){console.warn(`Tabulator setData delayed:`,e.message),setTimeout(()=>{l.detailTable&&l.detailTable.setData(t).then(()=>{l.detailTable.redraw(!0)})},100)}}var Fr=a((()=>{m(),Cr(),Mr()}));function Ir(e){if(console.log(`table.js: renderRankingTable() initializing leaderboard...`),typeof Tabulator>`u`){console.error(`table.js: CRITICAL - Tabulator library is NOT loaded.`);return}if(!document.querySelector(`#rankingTable`))return;if(!e){if(!l.filtered||!l.encMap)return;let t=l.filtered.filter(e=>e&&e._meta),n=new Set(t.map(e=>e._meta.cedula));e=Object.values(l.encMap).filter(e=>n.has(e.cedula));let r={norespuesta:(e,t)=>(t.pctNoRespuesta||0)-(e.pctNoRespuesta||0),encuestas:(e,t)=>(t.encuestas||0)-(e.encuestas||0),completadas:(e,t)=>(t.completadas||0)-(e.completadas||0),eficiencia:(e,t)=>(t.pctCompleta||0)-(e.pctCompleta||0),personas:(e,t)=>(t.personas||0)-(e.personas||0)},i=l.currentSort||`norespuesta`;e.sort(r[i]||r.norespuesta)}let t=e.map((e,t)=>({pos:t+1,nombre:e.nombre||`Sin Nombre`,cedula:e.cedula||`N/A`,encuestas:e.encuestas||0,completadas:e.completadas||0,noRespuesta:e.noRespuesta||0,pctCompleta:e.pctCompleta||0,pctNoRespuesta:e.pctNoRespuesta||0,tipoA:e.tipoA||0,tipoB:e.tipoB||0,tipoC:e.tipoC||0,tipoE:e.tipoE===void 0?e.completadas||0:e.tipoE,personas:e.personas||0,alertasCount:e.alertasCount||0})),n=window.innerWidth<640;l.rankingTabulator?l.rankingTabulator.setData(t).then(()=>{l.rankingTabulator.redraw(!0)}):(l.rankingTabulator=new Tabulator(`#rankingTable`,{data:t,layout:n?`fitDataFill`:`fitColumns`,height:`460px`,responsiveLayout:`collapse`,persistence:!1,placeholder:`<div style="padding:40px;text-align:center;color:#64748b;font-size:13px;font-family:Inter,sans-serif;">Sin datos disponibles</div>`,initialSort:[{column:`pctNoRespuesta`,dir:`desc`}],columns:[{formatter:`responsiveCollapse`,width:30,minWidth:30,hozAlign:`center`,headerSort:!1,resizable:!1,responsive:0},{title:`#`,field:`pos`,width:42,hozAlign:`center`,headerSort:!1,frozen:!n,responsive:0,formatter:e=>`<span style="color:#64748b;font-weight:800;font-size:12px;">${e.getValue()}</span>`},{title:`Encuestador`,field:`nombre`,minWidth:130,frozen:!n,responsive:0,formatter:Dr},{title:`Volumen`,field:`encuestas`,hozAlign:`center`,width:85,sorter:`number`,responsive:0,formatter:e=>`<span style="font-weight:800;color:#3B82F6;font-size:13px">${e.getValue()}</span>`},{title:`No Resp. (A)`,field:`noRespuesta`,hozAlign:`center`,width:85,sorter:`number`,responsive:1,formatter:e=>`<span style="font-weight:800;color:#8B5CF6;font-size:13px">${e.getValue()}</span>`},{title:`% No Resp.`,field:`pctNoRespuesta`,hozAlign:`center`,minWidth:110,sorter:`number`,responsive:0,formatter:kr},{title:`% Efectividad`,field:`pctCompleta`,hozAlign:`center`,minWidth:110,sorter:`number`,responsive:2,formatter:Or},{title:`Tipo`,field:`tipoA`,hozAlign:`center`,minWidth:180,headerSort:!1,responsive:2,formatter:Ar},{title:`Alertas`,field:`alertasCount`,hozAlign:`center`,width:75,sorter:`number`,responsive:2,formatter:e=>{let t=e.getValue();return t>0?`<span style="font-weight:900;color:#EF4444;background:rgba(239,68,68,0.12);padding:2px 6px;border-radius:4px;">⚠ ${t}</span>`:`<span style="color:#94a3b8;">0</span>`}}]}),l.rankingTabulator.on(`rowClick`,(e,t)=>{let n=t.getData().cedula,r=document.getElementById(`filterEncuestador`);n&&r&&(r.value=n,typeof J==`function`&&J())}))}var Lr=a((()=>{m(),Xn(),Mr()})),Rr=a((()=>{Fr(),Lr(),Mr()}));function zr(){return new Promise((e,t)=>{if(!window.indexedDB){t(Error(`IndexedDB not supported`));return}let n=window.indexedDB.open(Ur,Wr);n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(Gr)||t.createObjectStore(Gr)},n.onsuccess=t=>e(t.target.result),n.onerror=e=>t(e.target.error)})}async function Br(e){try{let t=await zr();return new Promise(n=>{let r=t.transaction(Gr,`readonly`).objectStore(Gr).get(e);r.onsuccess=()=>n(r.result||null),r.onerror=()=>n(null)})}catch(e){return console.warn(`[SpatialCache] IndexedDB read fallback:`,e),null}}async function Vr(e,t){try{let n=await zr();return new Promise(r=>{let i=n.transaction(Gr,`readwrite`);i.objectStore(Gr).put(t,e),i.oncomplete=()=>r(!0),i.onerror=()=>r(!1)})}catch(e){return console.warn(`[SpatialCache] IndexedDB write fallback:`,e),!1}}function Hr(e,t=4e-5,n=5){if(!e||!e.features||e._simplifiedInBrowser)return e;console.log(`[SpatialCache] Running in-browser intermediate simplification step...`);let r=performance.now(),i=10**n;function a(e){return typeof e[0]==`number`?[Math.round(e[0]*i)/i,Math.round(e[1]*i)/i]:e.map(a)}function o(e,t,n){let r=t[0],i=t[1],a=n[0]-r,o=n[1]-i;if(a!==0||o!==0){let t=((e[0]-r)*a+(e[1]-i)*o)/(a*a+o*o);t>1?(r=n[0],i=n[1]):t>0&&(r+=a*t,i+=o*t)}return a=e[0]-r,o=e[1]-i,a*a+o*o}function s(e,t){if(e.length<=4)return e;function n(e,t,r,i,a){let s=i,c=-1;for(let n=t+1;n<r;n++){let i=o(e[n],e[t],e[r]);i>s&&(c=n,s=i)}s>i&&(c-t>1&&n(e,t,c,i,a),a.push(e[c]),r-c>1&&n(e,c,r,i,a))}let r=[e[0]];return n(e,0,e.length-1,t,r),r.push(e[e.length-1]),r}function c(e){return!e||!e.length?e:typeof e[0][0]==`number`?s(e.map(a),t*t):e.map(c)}let l=e.features.map(e=>!e.geometry||!e.geometry.coordinates?e:{...e,geometry:{...e.geometry,coordinates:c(e.geometry.coordinates)}}),u=(performance.now()-r).toFixed(1);return console.log(`[SpatialCache] In-browser simplification completed in ${u}ms.`),{...e,features:l,_simplifiedInBrowser:!0,_simplifiedTimestamp:Date.now()}}var Ur,Wr,Gr,Kr=a((()=>{Ur=`ESCA_Spatial_Cache`,Wr=3,Gr=`geojson_store`}));async function qr(){if(!l.geoJSONData)try{let e=await Br(`segmentos_monagas`);if(!e){let t=await fetch(`data/segmentos_monagas.geojson`);if(!t.ok)throw Error(`Error loading GeoJSON`);e=await t.json(),e=Hr(e),Vr(`segmentos_monagas`,e)}l.geoJSONData=e,Jr()}catch(e){console.error(`FAILED TO LOAD GEOJSON:`,e)}}function Jr(){if(!(!l.geoJSONData||!l.map))try{l.geoJSONLayer&&=(l.geoJSONLayer.remove(),l.layerControl&&l.layerControl.removeLayer(l.geoJSONLayer),null),l.geoJSONLayer=L.geoJSON(l.geoJSONData,{smoothFactor:0,style:e=>{let t=e.properties,n=s[(`${t.cod_seg===`000`||t.cod_seg===`0`?t.cod_sc||`0`:t.cod_seg||`0`}`.split(``).reduce((e,t)=>e*31+t.charCodeAt(0),0)>>>0)*13%s.length];return{color:n,weight:2,opacity:.8,fillColor:n,fillOpacity:.15}},onEachFeature:(e,t)=>{let n=e.properties,r=n.cod_seg===`000`||n.cod_seg===`0`,i=s[(`${r?n.cod_sc||`0`:n.cod_seg||`0`}`.split(``).reduce((e,t)=>e*31+t.charCodeAt(0),0)>>>0)*13%s.length],a=r?`Sector`:`Segmento`,o=r?n.cod_sc||`N/A`:n.cod_seg||`N/A`;t.bindPopup(lr(a,o,i,n),{className:`custom-popup`}),t.on(`mouseover`,function(){this.setStyle({fillOpacity:.35,weight:3})}),t.on(`mouseout`,function(){this.setStyle({fillOpacity:.15,weight:2})})}}).addTo(l.map),l.layerControl&&l.layerControl.addOverlay(l.geoJSONLayer,`Segmentos Monagas`)}catch(e){console.error(`FAILED TO DRAW GEOJSON LAYER:`,e)}}async function Yr(){if(!l.controlsIndex)try{let e=await Br(`controles_monagas`);if(!e){let t=await fetch(`data/CONTROLES.geojson`);if(!t.ok)throw Error(`Error loading CONTROLES.geojson: ${t.status}`);e=await t.json(),e=Hr(e,2e-5,5),Vr(`controles_monagas`,e)}l.controlsData=e,l.controlsIndex=new Map,l.validControls=new Set,l.validSeries=new Set,l.validLineas=new Set,l.controlDetails=new Map;let t=e=>{if(e==null)return null;let t=parseInt(String(e).trim(),10);return isNaN(t)?null:t};l.controlsData.features.forEach(e=>{let n=e.properties,r=t(n.LINEA),i=t(n.SERIE);if(r===null||i===null)return;let a=String(n.CONTROL||``).trim(),o=String(i),s=String(r);l.validControls.add(a),l.validSeries.add(o),l.validLineas.add(s),l.controlDetails.has(a)||l.controlDetails.set(a,{series:new Set,lineas:new Set,combos:[]}),l.controlDetails.get(a).series.add(o),l.controlDetails.get(a).lineas.add(s),l.controlDetails.get(a).combos.push({serie:o,linea:s}),l.controlsIndex.set(`${a}-${o}-${s}`,{COD_SEG:String(n.COD_SEG??``).trim(),COD_MANZA:String(n.COD_MANZA??``).trim()})}),l.map&&Xr()}catch(e){console.error(`FAILED TO LOAD CONTROLES.geojson:`,e)}}function Xr(){if(!(!l.controlsData||!l.map))try{l.controlsLayer&&(l.controlsLayer.remove(),l.layerControl&&l.layerControl.removeLayer(l.controlsLayer)),l.controlsLayer=L.geoJSON(l.controlsData,{pointToLayer:(e,t)=>L.circleMarker(t,{radius:3.5,fillColor:`#38BDF8`,color:`#ffffff`,weight:1,opacity:.9,fillOpacity:.85}),onEachFeature:(e,t)=>{t.bindTooltip(ur(e.properties),{sticky:!0,opacity:.95})}}),l.layerControl&&l.layerControl.addOverlay(l.controlsLayer,`Viviendas`)}catch(e){console.error(`FAILED TO DRAW CONTROLS LAYER:`,e)}}var Zr=a((()=>{m(),mr(),Kr()}));function Qr(){if(l.map)return;let e=L.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`&copy; OpenStreetMap contributors`}),t=L.tileLayer(`https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}`,{maxZoom:20,subdomains:[`mt0`,`mt1`,`mt2`,`mt3`],attribution:`&copy; Google`});l.map=L.map(`mapView`,{center:[10.4806,-66.8983],zoom:12,layers:[e],zoomControl:!1,preferCanvas:!0});let n={OpenStreetMap:e,"Google Satélite":t};l.layerControl=L.control.layers(n,{},{collapsed:window.innerWidth<768}).addTo(l.map),L.control.scale().addTo(l.map),l.markerCluster=L.markerClusterGroup({showCoverageOnHover:!1,zoomToBoundsOnClick:!0,spiderfyOnMaxZoom:!0}),l.map.addLayer(l.markerCluster),Jr(),Xr(),(window.innerWidth<768||`ontouchstart`in window)&&$r(!1)}function $r(e){if(!l.map)return;let t=document.getElementById(`btnToggleMapTouch`),n=document.getElementById(`iconMapLock`),r=l.map.dragging?l.map.dragging.enabled():!1;(typeof e==`boolean`?e:!r)?(l.map.dragging&&l.map.dragging.enable(),l.map.tapHold&&l.map.tapHold.enable(),t&&(t.classList.add(`bg-brand-blue/15`),t.title=`Mapa interactivo activo. Toca para activar scroll libre.`),n&&(n.setAttribute(`data-lucide`,`unlock`),n.setAttribute(`class`,`w-4 h-4 text-brand-emerald`))):(l.map.dragging&&l.map.dragging.disable(),t&&(t.classList.remove(`bg-brand-blue/15`),t.title=`Scroll libre activo. Toca para interactuar con el mapa.`),n&&(n.setAttribute(`data-lucide`,`lock`),n.setAttribute(`class`,`w-4 h-4 text-brand-orange`))),window.lucide&&window.lucide.createIcons&&window.lucide.createIcons()}var ei=a((()=>{m(),Zr()})),ti,ni=a((()=>{tn(),ti={findContainingFeature(e,t,n){if(!e||!t||!n||!n.features)return null;let r=V([t,e]);for(let e of n.features)if((e.geometry.type===`Polygon`||e.geometry.type===`MultiPolygon`)&&lt(r,e))return e.properties;return null},getDistance(e,t,n,r){return je(V([t,e]),V([r,n]),{units:`meters`})},createConvexHull(e){return!e||e.length<3?null:kt(ye(e.map(e=>V([e.lng,e.lat]))))},simplifyPath(e,t=1e-4){return!e||e.length<3?e:Xt(ve(e.map(e=>[e[1],e[0]])),{tolerance:t,highQuality:!0}).geometry.coordinates.map(e=>[e[1],e[0]])},getAreaKm2(e){return e?Le(e)/1e6:0}}}));function ri(){l.agentRouteLayer&&=(l.map.removeLayer(l.agentRouteLayer),null)}function ii(e){if(ri(),!e||!l.map)return;let t=l.filtered.filter(t=>t._meta?.cedula===e&&t._meta.lat&&t._meta.lng).sort((e,t)=>new Date(e.start||0).getTime()-new Date(t.start||0).getTime());if(t.length===0)return;let n=x(`mapRouteAgentCount`);n&&(n.textContent=`${t.length} ptos`);let r=t.map(e=>[e._meta.lat,e._meta.lng]),i=ti.simplifyPath(r,1e-5),a=[];a.push(L.polyline(i,{color:`#F97316`,weight:2.5,opacity:.85,dashArray:`6 4`})),t.forEach((e,t)=>{let n=e._meta,r=t+1,i=(e.start||``).slice(11,16)||`—`,o=n.durMin===null?`—`:`${Math.round(n.durMin)} min`,s=L.divIcon({className:``,html:fr(r),iconSize:[22,22],iconAnchor:[11,11]}),c=L.marker([n.lat,n.lng],{icon:s});c.bindTooltip(pr(r,i,n,o),{sticky:!0,opacity:.97}),c.on(`click`,()=>yr(e)),a.push(c)}),l.agentRouteLayer=L.layerGroup(a).addTo(l.map);let o=L.latLngBounds(i);o.isValid()&&l.map.fitBounds(o,{padding:[60,60]})}function ai(){let e=document.getElementById(`filterEncuestador`),t=document.getElementById(`btnVerRutaEncuestador`),n=document.getElementById(`mapRouteAgentCount`);if(!e||!t||t._verRutaAttached)return;t._verRutaAttached=!0;let r=()=>{let r=!!e.value,i=r?l.filtered.filter(t=>t._meta?.cedula===e.value&&t._meta.lat&&t._meta.lng).length:0;if(t.disabled=!r,n&&(n.textContent=r&&i?`${i} pts`:`—`),!r){ri(),t.dataset.routeActive=`0`,t.classList.remove(`active-filter-route`);let e=t.querySelector(`.route-label`);e&&(e.textContent=`Ver Ruta`),l.map&&l.markerCluster&&!l.map.hasLayer(l.markerCluster)&&l.map.addLayer(l.markerCluster)}};r(),e.addEventListener(`change`,r),document.addEventListener(`filtersApplied`,r),t.addEventListener(`click`,()=>{let r=e.value;if(r)if(t.dataset.routeActive===`1`){ri(),t.dataset.routeActive=`0`,l.map&&l.markerCluster&&!l.map.hasLayer(l.markerCluster)&&l.map.addLayer(l.markerCluster),t.classList.remove(`active-filter-route`);let e=l.filtered.filter(e=>e._meta?.cedula===r&&e._meta.lat&&e._meta.lng).length;n&&(n.textContent=`${e} pts`);let i=t.querySelector(`.route-label`);i&&(i.textContent=`Ver Ruta`)}else{let e=document.querySelector(`[data-tab="tab-mapa"]`);e&&e.click(),setTimeout(()=>{ii(r),t.dataset.routeActive=`1`,l.map&&l.markerCluster&&l.map.hasLayer(l.markerCluster)&&l.map.removeLayer(l.markerCluster),t.classList.add(`active-filter-route`);let e=l.filtered.filter(e=>e._meta?.cedula===r&&e._meta.lat&&e._meta.lng).length;n&&(n.textContent=`${e} pts`);let i=t.querySelector(`.route-label`);i&&(i.textContent=`Ocultar Ruta`)},200)}})}var oi=a((()=>{m(),D(),Xn(),Cr(),mr(),ni()}));function si(){if(!l.map||!l.markerCluster)return;l.markerCluster.clearLayers();let e=l.filtered.filter(e=>e._meta.lat!=null&&e._meta.lng!=null),t=e.filter(e=>e._meta&&e._meta.estado===`completada`).length,n=e.length-t,r=new Set(e.map(e=>e._meta.cedula)).size,i=e.filter(e=>e._meta.hasAlerts).length,a=new Set(e.map(e=>e._meta.mun).filter(e=>e&&e!==`N/A`)),o=new Set(e.map(e=>e._meta.par).filter(e=>e&&e!==`N/A`)),s=new Set(e.map(e=>e._meta.nodo).filter(e=>e&&e!==`N/A`));x(`mapKpiPoints`)&&(x(`mapKpiPoints`).textContent=e.length),x(`mapKpiComplete`)&&(x(`mapKpiComplete`).textContent=t),x(`mapKpiNoEfectiva`)&&(x(`mapKpiNoEfectiva`).textContent=n),x(`mapKpiAgents`)&&(x(`mapKpiAgents`).textContent=r),x(`mapKpiAlertas`)&&(x(`mapKpiAlertas`).textContent=i);let c=x(`mapCoverageBadge`);c&&e.length>0&&(c.classList.remove(`hidden`),x(`mapMunCount`)&&(x(`mapMunCount`).textContent=a.size),x(`mapParCount`)&&(x(`mapParCount`).textContent=o.size),x(`mapNodoCount`)&&(x(`mapNodoCount`).textContent=s.size));let u=e.map(e=>{let t=e._meta,n=t.estado===`completada`,r=t.hasAlerts,i=t.alertas||[],a,o,s;r?(a=`#EF4444`,o=`#DC2626`,s=`Alerta`):n?(a=`#10B981`,o=`#059669`,s=`Efectiva`):(a=`#F59E0B`,o=`#D97706`,s=`No Efectiva`);let c=L.circleMarker([t.lat,t.lng],{radius:7,fillColor:a,color:o,weight:2,opacity:.9,fillOpacity:.7});return c.bindPopup(()=>{let n=t.durMin===null?`—`:`${Math.round(t.durMin)} min`,r=t.distance_m===null?`—`:`${Math.round(t.distance_m)} m`;return dr(t,e._uuid,a,o,s,i,n,r)},{className:`custom-popup`,maxWidth:320}),c});if(l.markerCluster.addLayers(u),document.getElementById(`btnVerRutaEncuestador`)?.dataset?.routeActive===`1`){l.map.hasLayer(l.markerCluster)&&l.map.removeLayer(l.markerCluster);let e=document.getElementById(`filterEncuestador`);e&&e.value&&ii(e.value)}else if(u.length>0){let e=l.markerCluster.getBounds();e.isValid()&&l.map.fitBounds(e,{padding:[50,50]})}window.lucide&&lucide.createIcons()}var ci=a((()=>{m(),D(),Xn(),mr(),oi(),window.setQuickFilter=function(e){l.quickFilterMode=e,Object.entries({all:{id:`btnMapFilterAll`,active:[`bg-brand-blue/10`,`dark:bg-brand-blue/20`,`border-brand-blue`,`ring-brand-blue/30`],inactive:`border-brand-blue`},efectivas:{id:`btnMapFilterEfectivas`,active:[`bg-brand-emerald/10`,`dark:bg-brand-emerald/20`,`border-brand-emerald`,`ring-brand-emerald/30`],inactive:`border-brand-emerald`},no_efectiva:{id:`btnMapFilterNoEfectiva`,active:[`bg-brand-orange/10`,`dark:bg-brand-orange/20`,`border-brand-orange`,`ring-brand-orange/30`],inactive:`border-brand-orange`},alertas:{id:`btnMapFilterAlertas`,active:[`bg-brand-red/10`,`dark:bg-brand-red/20`,`border-brand-red`,`ring-brand-red/30`],inactive:`border-brand-red`}}).forEach(([t,n])=>{let r=x(n.id);if(r)if(r.classList.remove(`bg-brand-blue/10`,`dark:bg-brand-blue/20`,`border-brand-blue`,`ring-brand-blue/30`,`bg-brand-emerald/10`,`dark:bg-brand-emerald/20`,`border-brand-emerald`,`ring-brand-emerald/30`,`bg-brand-orange/10`,`dark:bg-brand-orange/20`,`border-brand-orange`,`ring-brand-orange/30`,`bg-brand-red/10`,`dark:bg-brand-red/20`,`border-brand-red`,`ring-brand-red/30`,`ring-1`,`shadow-md`,`border-slate-400`,`active-filter-blue`,`active-filter-emerald`,`active-filter-orange`,`active-filter-red`),t===e){let e=`active-filter-${t===`all`?`blue`:t===`efectivas`?`emerald`:t===`no_efectiva`?`orange`:`red`}`;r.classList.add(e,`shadow-md`)}else r.classList.add(n.inactive)}),J()}})),li=a((()=>{ei(),Zr(),ci(),oi()}));function ui(e){if(typeof Tabulator>`u`){console.error(`Tabulator not found`);return}let t=(e||[]).map((e,t)=>{let n=[];e[`S1/G_P9/GP10_0b`]&&n.push(e[`S1/G_P9/GP10_0b`]),e[`S1/P_nomsect`]&&n.push(e[`S1/P_nomsect`]);for(let t=1;t<=4;t++){let r=e[`S1/G_P9/gp10_${t}_etiq`],i=e[`S1/G_P9/GP10_${t}b`];r&&i&&n.push(`${r} ${i}`)}let r=n.length>0?n.join(`, `):e[`S1/direccion`]||`-`,i=e._meta?.nroCasa||e[`control_de_la_entrevista/in10`]||e[`control_entrevista/in10`]||e.in10||e[`S1/in10`]||`-`,a=e[`control_de_la_entrevista/in11`]||e[`control_entrevista/in11`]||`-`;return{linea:e[`group_sh53u78/n_linea`]||t+1,manzana:e[`S1/manzana`]||`-`,parcela:e[`S1/parcela`]||`-`,edificacion:e[`S1/Edificaci_n`]||e[`S1/edificacion`]||`-`,estructura:e[`S1/estructura`]||e[`S1/unidad`]||`-`,calle:r,listadoCalleNro:i,nroCasa:i,descripcion:a,residente:e._meta.residente||`-`,panel:`-`,serie:e[`group_sh53u78/n_serie`]||`-`,razon:e[`Condici_n_de_ocupaci_n/condicion_de_ocupacion`]||e._meta.condicion||`-`,observaciones:e._meta.observaciones||`-`,fecha:e._meta.fecha_entrevista||`-`,duracion:e._meta.durMin,uso:e[`S1/Uso_de_la_Unidad_inmobiliaria`]||e._meta.uso||`-`,encuestador:e._meta.nombre?e._meta.nombre.split(` `)[0]:`N/A`}});t.sort((e,t)=>parseInt(e.linea)-parseInt(t.linea)),l.mm111Table?l.mm111Table.setData(t).then(()=>{l.mm111Table.redraw(!0)}):fi(t)}function di(e){let t=e.getData();return`
        <div class="flex flex-col gap-1 py-1 font-sans text-xs">
        ...
        </div>`}function fi(e){let t=window.innerWidth<768;l.mm111Table=new Tabulator(`#mm111Grid`,{data:e,layout:t?`fitDataFill`:`fitColumns`,height:`100%`,responsiveLayout:`collapse`,placeholder:`<div class='p-12 text-center text-slate-400 font-medium'>Seleccione un número de Control para visualizar el listado de las encuestas.</div>`,columns:[{formatter:`responsiveCollapse`,width:32,minWidth:32,hozAlign:`center`,headerSort:!1,resizable:!1,responsive:0},{title:`Línea`,field:`linea`,width:65,hozAlign:`center`,responsive:0,formatter:e=>`<span class="font-mono font-bold text-slate-700 dark:text-slate-200">${e.getValue()}</span>`},{title:`Manz.`,field:`manzana`,width:65,hozAlign:`center`,responsive:1},{title:`Parc.`,field:`parcela`,width:65,hozAlign:`center`,responsive:1},{title:`Edif.`,field:`edificacion`,width:65,hozAlign:`center`,responsive:1},{title:`Estr.`,field:`estructura`,width:65,hozAlign:`center`,responsive:1},{title:`Calle / Rumbo`,field:`calle`,minWidth:160,responsive:0,formatter:`textarea`},{title:`Listado C./N° Casa`,field:`listadoCalleNro`,minWidth:140,hozAlign:`center`,responsive:0,formatter:e=>`<span class="font-mono font-bold text-slate-700 dark:text-slate-200">${e.getValue()}</span>`},{title:`Listado MM-111`,field:`descripcion`,minWidth:240,responsive:0,formatter:di},{title:`Panel`,field:`panel`,width:60,hozAlign:`center`,responsive:2},{title:`Serie`,field:`serie`,width:60,hozAlign:`center`,responsive:2,formatter:e=>`<span class="font-mono opacity-70">${e.getValue()}</span>`},{title:`Condición Inclusión`,field:`razon`,minWidth:150,responsive:0,formatter:mi},{title:`Observaciones`,field:`observaciones`,minWidth:130,responsive:2,formatter:`textarea`},{title:`Fecha`,field:`fecha`,width:95,hozAlign:`center`,responsive:1},{title:`Duración`,field:`duracion`,width:90,hozAlign:`center`,formatter:e=>{let t=e.getValue();if(t==null||isNaN(t))return`<span class="text-slate-400">—</span>`;let n=Math.round(t);return`<span class="px-2 py-0.5 rounded text-[10px] ${n<5?`bg-red-500/10 text-red-500 border border-red-500/20 font-black animate-pulse`:`bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold`}">${n} min</span>`}},{title:`Uso`,field:`uso`,minWidth:120,formatter:pi},{title:`Encuestador`,field:`encuestador`,width:100,hozAlign:`center`,formatter:e=>`<span class="text-[10px] font-black uppercase text-slate-400 tracking-wider">${e.getValue()}</span>`}]})}function pi(e){let t=String(e.getValue()).toUpperCase(),n=i.DEFAULT;for(let e in i)if(t.includes(e)){n=i[e];break}return`<span class="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-tight ${n.badge}">${t}</span>`}function mi(e){let t=String(e.getValue()).toUpperCase(),n=t.replace(/_/g,` `),r=c.DEFAULT;for(let e in c)if(t.includes(e)){r=c[e];break}return`<span class="px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-tight ${r.badge}">${n}</span>`}function hi(){[`mm111Entidad`,`mm111Municipio`,`mm111Parroquia`,`mm111CPoblado`].forEach(e=>{x(e)&&(x(e).textContent=`---`)}),[`mm111EntidadCod`,`mm111MunicipioCod`,`mm111ParroquiaCod`,`mm111CPobladoCod`].forEach(e=>{x(e)&&(x(e).textContent=`--`)}),[`mm111Segmento`,`mm111Sector`,`mm111Nodo`,`mm111Semana`,`mm111ControlMaestro`,`mm111Lote`,`mm111Duracion`].forEach(e=>{x(e)&&(x(e).textContent=`-`)}),x(`mm111ControlNro`)&&(x(`mm111ControlNro`).textContent=`0000`)}function gi(e,t){let n=x(`mm111ResultsList`);if(n){if(e.length>0){let t=l.assetName&&l.assetName.toUpperCase().includes(`EHM`)?`EHM`:`ESCA`;n.innerHTML=e.map((e,n)=>{let r=String(e.control).slice(-4).padStart(4,`0`),i=0;l.planificacionData?.por_semana&&l.planificacionData.por_semana.forEach(e=>{e.programa===t&&String(e.control).padStart(4,`0`)===r&&(i+=e.n_viviendas||0)});let a=0,o=0,s=0;l.rawData.forEach(e=>{let t=e._meta;t&&t.control&&String(t.control).slice(-4).padStart(4,`0`)===r&&(t.tipo_vivienda===`TIPO A`?a++:t.tipo_vivienda===`TIPO B`?o++:t.tipo_vivienda===`TIPO C`&&s++)});let c=i-(o+s),u=c>0?Math.round(a/c*100):0,d=u>0?`bg-red-500/10 text-red-500 border border-red-500/20`:`bg-emerald-500/10 text-emerald-500 border border-emerald-500/20`;return`
            ...
            `)}else x(`mm111Duracion`)&&(x(`mm111Duracion`).textContent=`0 min`);ui(t)}function yi(){let e=new Map;return l.filtered.forEach(t=>{let n=t._meta;!n||!n.control||e.has(n.control)||e.set(n.control,{control:n.control,mun:d(n.mun||`N/A`),seg:n.segmento||``,sec:n.sector||``})}),Array.from(e.values()).sort((e,t)=>e.control.localeCompare(t.control))}var bi=a((()=>{m(),D(),_i()}));function xi(){let e=x(`btnLoadMM111`),t=x(`mm111SearchControl`),n=x(`mm111SearchResults`),r=x(`mm111ClearSearch`);if(!t||!n)return;let i=-1,a=e=>{let t=e.toLowerCase().trim(),r=yi().filter(e=>e.control.toLowerCase().includes(t)||e.mun.toLowerCase().includes(t)||e.seg.toLowerCase().includes(t)).slice(0,50);i=-1,t.length>0||e.length===0?(n.classList.remove(`hidden`),gi(r,e),n.querySelectorAll(`.result-item`).forEach(e=>{e.onclick=()=>o(e.getAttribute(`data-value`))})):n.classList.add(`hidden`)},o=async e=>{t&&(t.value=e),n&&n.classList.add(`hidden`),e.trim().length>0&&r?.classList.remove(`hidden`);let i=x(`filterControl`);i&&(i.value=e),vi(e),J()};t.onfocus=()=>a(t.value),t.oninput=()=>{t.value.trim().length>0?r?.classList.remove(`hidden`):r?.classList.add(`hidden`),a(t.value)},t.onkeydown=e=>{let t=n.querySelectorAll(`.result-item`);e.key===`ArrowDown`?(e.preventDefault(),i=Math.min(i+1,t.length-1),s(t)):e.key===`ArrowUp`?(e.preventDefault(),i=Math.max(i-1,0),s(t)):e.key===`Enter`?(e.preventDefault(),i>=0&&t[i]?o(t[i].getAttribute(`data-value`)):t.length>0&&o(t[0].getAttribute(`data-value`))):e.key===`Escape`&&n.classList.add(`hidden`)};let s=e=>{e.forEach((e,t)=>{t===i?(e.classList.add(`active`,`bg-brand-blue/10`,`dark:bg-brand-blue/20`,`ring-1`,`ring-brand-blue/30`),e.scrollIntoView({block:`nearest`})):e.classList.remove(`active`,`bg-brand-blue/10`,`dark:bg-brand-blue/20`,`ring-1`,`ring-brand-blue/30`)})};r&&(r.onclick=async()=>{t.value=``,r.classList.add(`hidden`);let e=x(`filterControl`);e&&(e.value=``);let n=x(`filterFechaInicio`),i=x(`filterFechaFin`);n&&(n.value=``),i&&(i.value=``),t.focus(),a(``),J()}),e&&(e.onclick=()=>o(t.value.trim())),document.addEventListener(`click`,e=>{!t.contains(e.target)&&!n.contains(e.target)&&n.classList.add(`hidden`)})}var Si=a((()=>{D(),bi(),_i(),On(),document.addEventListener(`filtersApplied`,()=>{let e=x(`filterControl`)?.value,t=x(`mm111SearchControl`),n=x(`mm111ClearSearch`);t&&e&&t.value!==e?(t.value=e,n&&n.classList.remove(`hidden`),vi(e)):t&&!e&&t.value!==``&&(t.value=``,n&&n.classList.add(`hidden`),hi(),ui([]))})}));function Ci(){wi||=(xi(),!0);let e=x(`mm111SearchControl`),t=x(`mm111ClearSearch`),n=x(`mm111FilteredCount`);if(!e)return;n&&(n.textContent=x(`kpiControles`)?.textContent||`0`),e.value.trim().length===0?t?.classList.add(`hidden`):t?.classList.remove(`hidden`);let r=e.value.trim();r?vi(r):(hi(),ui([]))}var wi,Ti=a((()=>{D(),Si(),bi(),_i(),wi=!1}));function Ei(){return`
        ...
        </div>`}function Di(e,t,n){let r=u[e]||{label:e},i=Oi[e]||{bg:`#64748b22`,border:`#64748b`,text:`#64748b`},a=n===e,o=a?`ring-2 ring-offset-1 dark:ring-offset-[#0B1120]`:``,s=a?`ring-color: ${i.border}; border-color: ${i.border};`:`border-color:${i.border}30;`;return`
    ...
    </div>`}var sa=a((()=>{}));function ca(){return`
    ...
    </div>`}var la=a((()=>{}));function ua(){return`
    ...
    </div>`}var da=a((()=>{}));function fa(){return`
    ...
    </div>`}var pa=a((()=>{}));function ma(){return`
    ...
    </div>`}var ha=a((()=>{}));function ga(){return`
        ...
        <div class="xl:col-span-8 flex flex-col gap-4">
          ...
          <div class="card-premium !p-0 overflow-hidden">
            ...
            <div class="rpt-section-body px-4 pb-4 border-t border-slate-100 dark:border-slate-800" data-section="demografia">
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-2.5 pt-3">
                ${_a([{id:`rpt-f-totalPers`,label:`Total Personas`,desc:`N° de miembros del hogar`,checked:!1},{id:`rpt-f-hogares`,label:`N° Hogares`,desc:`Hogares por encuesta`,checked:!1},{id:`rpt-f-hombres`,label:`Hombres`,desc:`Total de sexo masculino`,checked:!1},{id:`rpt-f-mujeres`,label:`Mujeres`,desc:`Total de sexo femenino`,checked:!1}])}
              </div>
            </div>
          </div>
    ...
    </div>`}function _a(e){return e.map(({id:e,label:t,desc:n,checked:r})=>`
    ...
    `).join(``)}var va=a((()=>{})),ya=a((()=>{sa(),la(),da(),pa(),ha(),va()}));function ba(){return`
    ...
    </div>`}var xa=a((()=>{}));function Sa(){return`
    <div id="errorState"
    ...
    </div>`}var Ca=a((()=>{}));function wa(){return`
    ...
    <div id="offCanvasFilters"
      ...
      <div class="flex-1 overflow-y-auto p-6 flex flex-col gap-8 relative z-10 custom-scrollbar">
        ...
        <!-- Cartografía y Capas GeoJSON -->
        <div class="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-5 border border-slate-200 dark:border-slate-800">
          <h4 class="text-xs uppercase font-black text-slate-400 tracking-widest flex items-center gap-2 mb-4">
            <i data-lucide="layers" class="w-3.5 h-3.5 text-brand-emerald"></i> Cartografía Espacial
          </h4>
          <div>
            <label class="block text-[11px] font-bold text-slate-500 mb-2 ml-1">Capas GeoJSON Personalizadas</label>
            <button id="btnOpenUploadGeoJSON" type="button" class="w-full flex items-center justify-center gap-2 py-3 px-4 bg-white dark:bg-surface-dark border border-brand-blue/30 dark:border-brand-blue/40 rounded-xl text-brand-blue hover:bg-brand-blue/10 transition-all text-xs font-bold uppercase shadow-sm cursor-pointer group">
              <i data-lucide="upload-cloud" class="w-4 h-4 group-hover:scale-110 transition-transform"></i> Subir GeoJSON
            </button>
          </div>
        </div>
    ...
    </div>`}var Ta=a((()=>{}));function Ea(){return`
    ...
    </div>`}var Da=a((()=>{}));function Oa(){return`
  <!-- GeoJSON Upload Modal Overlay -->
  <div id="uploadGeoJSONModal" class="fixed inset-0 z-[9999] bg-slate-900/60 backdrop-blur-sm hidden flex items-center justify-center p-4 transition-all duration-300">
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden flex flex-col transform transition-all scale-95 opacity-0 duration-200" id="uploadGeoJSONModalCard">
      ...
      <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50">
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-xl bg-brand-blue/10 dark:bg-brand-blue/20 text-brand-blue flex items-center justify-center font-bold">
            <i data-lucide="upload-cloud" class="w-5 h-5"></i>
          </div>
          <div>
            <h3 class="text-base font-bold text-slate-800 dark:text-slate-100">Cargar Capa GeoJSON</h3>
            <p class="text-xs text-slate-400">Importa y simplifica cartografía en tiempo real</p>
          </div>
        </div>
        <button id="btnCloseUploadGeoJSON" class="p-2 rounded-lg text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
          <i data-lucide="x" class="w-5 h-5"></i>
        </button>
      </div>
      ...
      <div class="p-6 space-y-5 flex-1 overflow-y-auto custom-scrollbar">
        ...
        <!-- Drag & Drop Zone -->
        <div id="geojsonDropZone" class="border-2 border-dashed border-slate-300 dark:border-slate-700/80 hover:border-brand-blue dark:hover:border-brand-blue rounded-xl p-6 text-center cursor-pointer transition-all bg-slate-50/50 dark:bg-slate-800/30 group relative">
          <input type="file" id="geojsonFileInput" accept=".geojson,.json" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" />
          <div class="flex flex-col items-center gap-2 pointer-events-none">
            <div class="w-12 h-12 rounded-full bg-brand-blue/10 text-brand-blue flex items-center justify-center group-hover:scale-110 transition-transform">
              <i data-lucide="file-up" class="w-6 h-6"></i>
            </div>
            <p class="text-sm font-semibold text-slate-700 dark:text-slate-200">
              Arrastra tu archivo <span class="text-brand-blue font-bold">.geojson</span> aquí
            </p>
            <p class="text-xs text-slate-400">o haz clic para explorar tus archivos</p>
          </div>
        </div>

        <!-- Options Container (hidden until file selected) -->
        <div id="geojsonFileDetails" class="hidden space-y-4">
          
          <!-- File Info Pill -->
          <div class="bg-slate-100 dark:bg-slate-800/60 rounded-xl p-4 flex items-center justify-between border border-slate-200/60 dark:border-slate-700/60">
            <div class="flex items-center gap-3 overflow-hidden">
              <i data-lucide="file-code" class="w-5 h-5 text-brand-blue shrink-0"></i>
              <div class="truncate">
                <p id="geojsonFileName" class="text-xs font-bold text-slate-800 dark:text-slate-100 truncate">—</p>
                <p id="geojsonFileRawSize" class="text-[11px] text-slate-400">—</p>
              </div>
            </div>
            <span id="geojsonFeatureCountBadge" class="px-2.5 py-1 rounded-full text-[10px] font-bold bg-brand-blue/10 text-brand-blue border border-brand-blue/20">0 Entidades</span>
          </div>

          <!-- Target Layer Select -->
          <div class="grid grid-cols-2 gap-3">
            <div>
              <label class="block text-xs font-bold text-slate-600 dark:text-slate-300 mb-1.5">Tipo de Capa</label>
              <select id="geojsonTargetLayer" class="w-full bg-white dark:bg-surface-dark border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-medium text-slate-700 dark:text-slate-200 outline-none focus:border-brand-blue">
                <option value="segmentos">Segmentos / Polígonos</option>
                <option value="controles">Viviendas / Puntos Control</option>
              </select>
            </div>
            <div>
              <label class="block text-xs font-bold text-slate-600 dark:text-slate-300 mb-1.5">Simplificación Cliente</label>
              <select id="geojsonSimplificationRatio" class="w-full bg-white dark:bg-surface-dark border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-medium text-slate-700 dark:text-slate-200 outline-none focus:border-brand-blue">
                <option value="40" selected>Recomendada (40%)</option>
                <option value="30">Alta Compresión (30%)</option>
                <option value="60">Fidelidad Elevada (60%)</option>
                <option value="100">Sin Simplificar (100%)</option>
              </select>
            </div>
          </div>

          <!-- Metrics Preview Box -->
          <div class="bg-brand-blue/5 dark:bg-brand-blue/10 rounded-xl p-4 border border-brand-blue/20 text-xs space-y-2">
            <div class="flex items-center justify-between text-slate-600 dark:text-slate-300 font-semibold">
              <span>Tamaño Estimado Optimizado:</span>
              <span id="geojsonOptimizedSize" class="text-brand-blue font-bold">—</span>
            </div>
            <div class="flex items-center justify-between text-slate-500 text-[11px]">
              <span>Ahorro Estimado:</span>
              <span id="geojsonSavingsPct" class="text-emerald-500 font-bold">—</span>
            </div>
          </div>
      ...
      <div class="px-6 py-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 flex items-center justify-end gap-3">
        <button id="btnCancelGeoJSONUpload" class="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors uppercase">
          Cancelar
        </button>
        <button id="btnApplyGeoJSONUpload" disabled class="btn-primary px-5 py-2.5 text-xs font-bold uppercase flex items-center gap-2 opacity-50 cursor-not-allowed">
          <i data-lucide="check-circle-2" class="w-4 h-4"></i> Aplicar Capa al Mapa
        </button>
      </div>

    </div>
  </div>`}function ka(){let e=document.getElementById(`uploadGeoJSONModal`),t=document.getElementById(`uploadGeoJSONModalCard`);!e||!t||(e.classList.remove(`hidden`),setTimeout(()=>{t.classList.remove(`scale-95`,`opacity-0`),t.classList.add(`scale-100`,`opacity-100`)},10),window.lucide&&lucide.createIcons())}function Aa(){let e=document.getElementById(`uploadGeoJSONModal`),t=document.getElementById(`uploadGeoJSONModalCard`);!e||!t||(t.classList.remove(`scale-100`,`opacity-100`),t.classList.add(`scale-95`,`opacity-0`),setTimeout(()=>{e.classList.add(`hidden`)},200))}var ja=a((()=>{})),Ma=a((()=>{xa(),Ca(),Ta(),Da(),ja()}));function Na(){let e=x(`mainContent`),t=document.body;if(!e){console.error(`Layout Error: mainContent element not found.`);return}let n=[ma(),ca(),fa(),ua(),oa(),ga()].join(``);e.insertAdjacentHTML(`beforeend`,n);let r=[Ea(),Sa(),wa(),ba(),Oa()].join(``);t.insertAdjacentHTML(`beforeend`,r),console.log(`UI Layout: All components injected successfully ✓`)}var Pa=a((()=>{D(),ya(),Ma()})),Fa=a((()=>{Pa()}));function Ia(){let e=localStorage.getItem(`esca_theme`),t=!0;e===`light`?t=!1:e===`dark`&&(t=!0),La(t);let n=x(`btnThemeToggle`);n&&n.addEventListener(`click`,()=>{La(!document.documentElement.classList.contains(`dark`))})}function La(e){let t=x(`iconMoon`),n=x(`iconSun`);e?(document.documentElement.classList.add(`dark`),localStorage.setItem(`esca_theme`,`dark`),t&&(t.style.display=`none`),n&&(n.style.display=`block`)):(document.documentElement.classList.remove(`dark`),localStorage.setItem(`esca_theme`,`light`),t&&(t.style.display=`block`),n&&(n.style.display=`none`)),Bi(e)}var Ra=a((()=>{D(),aa()}));function za(e=l.filtered){if(!l.planificacionData||!l.planificacionData.por_semana)return 0;let t=l.assetName&&l.assetName.toUpperCase().includes(`EHM`)?`EHM`:`ESCA`,n=x(`filterSemana`)?.value??``,r=x(`filterControl`)?.value??``,i=x(`filterMunicipio`)?.value??``,a=x(`filterParroquia`)?.value??``,o=x(`filterEncuestador`)?.value??``,s=null;o&&e&&(s=new Set(e.map(e=>e._meta?.control?String(e._meta.control).replace(/\D/g,``).padStart(4,`0`):null).filter(Boolean)));let c=``;i&&(c=i.replace(/^\d+\s*/,``).trim().toUpperCase());let u=``;a&&(u=a.replace(/^\d+\s*/,``).trim().toUpperCase());let d=0;return l.planificacionData.por_semana.forEach(e=>{e.programa===t&&(n&&e.semana!==Number(n)||r&&String(e.control).replace(/\D/g,``).padStart(4,`0`)!==r.replace(/\D/g,``).padStart(4,`0`)||s&&!s.has(String(e.control).replace(/\D/g,``).padStart(4,`0`))||c&&e.municipio.toUpperCase()!==c||u&&e.parroquia.toUpperCase()!==u||(d+=e.n_viviendas||0))}),d}function Ba(){let e=l.filtered.filter(e=>e._meta&&e._meta.estado===`completada`).length,t=l.filtered.length-e,n=new Set(l.filtered.map(e=>e._meta.cedula)).size,r=l.filtered.filter(e=>e._meta.estado===`completada`).map(e=>e._meta.durMin).filter(e=>e!==null),i=r.length?v(r):0,a=l.filtered.reduce((e,t)=>e+(t._meta.totalPers||0),0),o=e>0?(a/e).toFixed(1):`0`,s=l.filtered.reduce((e,t)=>e+(t._meta.hogaresUniPersonales||0),0),c=new Set(l.filtered.map(e=>e._meta.control)).size,u=l.filtered.reduce((e,t)=>e+(t._meta.totalHombres||0),0),d=l.filtered.reduce((e,t)=>e+(t._meta.totalMujeres||0),0),f=new Set(l.filtered.map(e=>e._meta.mun)).size,m=l.filtered.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO A`).length,h=l.filtered.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO B`).length,g=l.filtered.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO C`).length,_=l.filtered.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO E`).length,y=l.filtered.filter(e=>e._meta&&e._meta.tipo_vivienda===`NO DEFINIDO`).length,b=l.filtered.length||1,S=Math.round(m/b*100),C=Math.round(h/b*100),w=Math.round(g/b*100),T=Math.round(_/b*100),E=Math.round(y/b*100);x(`kpiTotal`)&&(x(`kpiTotal`).textContent=l.filtered.length),x(`kpiCompletadas`)&&(x(`kpiCompletadas`).textContent=e),x(`kpiNoEfectiva`)&&(x(`kpiNoEfectiva`).textContent=t),x(`kpiEncuestadores`)&&(x(`kpiEncuestadores`).textContent=n),x(`kpiDuracion`)&&(x(`kpiDuracion`).textContent=i?`${Math.round(i)} min`:`N/A`),x(`kpiPersonas`)&&(x(`kpiPersonas`).textContent=o),x(`kpiHogaresUni`)&&(x(`kpiHogaresUni`).textContent=s),x(`kpiControles`)&&(x(`kpiControles`).textContent=c),x(`kpiHombres`)&&(x(`kpiHombres`).textContent=u),x(`kpiMujeres`)&&(x(`kpiMujeres`).textContent=d),x(`kpiMunicipios`)&&(x(`kpiMunicipios`).textContent=f),x(`kpiTipoA`)&&(x(`kpiTipoA`).textContent=m),x(`pctTipoA`)&&(x(`pctTipoA`).textContent=`${S}%`),x(`kpiTipoB`)&&(x(`kpiTipoB`).textContent=h),x(`pctTipoB`)&&(x(`pctTipoB`).textContent=`${C}%`),x(`kpiTipoC`)&&(x(`kpiTipoC`).textContent=g),x(`pctTipoC`)&&(x(`pctTipoC`).textContent=`${w}%`),x(`kpiTipoE`)&&(x(`kpiTipoE`).textContent=_),x(`pctTipoE`)&&(x(`pctTipoE`).textContent=`${T}%`),x(`kpiTipoND`)&&(x(`kpiTipoND`).textContent=y),x(`pctTipoND`)&&(x(`pctTipoND`).textContent=`${E}%`);let D=l.filtered.length/(n*8||1);x(`kpiEncPerHour`)&&(x(`kpiEncPerHour`).textContent=D.toFixed(1));let O={};l.filtered.forEach(e=>{let t=e._meta&&e._meta.nombre||`Desconocido`;O[t]=(O[t]||0)+1});let k=Object.entries(O).sort((e,t)=>t[1]-e[1])[0]||[`--`,0];x(`kpiTopProducer`)&&(x(`kpiTopProducer`).textContent=String(k[0]).split(` `)[0]),x(`kpiTopProducerVal`)&&(x(`kpiTopProducerVal`).textContent=`${k[1]} encuestas`);let A=l.filtered.filter(e=>e._meta&&e._meta.hasAlerts).length,j=l.filtered.length>0?Math.round(e/l.filtered.length*100):0,M=l.filtered.length>0?Math.round(A/l.filtered.length*100):0,N=x(`searchEncuesta`)?.value.toLowerCase()??``,P=x(`filterEncuestador`)?.value??``,F=x(`filterFechaInicio`)?.value??``,I=x(`filterFechaFin`)?.value??``,R=x(`filterSemana`)?.value??``,z=x(`filterControl`)?.value??``,ee=x(`filterMunicipio`)?.value??``,te=x(`filterParroquia`)?.value??``,ne=x(`filterNodo`)?.value??``,re=x(`filterSituacionVivienda`)?.value??``,ie=x(`filterCondicion`)?.value??``,ae=x(`filterUso`)?.value??``,B=x(`filterAlerta`)?.value??``,oe=x(`filterHoraTransmision`)?.value??``,se=x(`filterHoraInicio`)?.value??``,ce=l.rawData.filter(e=>{let t=e._meta;return!(!t||N&&!(t.nombre.toLowerCase().includes(N)||t.cedula.includes(N)||t.control.includes(N))||P&&t.cedula!==P||l.filterINE&&!p.has(String(t.cedula).trim())||l.filterSEGEN&&p.has(String(t.cedula).trim())||F&&t.fecha<F||I&&t.fecha>I||R&&t.semana!==R||z&&t.control!==z||ee&&t.mun!==ee||te&&t.par!==te||ne&&t.nodo!==ne||re&&t.situacion_vivienda!==re||ie&&t.condicion!==ie||ae&&t.uso!==ae||B&&!t.alertas.includes(B)||oe!==``&&String(t.hora_trans)!==oe||se!==``&&String(t.hora)!==se)}),le=ce.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO A`).length,ue=ce.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO B`).length,de=ce.filter(e=>e._meta&&e._meta.tipo_vivienda===`TIPO C`).length,fe=za(ce),pe=(fe>0?fe:ce.length)-(ue+de),me=pe>0?Math.round(le/pe*100):le>0?100:0;x(`kpiTasaEfectividad`)&&(x(`kpiTasaEfectividad`).textContent=`${j}%`),x(`kpiTasaNoRespuesta`)&&(x(`kpiTasaNoRespuesta`).textContent=`${me}%`),x(`kpiTotalAlertas`)&&(x(`kpiTotalAlertas`).textContent=A),x(`kpiTasaAlerta`)&&(x(`kpiTasaAlerta`).textContent=`${M}%`);let he={};l.filtered.forEach(e=>{e._meta&&e._meta.hora!==null&&(he[e._meta.hora]=(he[e._meta.hora]||0)+1)});let ge=Object.entries(he).sort((e,t)=>t[1]-e[1])[0]||[null,0];x(`kpiPeakHour`)&&(x(`kpiPeakHour`).textContent=ge[0]===null?`--`:`${ge[0]}:00`);let V=x(`inputMetaDiaria`),_e=n*(V&&!isNaN(Number(V.value))&&Number(V.value)>0?Number(V.value):20),ve=Math.min(100,l.filtered.length/(_e||1)*100);x(`kpiMetaProgreso`)&&(x(`kpiMetaProgreso`).textContent=`${Math.round(ve)}%`),x(`kpiMetaBar`)&&(x(`kpiMetaBar`).style.width=`${ve}%`);let ye=l.filtered.length||1,be=Math.round(e/ye*100);x(`rankKpiPctNoRespuesta`)&&(x(`rankKpiPctNoRespuesta`).textContent=`${me}%`),x(`rankKpiNoEfectivaSub`)&&(x(`rankKpiNoEfectivaSub`).textContent=`(${m} Tipo A)`),x(`rankKpiEfectivas`)&&(x(`rankKpiEfectivas`).textContent=e),x(`rankKpiPctEfectivas`)&&(x(`rankKpiPctEfectivas`).textContent=`(${be}%)`),x(`rankKpiAlerts`)&&(x(`rankKpiAlerts`).textContent=A)}function Va(){let e=document.getElementById(`subtiposBreakdownContainer`);if(!e)return;let t=l.filtered.length||1,n={};l.filtered.forEach(e=>{let t=e._meta?.subtipo_vivienda||`Otro (Especifique)`;n[t]=(n[t]||0)+1}),e.innerHTML=Ha.map(e=>{let i=e.subtypes.reduce((e,t)=>e+(n[t]||0),0),a=t>0?Math.round(i/t*100):0,o=e.subtypes.filter(e=>(n[e]||0)>0),s=o.length>0?o.map(e=>{let i=n[e]||0,a=t>0?Math.round(i/t*100):0,o=r[e]||r.DEFAULT,s=h[e]||``;return`
            ...
            </div>`}).join(``),window.lucide&&window.lucide.createIcons({root:e})}var Ha,Ua=a((()=>{m(),D(),Ha=[{tipo:`TIPO A`,label:`Ausentes / Rechazos / No Respuesta`,icon:`user-round-x`,color:`#8B5CF6`,borderClass:`!border-l-2 !border-l-[#8B5CF6]`,tooltip:`Viviendas con ausencias, rechazos o informantes no calificados (AT, IN, OA, IC, PE, NO, RZ, SE).`,subtypes:[`Ausente Temporalmente`,`Incompleta`,`Ocupantes Ausentes`,`Informante No Calificado`,`Pendiente`,`No Atiende Telefono`,`Rechazada`,`Sin Entrevista`]},{tipo:`TIPO B`,label:`Desocupadas / Ocasionales / Construcción`,icon:`brick-wall`,color:`#F59E0B`,borderClass:`!border-l-2 !border-l-[#F59E0B]`,tooltip:`Viviendas en construcción, desocupadas, vacacionales, ocasionales o inadecuadas para uso (CO, IU, VD, VO, UV, TN).`,subtypes:[`Construccion`,`Inadecuada para Uso`,`Vivienda Desocupada`,`Vivienda Ocasional`,`Uso Vacasional`,`Temporalmente en Negocio`]},{tipo:`TIPO C`,label:`Inexistentes / No Residenciales / Demolidas`,icon:`hammer`,color:`#64748B`,borderClass:`!border-l-2 !border-l-[#64748B]`,tooltip:`Viviendas demolidas, mal listadas, inexistentes, negocios permanentes u otras situaciones no residenciales (DE, ML, NE, SL, OT, OS, NT, NP, OE, CD).`,subtypes:[`Demolida`,`Mal Listada`,`No Existe`,`Sin Listar`,`Otra Condicion`,`Otra Situacion`,`No Existe Nro Telefonico`,`Negocio Permanente`,`Otro (Especifique)`,`Consolidada`]},{tipo:`TIPO E`,label:`Entrevistas Efectivas`,icon:`user-check`,color:`#10B981`,borderClass:`!border-l-2 !border-l-[#10B981]`,tooltip:`Viviendas con entrevistas exitosas (Totalmente Encuestadas - TE).`,subtypes:[`Totalmente Encuestado`]}]})),Wa,Ga,Ka,qa,Ja=a((()=>{Wa=`modulepreload`,Ga=function(e,t){return new URL(e,t).href},Ka={},qa=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Ga(t,n),t in Ka)return;Ka[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Wa,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));function Ya(e){if(!e)return;let t=x(`mainTabs`);t&&t.querySelectorAll(`.tab-btn`).forEach(t=>{let n=t.dataset.tab===e;t.classList.toggle(`tab-btn-active`,n),t.classList.toggle(`active`,n)}),document.querySelectorAll(`.tab-content`).forEach(t=>{t.classList.toggle(`hidden-tab`,t.id!==e)}),e===`tab-mapa`&&(l.map||Qr(),setTimeout(()=>{l.map.invalidateSize(),setTimeout(()=>{let e=!1;Xa[`tab-mapa`]||(Xa[`tab-mapa`]=!0,Pr(),e=!0),si(),l.detailTable&&!e&&l.detailTable.redraw(!0),window.lucide&&window.lucide.createIcons()},200)},50)),e===`tab-ranking`&&(Xa[`tab-ranking`]?l.rankingTabulator&&setTimeout(()=>l.rankingTabulator.redraw(!0),50):(Xa[`tab-ranking`]=!0,setTimeout(()=>Ir(),100))),e===`tab-mm111`&&(l.mm111Table&&l.mm111Table.redraw(),!l.mm111Table&&l.filtered.length>0&&Ci()),e===`tab-reportes`&&qa(async()=>{let{initReportesTab:e}=await import(`./reportes-DrSnxbD3.js`);return{initReportesTab:e}},__vite__mapDeps([0,1]),import.meta.url).then(({initReportesTab:e})=>{e(),window.lucide&&window.lucide.createIcons()}).catch(e=>console.error(`[navigation] Error loading reportes module:`,e)),setTimeout(()=>{Object.values(l.charts).forEach(e=>{e&&typeof e.resize==`function`&&(e.update(`none`),e.resize())}),window.dispatchEvent(new Event(`resize`))},50),window.lucide&&window.lucide.createIcons()}var Xa,Za=a((()=>{m(),D(),li(),Rr(),Ti(),zi(),Ja(),Xa={}}));function Qa(e){let t=x(`mapSectionWrapper`),n=x(`mapKpiGrid`),r=x(`mapDisplayContainer`),i=n?n.querySelector(`.header-label`):null;if(!t||!n||!r)return;e===`full`?$r(!0):window.innerWidth<768&&$r(!1),document.body.classList.remove(`has-map-fullscreen`),t.className=`flex flex-col lg:grid lg:grid-cols-12 gap-4 sm:gap-8 transition-all duration-500 overflow-visible items-stretch`,r.className=`lg:col-span-10 relative transition-all duration-500 rounded-2xl overflow-hidden shadow-xl border border-slate-200 dark:border-white/5 bg-slate-100 dark:bg-slate-900`,n.className=`lg:col-span-2 transition-all duration-500 overflow-visible flex flex-col gap-3`,i&&(i.className=`header-label text-[9px] uppercase font-bold text-slate-500 dark:text-slate-400 tracking-widest ml-1 mb-1`);let a=x(`btnToggleMapKpis`);if(a&&a.classList.add(`hidden`),n.querySelectorAll(`button:not(#btnToggleMapKpis), div.glass-panel`).forEach(e=>{e.className=e.id===`btnVerRutaEncuestador`?`glass-panel rounded-xl p-3 flex items-center justify-between !border-l-4 !border-orange-500 hover:bg-orange-500/5 transition-all group disabled:opacity-40 disabled:cursor-not-allowed`:`glass-panel rounded-xl p-3 flex items-center justify-between !border-l-4 hover:bg-slate-100/50 dark:hover:bg-white/5 transition-all group`,e.id===`btnMapFilterAll`&&e.classList.add(`!border-brand-blue`),e.id===`btnMapFilterEfectivas`&&e.classList.add(`!border-brand-emerald`),e.id===`btnMapFilterNoEfectiva`&&e.classList.add(`!border-brand-orange`),e.id===`btnMapFilterAlertas`&&e.classList.add(`!border-brand-red`),(e.classList.contains(`opacity-80`)||e.id===`kpiMapEncuestadorContainer`)&&e.classList.add(`border-brand-purple`);let t=e.querySelector(`span.uppercase`);t&&t.classList.remove(`hidden`)}),e===`normal`)t.classList.add(`h-auto`,`lg:h-[88vh]`,`lg:min-h-[700px]`),r.classList.add(`h-[500px]`,`lg:h-auto`,`lg:col-span-10`),n.classList.add(`grid`,`grid-cols-2`,`sm:flex`,`sm:flex-col`,`gap-2`),i&&i.classList.add(`hidden`,`sm:block`),n.querySelectorAll(`:scope > button, :scope > div.glass-panel`).forEach(e=>{e.id!==`btnToggleMapKpis`&&e.classList.add(`flex-row`,`items-center`,`justify-between`)});else if(e===`expanded`)t.className=`flex flex-col items-center gap-6 transition-all duration-500 w-full mb-8`,r.className=`w-full h-[75vh] relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-white/10`,n.className=`flex flex-wrap sm:flex-nowrap grid grid-cols-2 sm:flex flex-row gap-2 sm:gap-8 mt-4 sm:mt-6 mx-auto max-w-[95%] sm:max-w-fit bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-slate-200 dark:border-white/10 px-4 sm:px-10 py-1.5 sm:py-2 shadow-2xl`,i&&i.classList.add(`hidden`),n.querySelectorAll(`:scope > button, :scope > div.glass-panel`).forEach(e=>{e.id!==`btnToggleMapKpis`&&e.classList.add(`flex-col`,`items-center`,`justify-center`,`min-w-0`,`sm:min-w-[130px]`,`flex-1`,`!border-l-0`,`!border-b-2`,`sm:!border-b-4`,`gap-0.5`,`py-1`,`sm:py-1.5`,`px-2`)});else if(e===`full`){r.className=`map-fullscreen fixed inset-0 z-[var(--z-map-full)] bg-slate-900`,document.body.classList.add(`has-map-fullscreen`),n.className=`flex flex-col-reverse sm:flex-row fixed bottom-40 sm:bottom-6 left-4 sm:left-1/2 sm:-translate-x-1/2 z-[var(--z-map-full-controls)] gap-2 transition-all duration-300 items-start sm:items-center w-auto sm:max-w-fit`;let e=x(`btnToggleMapKpis`);e&&e.classList.remove(`hidden`),i&&i.classList.add(`hidden`),n.querySelectorAll(`:scope > button, :scope > div.glass-panel`).forEach(e=>{if(e.id===`btnToggleMapKpis`)return;e.classList.add(`flex`,`flex-col`,`items-center`,`justify-center`,`min-w-[55px]`,`sm:min-w-[75px]`,`!border-2`,`rounded-xl`,`shadow-lg`,`gap-0`,`p-2`);let t=e.querySelector(`span.uppercase`);t&&t.classList.add(`hidden`),e.classList.add(`kpi-drawer-item`)}),n.classList.add(`kpi-drawer-collapsed`)}[`Normal`,`Expanded`,`Full`].forEach(t=>{let n=x(`btnMapState${t}`);if(n){let r=e===t.toLowerCase();n.classList.toggle(`bg-white/30`,r)}}),window.lucide&&window.lucide.createIcons(),setTimeout(()=>{l.map&&l.map.invalidateSize()},600)}var $a=a((()=>{m(),D(),li()}));function eo(e){let{onProcessData:t}=e,n=()=>{En(),[`filterINE`,`filterSEGEN`].forEach(e=>{x(e)&&x(e).classList.remove(`active`,`bg-brand-emerald`,`bg-brand-purple`,`text-white`,`border-brand-emerald`,`border-brand-purple`)}),l.filterINE=!1,l.filterSEGEN=!1};x(`btnReset`)&&(x(`btnReset`).onclick=n),x(`btnResetOffcanvas`)&&(x(`btnResetOffcanvas`).onclick=n),x(`btnRefresh`)&&x(`btnRefresh`).addEventListener(`click`,()=>{let e=x(`assetSelect`).value;e&&re(e,t,!0)}),x(`btnRetryConnection`)&&x(`btnRetryConnection`).addEventListener(`click`,()=>ne(t)),x(`assetSelect`)&&x(`assetSelect`).addEventListener(`change`,e=>re(e.target.value,t)),x(`searchEncuesta`)&&x(`searchEncuesta`).addEventListener(`input`,()=>J()),x(`btnOpenFilters`)&&(x(`btnOpenFilters`).onclick=vn),x(`btnCloseFilters`)&&x(`btnCloseFilters`).addEventListener(`click`,yn),x(`filtersOverlay`)&&x(`filtersOverlay`).addEventListener(`click`,yn),x(`btnApplyFilters`)&&x(`btnApplyFilters`).addEventListener(`click`,()=>{yn(),J()});let r=(e,t,n,r,i)=>{let a=x(e);a&&(a.onclick=()=>{l[t]=!l[t],l[t]&&(l[i]=!1),a.classList.toggle(`active`,l[t]),a.classList.toggle(n,l[t]),a.classList.toggle(`text-white`,l[t]),a.classList.toggle(`border-${n.split(`-`)[1]}-${n.split(`-`)[2]}`,l[t]);let e=x(r);e&&e.classList.remove(`active`,`bg-brand-emerald`,`bg-brand-purple`,`text-white`,`border-brand-emerald`,`border-brand-purple`),J()})};r(`filterINE`,`filterINE`,`bg-brand-emerald`,`filterSEGEN`,`filterSEGEN`),r(`filterSEGEN`,`filterSEGEN`,`bg-brand-purple`,`filterINE`,`filterINE`),[`filterEncuestador`,`filterMunicipio`,`filterSemana`,`filterFechaInicio`,`filterFechaFin`,`filterHoraTransmision`,`filterHoraInicio`,`filterTasaNoRespuesta`].forEach(e=>{x(e)&&x(e).addEventListener(`change`,J)}),x(`presetAlertas`)&&x(`presetAlertas`).addEventListener(`click`,()=>{l.quickFilterMode=`alertas`,J()}),x(`presetNoRespuesta`)&&x(`presetNoRespuesta`).addEventListener(`click`,()=>{let e=x(`filterClasificacion`);e&&(e.value=e.value===`TIPO A`?``:`TIPO A`,e.dispatchEvent(new Event(`change`))),J()}),x(`presetNoEfectivas`)&&x(`presetNoEfectivas`).addEventListener(`click`,()=>{let e=x(`filterEstado`);e&&(e.value=e.value===`no_efectiva`?``:`no_efectiva`,e.dispatchEvent(new Event(`change`))),J()}),Object.entries({All:`all`,Efectivas:`efectivas`,NoEfectiva:`no_efectiva`,Alertas:`alertas`}).forEach(([e,t])=>{let n=x(`btnMapFilter${e}`);n&&n.addEventListener(`click`,()=>{typeof window.setQuickFilter==`function`&&window.setQuickFilter(t)})});let i=x(`inputMetaDiaria`);if(i){try{let e=localStorage.getItem(`esca_meta_diaria`);e&&!isNaN(Number(e))&&(i.value=e)}catch{}i.addEventListener(`input`,()=>{try{localStorage.setItem(`esca_meta_diaria`,i.value)}catch{}Ba()})}x(`btnMapStateNormal`)&&x(`btnMapStateNormal`).addEventListener(`click`,()=>Qa(`normal`)),x(`btnMapStateExpanded`)&&x(`btnMapStateExpanded`).addEventListener(`click`,()=>Qa(`expanded`)),x(`btnMapStateFull`)&&x(`btnMapStateFull`).addEventListener(`click`,()=>Qa(`full`)),x(`btnToggleMapTouch`)&&x(`btnToggleMapTouch`).addEventListener(`click`,()=>$r()),x(`btnToggleMapKpis`)&&x(`btnToggleMapKpis`).addEventListener(`click`,()=>{let e=x(`mapKpiGrid`);if(e){let t=e.classList.contains(`kpi-drawer-collapsed`);e.classList.toggle(`kpi-drawer-collapsed`,!t),e.classList.toggle(`kpi-drawer-expanded`,t)}}),document.querySelectorAll(`.tab-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),Ya(e.dataset.tab)})}),document.querySelectorAll(`.sort-btn`).forEach(t=>{t.addEventListener(`click`,()=>{l.currentSort=t.dataset.sort,document.querySelectorAll(`.sort-btn`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`);let{renderRankingTable:n}=e;n&&n()})}),x(`btnDetailExpand`)&&x(`btnDetailExpand`).addEventListener(`click`,()=>{typeof window.toggleDetailModalExpand==`function`&&window.toggleDetailModalExpand()}),x(`btnDetailClose`)&&x(`btnDetailClose`).addEventListener(`click`,()=>{let{closeDetailModal:t}=e;t&&t()}),x(`detailModalBackdrop`)&&x(`detailModalBackdrop`).addEventListener(`click`,()=>{let{closeDetailModal:t}=e;t&&t()}),x(`btnDetailPrev`)&&x(`btnDetailPrev`).addEventListener(`click`,()=>{let{navigateDetailModal:t}=e;t&&t(-1)}),x(`btnDetailNext`)&&x(`btnDetailNext`).addEventListener(`click`,()=>{let{navigateDetailModal:t}=e;t&&t(1)}),document.addEventListener(`keydown`,t=>{let n=x(`detailModal`);if(n&&!n.classList.contains(`hidden`)){if(t.key===`Escape`){let{closeDetailModal:t}=e;t&&t()}else if(t.key===`ArrowLeft`){let{navigateDetailModal:t}=e;t&&t(-1)}else if(t.key===`ArrowRight`){let{navigateDetailModal:t}=e;t&&t(1)}}});let a=null;x(`btnOpenUploadGeoJSON`)&&(x(`btnOpenUploadGeoJSON`).onclick=ka),x(`btnCloseUploadGeoJSON`)&&(x(`btnCloseUploadGeoJSON`).onclick=Aa),x(`btnCancelGeoJSONUpload`)&&(x(`btnCancelGeoJSONUpload`).onclick=Aa);let o=x(`geojsonFileInput`),s=x(`geojsonDropZone`),c=(e,t)=>{try{let n=JSON.parse(e);if(!n.features||!Array.isArray(n.features)){alert(`El archivo no parece ser un GeoJSON válido (debe contener un arreglo "features").`);return}a=n;let r=(e.length/(1024*1024)).toFixed(2);x(`geojsonFileName`)&&(x(`geojsonFileName`).textContent=t),x(`geojsonFileRawSize`)&&(x(`geojsonFileRawSize`).textContent=`${r} MB (Original)`),x(`geojsonFeatureCountBadge`)&&(x(`geojsonFeatureCountBadge`).textContent=`${n.features.length} Entidades`);let i=(r*(parseInt(x(`geojsonSimplificationRatio`)?.value||`40`,10)/100)*.5).toFixed(2),o=(100-i/r*100).toFixed(0);x(`geojsonOptimizedSize`)&&(x(`geojsonOptimizedSize`).textContent=`${i} MB aprox.`),x(`geojsonSavingsPct`)&&(x(`geojsonSavingsPct`).textContent=`${Math.max(10,o)}% de reducción`);let s=x(`geojsonFileDetails`);s&&s.classList.remove(`hidden`);let c=x(`btnApplyGeoJSONUpload`);c&&(c.disabled=!1,c.classList.remove(`opacity-50`,`cursor-not-allowed`))}catch(e){alert(`Error al leer el archivo JSON: `+e.message)}};o&&o.addEventListener(`change`,e=>{let t=e.target.files&&e.target.files[0];if(t){let e=new FileReader;e.onload=e=>c(e.target.result,t.name),e.readAsText(t)}}),s&&([`dragover`,`dragenter`].forEach(e=>{s.addEventListener(e,e=>{e.preventDefault(),s.classList.add(`border-brand-blue`,`bg-brand-blue/10`)})}),[`dragleave`,`drop`].forEach(e=>{s.addEventListener(e,e=>{e.preventDefault(),s.classList.remove(`border-brand-blue`,`bg-brand-blue/10`)})}),s.addEventListener(`drop`,e=>{let t=e.dataTransfer.files&&e.dataTransfer.files[0];if(t){let e=new FileReader;e.onload=e=>c(e.target.result,t.name),e.readAsText(t)}})),x(`btnApplyGeoJSONUpload`)&&x(`btnApplyGeoJSONUpload`).addEventListener(`click`,()=>{if(!a)return;let e=x(`geojsonTargetLayer`)?.value||`segmentos`,t=parseInt(x(`geojsonSimplificationRatio`)?.value||`40`,10),n=t===100?0:1e-4*(100-t)/100,r=t===100?a:Hr(a,n,5);e===`segmentos`?(l.geoJSONData=r,Jr(),Vr(`segmentos_monagas`,r)):(l.controlsData=r,Xr(),Vr(`controles_monagas`,r)),Aa(),console.log(`[UploadGeoJSON] Capa ${e} inyectada e indexada correctamente.`)})}var to=a((()=>{m(),D(),ae(),Xn(),$a(),Za(),Ua(),_n(),li(),Ma(),Kr(),Zr()}));o((()=>{m(),D(),ae(),pn(),Xn(),Rr(),li(),Cr(),Ti(),zi(),aa(),Fa(),Ra(),Ua(),Za(),$a(),to(),console.log(`main/index.js: Modular orchestrator initializing ✓`);function e(){console.log(`main/index.js: renderAll() starting`);try{Ba()}catch(e){console.error(`KPI Update Error:`,e)}try{Va()}catch(e){console.warn(`Subtipos Breakdown Error:`,e)}[Ui,Wi,Gi,Ki,na,Zi,Qi,$i,ta,ra].forEach(e=>{try{e()}catch(t){console.warn(`Chart Renderer Error (${e.name}):`,t)}});try{si()}catch(e){console.error(`Map Render Error:`,e)}try{Pr()}catch(e){console.error(`Grid Update Error:`,e)}try{Ir()}catch(e){console.error(`Ranking Table Error:`,e)}try{Ci()}catch(e){console.error(`MM111 Error:`,e)}try{Fi()}catch(e){console.error(`Inconsistencias Error:`,e)}window.lucide&&lucide.createIcons()}Tn(e);var t=async()=>{await fn(),Cn(),l.filtered=[...l.rawData],e()};async function n(){Na(),Ia(),console.log(`main/index.js: init() start`),r(),Qa(`normal`),eo({onProcessData:t,renderRankingTable:Ir,closeDetailModal:br,navigateDetailModal:vr}),Un(),i(),Promise.allSettled([ie(),ne(e=>re(e,t))]).then(()=>{console.log(`main/index.js: Primary dashboard data ready.`),window.lucide&&lucide.createIcons();let e=()=>{Promise.allSettled([qr(),Yr().then(()=>{l.rawData.length>0&&(console.log(`main/index.js: Spatial catalog index ready.`),t())})])};`requestIdleCallback`in window?requestIdleCallback(e,{timeout:2e3}):setTimeout(e,100)})}function r(){let e=x(`currentDateDisplay`);e&&(e.textContent=new Date().toLocaleDateString(`es-ES`,{weekday:`long`,year:`numeric`,month:`long`,day:`numeric`}))}function i(){let e=[];typeof Tabulator>`u`&&e.push(`Tabulator`),typeof Chart>`u`&&e.push(`Chart.js`),typeof L>`u`&&e.push(`Leaflet`);let t=x(`libCheckWarn`);e.length>0?(console.error(`CRITICAL: Missing libraries:`,e.join(`, `)),t&&t.classList.remove(`hidden`)):t&&t.classList.add(`hidden`)}document.addEventListener(`DOMContentLoaded`,()=>{n(),ai()}),window.setMapStateForDebug=Qa,window.switchTabForDebug=Ya}))();