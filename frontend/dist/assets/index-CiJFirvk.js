...
import{a as e,c as t,l as n,n as r,o as i,r as a,s as o,t as s,u as c}from"./helpers-CBT32SXN.js";import{_ as l,a as u,c as d,d as f,f as p,g as m,h,i as g,l as _,m as v,n as y,o as ee,p as b,s as x,t as S}from"./logic-_BSIi1jk.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),n((()=>{window.tailwind&&(tailwind.config={darkMode:`class`,theme:{extend:{fontFamily:{sans:[`Inter`,`sans-serif`],inter:[`Inter`,`sans-serif`],outfit:[`Outfit`,`sans-serif`]},colors:{brand:{blue:`#3B82F6`,emerald:`#10B981`,purple:`#8B5CF6`,orange:`#F59E0B`,red:`#EF4444`}}}}})}))();function C(e){let t=s(`loadingOverlay`),n=s(`loadingMsg`);t&&(E&&=(clearTimeout(E),null),t.style.display=`flex`,setTimeout(()=>{t.style.opacity=`1`,t.style.pointerEvents=`all`},10),n&&(n.textContent=e))}function w(){let e=s(`loadingOverlay`);e&&(E&&clearTimeout(E),e.style.opacity=`0`,e.style.pointerEvents=`none`,E=setTimeout(()=>{e.style.display=`none`,E=null},500))}function T(e){let t=document.getElementById(`connectionStatus`),n=document.getElementById(`connectionDot`),r=document.getElementById(`connectionPing`);!t||!n||(e?(t.textContent=`Live Connection`,t.classList.remove(`text-amber-500`),t.classList.add(`text-emerald-400`),n.className=`relative inline-flex rounded-full h-2 w-2 bg-brand-emerald`,r&&(r.className=`animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-emerald opacity-75`)):(t.textContent=`Modo Offline - Datos Cacheados`,t.classList.remove(`text-emerald-400`,`text-slate-400`),t.classList.add(`text-amber-500`),n.className=`relative inline-flex rounded-full h-2 w-2 bg-amber-500`,r&&(r.className=`absolute inline-flex h-full w-full rounded-full bg-amber-500 opacity-20`)))}var E,D=c((()=>{e(),E=null})),O,k,A,j=c((()=>{O=`KoboDashboardDB`,k=`cacheStore`,A={async open(){return new Promise((e,t)=>{let n=indexedDB.open(O,1);n.onerror=()=>t(`Error opening DB`),n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(k)||t.createObjectStore(k)},n.onsuccess=t=>e(t.target.result)})},async get(e){try{let t=await this.open();return new Promise((n,r)=>{let i=t.transaction(k,`readonly`).objectStore(k).get(e);i.onsuccess=()=>n(i.result),i.onerror=()=>r(i.error)})}catch(e){return console.error(`IndexedDB Get Error:`,e),null}},async set(e,t){try{let n=await this.open();return new Promise((r,i)=>{let a=n.transaction(k,`readwrite`).objectStore(k).put(t,e);a.onsuccess=()=>r(),a.onerror=()=>i(a.error)})}catch(e){console.error(`IndexedDB Set Error:`,e)}}}}));async function M(){let e=await fetch(`/api/assets`);if(!e.ok)throw Error(`Error API (${e.status}) at fetchAssets`);return await e.json()}async function te(e){if(!e)throw Error(`Missing UID in fetchSurveyData`);let t=`/api/data/${e}`,n=await fetch(t);if(!n.ok)throw Error(`Error API (${n.status}) at fetchSurveyData`);return await n.json()}var N=c((()=>{h()}));async function P(e){console.log(`api.js: Orchestrating loadAssets()...`),C(`Buscando formularios en KoboToolbox…`);let t=null;try{t=await M(),await A.set(`assets_cache`,t),T(!0)}catch(e){console.warn(`Network failure. Trying cache...`,e),t=await A.get(`assets_cache`),t&&T(!1)}if(!t){w(),s(`errorState`)&&(s(`errorState`).style.display=`flex`);let e=s(`statusBadge`);e&&(e.textContent=`Error de conexión`,e.classList.remove(`active`)),T(!1);return}let n=s(`assetSelect`);n&&(n.innerHTML=`<option value="">— Seleccionar encuesta —</option>`,t.forEach(e=>{let t=document.createElement(`option`);t.value=e.uid,t.textContent=e.name,n.appendChild(t)}),n.addEventListener(`change`,()=>{let e=n.options[n.selectedIndex];l.assetName=e?e.textContent.trim():``}));let r=s(`statusBadge`);r&&(r.textContent=`Formularios Listos`),window.lucide&&lucide.createIcons();let i=t.find(e=>e.name.toLowerCase().includes(`esca`)&&e.name.toLowerCase().includes(`v3`));i?(n&&(n.value=i.uid),l.assetName=i.name,e&&e(i.uid)):w()}async function F(e,t){if(!e)return;C(`Descargando datos desde Kobo API…`);let n=s(`btnRefresh`);n&&(n.disabled=!0);let r=null,i=!1;try{r=await te(e),await A.set(`data_cache_${e}`,r),T(!0)}catch(t){console.warn(`Network failure. Trying cache...`,t),r=await A.get(`data_cache_${e}`),r&&(i=!0,T(!1))}if(!r){alert(`Error: No se pudieron descargar los datos y no hay caché disponible.`),w(),n&&(n.disabled=!1);return}l.rawData=r.results||(Array.isArray(r)?r:[]),console.log(`api.js: Loaded ${l.rawData.length} records ${i?`(Offline Cache)`:``}`);let a=s(`statusBadge`);a&&(a.textContent=`${l.rawData.length} registros`),s(`errorState`)&&s(`errorState`).classList.add(`hidden`),s(`mainContent`)&&s(`mainContent`).classList.remove(`hidden`),C(`Renderizando dashboard...`),requestAnimationFrame(()=>{setTimeout(()=>{t&&t(),window.lucide&&lucide.createIcons(),requestAnimationFrame(()=>{setTimeout(()=>{w(),n&&(n.disabled=!1)},800)})},100)})}var ne=c((()=>{m(),e(),D(),j(),N(),window.loadAssets=()=>P(e=>F(e,window.__onProcessData))}));function re(e){let t=String(e[`S0/cedula_encuestador`]||`N/A`).trim(),n=String(e[`S0/s0_nombreapellido`]||`Desconocido`).trim(),r=e.start||``,i=e.end||``,a=e[`ubicacion_final/hora_fin`]||e[`ubicacion_final/hora_f`]||e.hora_f;a&&(i=!a.includes(`T`)&&r.includes(`T`)?r.split(`T`)[0]+`T`+a:a,e.end=i);let o=(e.today||e._submission_time||``).slice(0,10),s=(l.assetName||``).toUpperCase().includes(`EHM`)?`EHM`:`ESCA`,c=null;if(r)try{c=new Date(r).getHours()}catch{}let u=null;if(e._submission_time)try{u=new Date(e._submission_time).getHours()}catch{}let d=e=>{if(!e||typeof e!=`string`)return null;let t=e.trim().split(` `);return t.length>=4?parseFloat(t[3]):null};return{cedula:t,nombre:n,start:r,end:i,fecha:o,hora:c,hora_trans:u,formType:s,start_precision:d(e[`start-geopoint`]||e.start_geopoint),end_precision:d(e[`group_sh53u78/ubicacion_i`]||e[`end-geopoint`]),mun:e[`S1/mun`]||`N/A`,par:e[`S1/par`]||`N/A`,nodo:e[`S1/nodo`]||`N/A`,semana:e[`group_sh53u78/semana`]||``,uso:e[`S1/Uso_de_la_Unidad_inmobiliaria`]||`N/A`,condicion:e[`Condici_n_de_ocupaci_n/condicion_de_ocupacion`]||`N/A`,control:e[`group_sh53u78/control`]||e._uuid||``,lote:e[`group_sh53u78/lote`]||``,situacion_vivienda:e[`Condici_n_de_ocupaci_n/situacion_vivienda`]||``,segmento:e[`S1/segmento`]||e[`S1/group_segmeto_sector/segmento`]||e[`group_segmeto_sector/segmento`]||``,sector:e[`S1/sector`]||e[`S1/group_segmeto_sector/sector`]||e[`group_segmeto_sector/sector`]||``,manzana:e[`S1/manzana`]||``,parcela:e[`S1/parcela`]||``,edificacion:e[`S1/Edificaci_n`]||e[`S1/edificacion`]||``,lado_manz:e[`S1/lado_manz`]||``,n_linea:e[`group_sh53u78/n_linea`]||``,n_serie:e[`group_sh53u78/n_serie`]||``,direccion:e[`S1/P_nomsect`]||e[`S1/direccion`]||``,nota:e[`ubicacion_final/nota`]||``}}function ie(e,t){if(!e||!t)return null;try{let n=new Date(e),r=new Date(t),i=Math.round((r-n)/6e4*10)/10;return i>=0&&i<=600?i:null}catch{return null}}var ae=c((()=>{m()}));function oe(e,t){let n=0,r=0,i=0,a=[];return t===`EHM`?(a=Array.isArray(e.lista_hogar)?e.lista_hogar:[],a.forEach(e=>{let t=Array.isArray(e[`lista_hogar/lista_miembros`])?e[`lista_hogar/lista_miembros`]:[];if(t.length>0)n+=t.length;else{let t=parseInt(e[`lista_hogar/personas_hogar`]||e[`lista_hogar/lista_miembros_count`]||`0`,10);isNaN(t)||(n+=t)}t.forEach(e=>{let{hCount:t,mCount:n}=se(e);r+=t,i+=n})})):(a=Array.isArray(e[`datos_hogar/hogar`])?e[`datos_hogar/hogar`]:[],a.forEach(e=>{let t=Array.isArray(e[`datos_hogar/hogar/integrantes_hogar`])?e[`datos_hogar/hogar/integrantes_hogar`]:[];n+=t.length,t.forEach(e=>{let{hCount:t,mCount:n}=se(e);r+=t,i+=n})})),{totalPers:n,totalHombres:r,totalMujeres:i,hogaresCount:a.length,hogaresRaw:a}}function se(e){let t=0,n=0,r=Object.keys(e).find(e=>e.endsWith(`/sexo`)||e.endsWith(`:sexo`)||e===`sexo`);if(r){let i=String(e[r]).trim().toLowerCase();[`1`,`sexo1`,`v`,`m`,`masculino`,`hombre`].includes(i)&&(t=1),[`2`,`sexo2`,`h`,`f`,`femenino`,`mujer`].includes(i)&&(n=1)}return{hCount:t,mCount:n}}var ce=c((()=>{}));function le(e){let n=t(e[`ubicacion_final/ubicacion_f`]||e.ubicacion_f),r=t(e[`group_sh53u78/ubicacion_i`]||e.ubicacion_i),i=null,a=null;if(r&&r[0])i=r[0],a=r[1];else if(n&&n[0])i=n[0],a=n[1];else if(e._geolocation&&e._geolocation.length>=2)i=e._geolocation[0],a=e._geolocation[1];else if(e[`S1/ubicacion`]){let t=e[`S1/ubicacion`].split(` `);t.length>=2&&(i=parseFloat(t[0]),a=parseFloat(t[1]))}return{lat:i,lng:a,ptIni:r,ptFin:n}}function ue(e,n,r){let i=null,o=null;try{let s=e[`start-geopoint`]||e.start_geopoint,c=e[`group_sh53u78/ubicacion_i`]||e[`end-geopoint`]||e.end_geopoint,l=t(s)||(e._geolocation?.length>=2?[e._geolocation[0],e._geolocation[1]]:null),u=t(c)||(e._geolocation?.length>=2?[e._geolocation[0],e._geolocation[1]]:null);l&&u&&(i=a(l[0],l[1],u[0],u[1])),n&&r&&n[0]&&r[0]&&(o=a(n[0],n[1],r[0],r[1]))}catch{}return{distance_m:i,dist_ini_fin:o}}function de(e,t,n){if(e===null||t===null||l.segmentBBoxes.length===0)return null;let r=null;for(let n of l.segmentBBoxes){let a=n.bbox;if(e>=a.minLat&&e<=a.maxLat&&t>=a.minLng&&t<=a.maxLng){let a=n.feature.geometry,o=!1;if(a.type===`Polygon`)i([e,t],a.coordinates[0])&&(o=!0);else if(a.type===`MultiPolygon`){for(let n of a.coordinates)if(i([e,t],n[0])){o=!0;break}}if(o){r=n.props.cod_seg===`000`||n.props.cod_seg===`0`?n.props.cod_sc:n.props.cod_seg;break}}}if(!r){let r=.0015;for(let i of l.segmentBBoxes){let a=i.props.cod_seg===`000`||i.props.cod_seg===`0`?i.props.cod_sc:i.props.cod_seg;if(o(n,a)){let n=i.bbox;if(e>=n.minLat-r&&e<=n.maxLat+r&&t>=n.minLng-r&&t<=n.maxLng+r)return a}}}return r}var fe=c((()=>{m(),e()}));function pe(e){let{r:n,normalized:r,durMin:i,totalPers:s,distance_m:c,dist_ini_fin:l,actualSeg:u,ptIni:d,isCompletada:f,hogaresRaw:p}=e,m=[];try{let e=t(n[`start-geopoint`]||n.start_geopoint)||(n._geolocation?.length>=2?[n._geolocation[0],n._geolocation[1]]:null);e&&d&&d[0]&&a(e[0],e[1],d[0],d[1])>500&&m.push(`APERT_LEJOS`)}catch{}c!==null&&c>600&&m.push(`FUERA_SEGMENTO`),l!==null&&l>30&&m.push(`DESPLAZAMIENTO_ANOMALO`),f&&i!==null&&(r.formType===`EHM`&&s===1&&i<10?m.push(`TIEMPO_CORTO_EHM`):r.formType!==`EHM`&&i<15?m.push(`TIEMPO_CORTO_ESCA`):i<15&&m.push(`TIEMPO_CORTO`)),f&&i!==null&&i>45&&m.push(`TIEMPO_LARGO`);let h=r.cedula.replace(/\D/g,``);(h.length<6||h.length>9)&&m.push(`CEDULA_INVALIDA`),p.forEach(e=>{(Array.isArray(e[`datos_hogar/hogar/integrantes_hogar`])?e[`datos_hogar/hogar/integrantes_hogar`]:[]).forEach(e=>{let t=e[`datos_hogar/hogar/integrantes_hogar/integrantes/cuanto_actividad`];if(t!=null&&t!==``){let e=Number(t);!isNaN(e)&&(e<1||e>9999999)&&(m.includes(`INGRESO_ANOMALO`)||m.push(`INGRESO_ANOMALO`))}})}),p.forEach(e=>{let t=e[`datos_hogar/hogar/productos_22/arranque`]||``,n=e[`datos_hogar/hogar/productos_22/productos`],r=Array.isArray(n)&&n.length>0;f&&r&&!t&&(m.includes(`ARRANQUE_INCONSISTENTE`)||m.push(`ARRANQUE_INCONSISTENTE`))});let g=r.segmento===`000`||r.segmento===`0`?r.sector:r.segmento;return(u&&!o(g,u)||!u&&r.lat!==null)&&m.push(`SEGMENTO_INCORRECTO`),m}var me=c((()=>{e(),h()}));function he(){l.encMap={},l.rawData.forEach(e=>{if(!e._meta)return;let{cedula:t,nombre:n,estado:r,durMin:i,totalPers:a,mun:o,condicion:s,semana:c,control:u}=e._meta;l.encMap[t]||(l.encMap[t]={cedula:t,nombre:n,encuestas:0,completadas:0,duraciones:[],personas:0,municipios:new Set,condiciones:{},semanas:{}});let d=l.encMap[t];d.encuestas++,r===`completada`&&d.completadas++,i!==null&&d.duraciones.push(i),d.personas+=a||0,d.municipios.add(o),d.condiciones[s]=(d.condiciones[s]||0)+1,c&&(d.semanas[c]||(d.semanas[c]=new Set),u&&d.semanas[c].add(u))}),Object.values(l.encMap).forEach(e=>{e.avgDur=e.duraciones.length?r(e.duraciones):0,e.pctCompleta=e.encuestas>0?Math.round(e.completadas/e.encuestas*100):0,e.score=e.pctCompleta;let t=Object.values(e.semanas||{});e.avgControlesSemana=t.length?Math.round(t.reduce((e,t)=>e+t.size,0)/t.length):0,e.totalSemanas=t.length})}var ge=c((()=>{m(),e()}));function I(e){return e?String(e).toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]/g,``).trim():``}function _e(e){let t=I(e);return t?ve.has(t)?`TIPO A`:ye.has(t)?`TIPO B`:be.has(t)?`TIPO C`:xe.has(t)?`TIPO E`:`NO DEFINIDO`:`NO DEFINIDO`}var ve,ye,be,xe,Se=c((()=>{ve=new Set([`AUSENTE TEMPORALMENTE`,`AUSENTETEMPORALMENTE`,`ausente_temporalmente`,`NADIE EN LA VIVIENDA AL MOMENTO DE LA ENTREVISTA`,`nadie_en_vivienda`,`REHUSO LA ENTREVISTA`,`REHUSÓ LA ENTREVISTA`,`REHUSOLAENTREVISTA`,`rehuso_entrevista`,`OCUPANTES AUSENTES`,`OCUPANTES_AUSENTES`,`INFORMANTE NO CALIFICADO`,`INFORMANTE_NO_CALIFICADO`,`INCOMPLETA`,`PENDIENTE`,`NO ATIENDE TELEFONO`,`RECHAZO`,`SIN ENTREVISTA`,`RECHAZADA`,`OTRO_AUSENTES`].map(e=>I(e))),ye=new Set([`CONSTRUCCION`,`EN CONSTRUCCION`,`en_construccion`,`INADECUADA PARA EL USO`,`inadecuada_el_uso`,`CONSTRUYENDOSE`,`CONSTRUYÉNDOSE`,`VIVIENDA DESOCUPADA`,`VIVIENDA OCASIONAL`,`USO VACACIONAL`,`uso_vacacional`,`USO_VACACIONAL`,`TEMPORALMENTE EN NEGOCIO`,`temporalmente_en_negocio`,`DESOCUPADA EN ESTADO REGULAR`,`desocupada_estado_regular`,`VIVIENDA_DESOCUPADA`,`OTRO_DESOCUPADA`].map(e=>I(e))),be=new Set([`DEMOLIDA`,`demolida`,`OTRO (ESPECIFIQUE)`,`MAL LISTADA`,`NO EXISTE`,`SIN LISTAR`,`NO RESIDENCIAL`,`NO RESIENDECIAL`,`OTRO`,`NO EXISTE NRO TELEFONICO`,`NEGOCIO PERMANENTE`,`OTRA SITUACION`,`CONSOLIDADA`,`NEGOCIO O ALMACEN PERMANENTE`,`negocio_almacen_permanente`].map(e=>I(e))),xe=new Set([`OCUPADA CON OCUPANTES PRESENTES`,`ocupada_con_ocupantes_presentes`,`TOTALMENTE ENCUESTADA`].map(e=>I(e)))}));function Ce(){console.log(`dataProcessor: Processing raw data pipeline...`),l.rawData.forEach(e=>{let t=re(e),n=ie(t.start,t.end),{totalPers:r,totalHombres:i,totalMujeres:a,hogaresCount:o,hogaresRaw:s}=oe(e,t.formType),{lat:c,lng:l,ptIni:u,ptFin:d}=le(e),{distance_m:f,dist_ini_fin:p}=ue(e,u,d),m=de(c,l,t.segmento===`000`||t.segmento===`0`?t.sector:t.segmento),h=0;Array.isArray(s)&&s.forEach(e=>{let t=(Array.isArray(e[`lista_hogar/lista_miembros`])?e[`lista_hogar/lista_miembros`]:Array.isArray(e[`datos_hogar/hogar/integrantes_hogar`])?e[`datos_hogar/hogar/integrantes_hogar`]:[]).length;if(t===0){let n=parseInt(e[`lista_hogar/personas_hogar`]||e[`lista_hogar/lista_miembros_count`]||`0`,10);isNaN(n)||(t=n)}t===1&&h++});let g=/totalment/i.test(t.nota),_=_e(t.situacion_vivienda||t.condicion);e._meta={...t,durMin:n,totalPers:r,totalHombres:i,totalMujeres:a,hogares:o,hogaresUniPersonales:h,lat:c,lng:l,distance_m:f,dist_ini_fin:p,actual_seg:m,estado:g?`completada`:`no_efectiva`,tipo_vivienda:_,flag_distance_gt_500:f!==null&&f>500,flag_short_duration:n!==null&&n<10},e._meta.alertas=pe({r:e,normalized:t,durMin:n,totalPers:r,distance_m:f,dist_ini_fin:p,actualSeg:m,ptIni:u,isCompletada:g,hogaresRaw:s}),e._meta.hasAlerts=e._meta.alertas.length>0}),we(),he(),console.log(`dataProcessor: Pipeline completed ✓`)}function we(){l.controlsIndex instanceof Map&&l.controlsIndex.size>0&&l.rawData.forEach(e=>{if(!e._meta)return;let t=e._meta.control?e._meta.control.slice(-4):``,n=String(parseInt(e._meta.n_serie,10)||0),r=String(parseInt(e._meta.n_linea,10)||0),i=l.validControls.has(t),a=l.validSeries.has(n),o=l.validLineas.has(r);if(e._meta._ls_ctrl_ok=i,e._meta._ls_serie_ok=a,e._meta._ls_linea_ok=o,!i||!a||!o){e._meta.alertas.includes(`LINEA_SERIE_INVALIDA`)||(e._meta.alertas.push(`LINEA_SERIE_INVALIDA`),e._meta.hasAlerts=!0);let t=[];i||t.push(`Control`),a||t.push(`Serie`),o||t.push(`Línea`),e._meta._ls_key_reported=`${t.join(`, `)} no definido(s) en base de datos`}})}var Te=c((()=>{m(),ae(),ce(),fe(),me(),ge(),Se()}));function Ee(){let e=s(`offCanvasFilters`),t=s(`filtersOverlay`);!e||!t||(e.classList.remove(`translate-x-full`),t.classList.remove(`hidden`),setTimeout(()=>t.classList.remove(`opacity-0`),10))}function De(){let e=s(`offCanvasFilters`),t=s(`filtersOverlay`);!e||!t||(e.classList.add(`translate-x-full`),t.classList.add(`opacity-0`),setTimeout(()=>t.classList.add(`hidden`),300))}function Oe(){let e={enc:s(`filterEncuestador`),mun:s(`filterMunicipio`),con:s(`filterCondicion`),sit:s(`filterSituacionVivienda`),uso:s(`filterUso`),sem:s(`filterSemana`),ctrl:s(`filterControl`),par:s(`filterParroquia`),nodo:s(`filterNodo`),alerta:s(`filterAlerta`),htrans:s(`filterHoraTransmision`),hinicio:s(`filterHoraInicio`)};Object.values(e).forEach(e=>{if(e){let t=`Todos`;e.id===`filterAlerta`?t=`Todas las alertas`:e.id===`filterHoraTransmision`||e.id===`filterHoraInicio`?t=`Cualquier hora`:(e.id.includes(`Condicion`)||e.id.includes(`Semana`)||e.id.includes(`Parroquia`))&&(t=`Todas`),e.innerHTML=`<option value="">${t}</option>`}}),e.alerta&&d.forEach(t=>{let n=document.createElement(`option`);n.value=t.code,n.textContent=t.label,e.alerta.appendChild(n)});let t={muns:new Set,sitVs:new Set,cons:new Set,usos:new Set,semanas:new Set,controles:new Set,pars:new Set,nodos:new Set,hTrans:new Set,hInicio:new Set};e.enc&&Object.values(l.encMap).sort((e,t)=>e.nombre.localeCompare(t.nombre)).forEach(t=>{let n=f.has(String(t.cedula).trim()),r=document.createElement(`option`);r.value=t.cedula,r.textContent=`${t.nombre} (${t.cedula})${n?` [INE]`:` [SEGEN]`}`,r.style.color=n?`#10B981`:`#8B5CF6`,r.style.fontWeight=`bold`,e.enc.appendChild(r)}),l.rawData.forEach(e=>{let n=e._meta;n&&(n.mun&&n.mun!==`N/A`&&t.muns.add(n.mun),n.situacion_vivienda&&t.sitVs.add(n.situacion_vivienda),n.condicion&&n.condicion!==`N/A`&&t.cons.add(n.condicion),n.uso&&n.uso!==`N/A`&&t.usos.add(n.uso),n.semana&&t.semanas.add(n.semana),n.control&&t.controles.add(n.control),n.par&&n.par!==`N/A`&&t.pars.add(n.par),n.nodo&&n.nodo!==`N/A`&&t.nodos.add(n.nodo),n.hora_trans!==void 0&&n.hora_trans!==null&&t.hTrans.add(n.hora_trans),n.hora!==void 0&&n.hora!==null&&t.hInicio.add(n.hora))});let n=(e,t,n)=>{e&&[...t].sort().forEach(t=>{let r=document.createElement(`option`);r.value=t,r.textContent=n?n(t):t,e.appendChild(r)})};n(e.mun,t.muns),n(e.par,t.pars),n(e.nodo,t.nodos),n(e.sem,t.semanas),n(e.ctrl,t.controles),n(e.sit,t.sitVs,e=>e.replace(/_/g,` `).toUpperCase()),n(e.con,t.cons,e=>e.replace(/_/g,` `).toUpperCase()),n(e.uso,t.usos,e=>e.replace(/_/g,` `).toUpperCase()),n(e.htrans,t.hTrans,e=>`${e}:00`),n(e.hinicio,t.hInicio,e=>`${e}:00`),e.mun&&e.mun.dispatchEvent(new Event(`change`))}var ke=c((()=>{m(),e(),h()})),R=c((()=>{y(),ke(),ee()})),z,B,V,Ae,je,H,Me=c((()=>{z=(e,t)=>{if(!e)return null;if(e._meta&&e._meta[t]!==void 0&&e._meta[t]!==null)return e._meta[t];if(e[t]!==void 0&&e[t]!==null)return e[t];let n=String(t).split(`/`).map(e=>e.trim());for(let t of n)if(!(!t||t.includes(` `))&&e[t]!==void 0&&e[t]!==null)return e[t];return null},B=e=>e==null||e===``?`<span class="text-slate-500 font-medium italic">(No Registrado)</span>`:typeof e==`object`?`<pre class="text-[10px] bg-slate-950/20 p-2 rounded overflow-x-auto">${JSON.stringify(e,null,2)}</pre>`:`<span class="font-outfit font-bold text-slate-800 dark:text-slate-200 text-sm">${String(e)}</span>`,V=e=>{if(!e||typeof e!=`string`)return null;let t=e.trim().split(` `);return t.length>=2?{lat:parseFloat(t[0]),lng:parseFloat(t[1]),alt:t[2]?parseFloat(t[2]):null,acc:t[3]?parseFloat(t[3]):null}:null},Ae=(e,t)=>{if(!e||!t)return null;let n=e=>e*Math.PI/180,r=n(t.lat-e.lat),i=n(t.lng-e.lng),a=Math.sin(r/2)**2+Math.cos(n(e.lat))*Math.cos(n(t.lat))*Math.sin(i/2)**2;return 6371e3*2*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))},je=(e,t)=>String(parseInt(e,10)||0).padStart(t,`0`),H=(e,t,n)=>`${String(e||``).trim().slice(-4)}-${String(parseInt(t,10)||0)}-${String(parseInt(n,10)||0)}`}));function Ne(e){let{stEntidad:t,stMpio:n,stParr:r,valHeader:i,valLeftLabel:a,valLeftVal:o,segmentMatchStatus:s,actualSegClasses:c,actualSegText:l,actualSeg:u,stSect:d,stNodo:f,stEncuestador:p,stCedula:m,stFecha:h,stEstado:g,stDur:_,stControl:v,stLinea:y,stSerie:ee,ctrlPanelHtml:b,stHogares:x,stPers:S,stCond:C,stUso:w,stDist:T,hasAlerts:E,alertsHtml:D,hasMapData:O,isFlagged:k,walkedDistance:A,rawDist:j,durMin:M,declaredSeg:te,alertas:N}=e,P=O?`
        ...
        ${P}
    `}function Pe(e,t){return!e||e.length===0?`<span class="text-[10px] font-bold text-brand-emerald">✔ Encuesta dentro de parámetros normales</span>`:e.map(e=>{let n=x[e];if(!n)return``;let r=``;return e===`LINEA_SERIE_INVALIDA`&&(r=`<div class="mt-1 px-2 py-1 bg-red-100 dark:bg-red-900/30 rounded text-[9px] font-mono text-red-700 dark:text-red-300 border border-red-200 dark:border-red-800/50">
    ...
    </div>`}function Ie(e){return`<details class="mt-3 text-sm text-slate-400 group">
        ...
        </div>`}function Re(e,t,n,r,i,a){return`<div class="font-inter p-1 w-52">
    ...
    </div>`}var ze=c((()=>{h()}));function Be(e,t,n,r){return`<div class="p-2 font-sans">
    ...
    </div>`}function Ve(e){return`<div style="font-family:Inter,sans-serif;font-size:11px;line-height:1.5">
        <b>Control ${e.CONTROL}</b> · Serie ${e.SERIE}<br>
        Línea ${e.LINEA} · Seg ${e.COD_SEG} · Manz ${e.COD_MANZA}
    </div>`}function He(e,t,n,r,i,a,o,s){let c=a&&a.length>0,l=e.segmento||e.sector||e.manzana||e.parcela||e.edificacion||e.direccion?`
        ...
        <div class="p-4 min-w-[280px] bg-white dark:bg-[#0f172a] text-slate-600 dark:text-slate-200 rounded-xl shadow-2xl border border-slate-100 dark:border-white/5" style="font-family:'Inter',sans-serif">
            ...
            <div class="border-t border-red-500/10 dark:border-red-500/20 pt-3 mb-3">
                ...
                ${a.map(e=>{let t=x[e];return t?`<div class="mb-1 p-1 bg-red-500/5 dark:bg-red-500/10 border border-red-500/10 dark:border-red-500/20 rounded-lg flex items-center gap-2" title="${t.detail.replace(/\n/g,``).trim()}">
    ...
    `}function Ue(e){return`<div style="
        ...
        cursor:pointer;
    ">${e}</div>`}function We(e,t,n,r){return`
    ...
    `}var U=c((()=>{h()}));function Ge(e){let{displayLat:t,displayLng:n,declaredSeg:r,actualSeg:i,ptStart:a,ptIni:o,ptFin:s,ptMain:c,isFlagged:u,rec:d}=e,f=H(z(d,`group_sh53u78/control`)||z(d,`control`)||``,z(d,`n_serie`)||``,z(d,`n_linea`)||``);if(!l.detailMiniMapObj){l.detailMiniMapObj=L.map(`detailMap`,{zoomControl:!1}).setView([t,n],16);let e=L.tileLayer(`https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}`,{maxZoom:20,subdomains:[`mt0`,`mt1`,`mt2`,`mt3`],attribution:`&copy; Google`}),r=L.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`&copy; OpenStreetMap contributors`});e.addTo(l.detailMiniMapObj),l.detailMiniMapLayerControl=L.control.layers({"Google Satélite":e,OpenStreetMap:r},null,{position:`topright`}).addTo(l.detailMiniMapObj)}else if(l.detailMiniMapObj.setView([t,n],16),l.detailMiniMapObj.eachLayer(e=>{e instanceof L.TileLayer||l.detailMiniMapObj.removeLayer(e)}),l.detailMiniMapLayerControl){l.detailMiniMapObj.removeControl(l.detailMiniMapLayerControl);let e=L.tileLayer(`https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}`,{maxZoom:20,subdomains:[`mt0`,`mt1`,`mt2`,`mt3`],attribution:`&copy; Google`}),t=L.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`&copy; OpenStreetMap contributors`});l.detailMiniMapLayerControl=L.control.layers({"Google Satélite":e,OpenStreetMap:t},null,{position:`topright`}).addTo(l.detailMiniMapObj)}let p={};if(l.geoJSONData&&(p.Segmentos=L.geoJSON(l.geoJSONData,{style:e=>{let t=String(e.properties.cod_seg||`0`),n=String(e.properties.cod_seg)===String(r),i=_[t.split(``).reduce((e,t)=>e+t.charCodeAt(0),0)%_.length];return{color:n?`#FBBF24`:i,weight:n?2.5:1.5,opacity:.9,fillColor:n?`#FBBF24`:i,fillOpacity:n?.35:.15}},onEachFeature:(e,t)=>{let n=e.properties||{},a=n.cod_seg||n.id||`N/A`,o=n.cod_munici||n.mun||`N/A`,s=n.cod_parroq||n.par||`N/A`,c=String(a)===String(r),l=String(a)===String(i),u=String(a)===`000`||String(a)===`0`,d=Le({cod:a,mun:o,par:s,declaredSeg:r,actualSeg:i,featureLabel:u?`Sector`:`Segmento`,displayId:u?n.cod_sc||`000`:a,isCurrent:c,isActual:l});t.bindPopup(d,{className:`custom-popup`,maxWidth:260})}}).addTo(l.detailMiniMapObj)),l.controlsData&&(p[`Vivienda Esperada`]=L.geoJSON(l.controlsData,{filter:e=>{let t=e.properties;return H(t.CONTROL,t.SERIE,t.LINEA)===f},pointToLayer:(e,t)=>L.circleMarker(t,{radius:7,fillColor:`#38BDF8`,color:`#ffffff`,weight:2,opacity:1,fillOpacity:1}),onEachFeature:(e,t)=>{t.bindPopup(Ve(e.properties),{className:`custom-popup`})}}).addTo(l.detailMiniMapObj)),l.detailMiniMapLayerControl)for(let[e,t]of Object.entries(p))l.detailMiniMapLayerControl.addOverlay(t,e);let m=[],h=[],g=(e,t,n,r,i)=>{if(!e)return;let a=L.divIcon({className:`custom-minimap-marker`,html:`<div style="background-color:${t};width:14px;height:14px;border-radius:50%;border:2px solid white;box-shadow:0 0 10px ${t};"></div>`,iconSize:[14,14],iconAnchor:[7,7]}),o=e.acc?`<span class="text-brand-emerald">± ${e.acc}m</span>`:`<span class="text-slate-500">N/A</span>`,s=e.alt?`${e.alt}m s.n.m.`:`N/A`,c=r===`start`?i.start:i.end,u=Re(n,t,e,o,s,c?new Date(c).toLocaleTimeString():`N/A`);L.marker([e.lat,e.lng],{icon:a}).addTo(l.detailMiniMapObj).bindPopup(u,{className:`custom-popup-enrich`}),m.push([e.lat,e.lng]),h.push([e.lat,e.lng])};a&&g(a,`#3B82F6`,`Apertura de la Encuesta`,`start`,d),o&&g(o,`#10B981`,`Confirmación Inicial`,`start`,d),s&&g(s,`#F59E0B`,`Cierre de Encuesta`,`end`,d),!a&&!o&&!s&&c&&g(c,u?`#EF4444`:`#10B981`,`Ubicación Registrada`,`end`,d),h.length>1&&L.polyline(h,{color:`#94a3b8`,dashArray:`4, 4`,weight:2,opacity:.6}).addTo(l.detailMiniMapObj);let v=o||c;if(v){let e=u?`#EF4444`:`#10B981`;L.circle([v.lat,v.lng],{radius:500,color:e,fillColor:e,fillOpacity:.05,weight:1.5,dashArray:`6,5`,interactive:!1}).addTo(l.detailMiniMapObj)}if(m.length>0){let e=L.latLngBounds(m);m.length===1&&!u?l.detailMiniMapObj.setView(m[0],16):l.detailMiniMapObj.fitBounds(e,{padding:[40,40],maxZoom:18})}l.detailMiniMapObj.invalidateSize()}var Ke=c((()=>{m(),h(),ze(),U(),Me()}));function W(e){let t=s(`detailModal`),n=s(`detailModalBody`);if(!t||!n||!e)return;let r={stEntidad:B(z(e,`S1/ent`)||z(e,`ent`)),stMpio:B(z(e,`mun`)),stParr:B(z(e,`par`)),stSect:B(z(e,`sector`)||z(e,`S1/sector`)||z(e,`S1/group_segmeto_sector/sector`)),stNodo:B(z(e,`nodo`)),stEncuestador:B(z(e,`nombre`)||z(e,`S0/s0_nombreapellido`)),stCedula:B(z(e,`cedula`)||z(e,`S0/cedula_encuestador`)),stFecha:B(z(e,`fecha`)||z(e,`today/_submission_time`)),stDur:B(z(e,`durMin`)?`${z(e,`durMin`)} min`:null),declaredSeg:z(e,`segmento`)||z(e,`S1/segmento`)||z(e,`S1/group_segmeto_sector/segmento`),actualSeg:z(e,`actual_seg`),rawControl:String(z(e,`group_sh53u78/control`)||z(e,`control`)||``),rawSerie:String(z(e,`n_serie`)||``),rawLinea:String(z(e,`n_linea`)||``),stHogares:B(z(e,`hogares`)||z(e,`datos_hogar/hogar_count`)||z(e,`lista_hogar_count`)),stPers:B(z(e,`totalPers`)||z(e,`datos_hogar/hogar.integrantes_hogar`)),stUso:B(z(e,`uso`)||z(e,`S1/Uso_de_la_Unidad_inmobiliaria`)),stCond:B(z(e,`condicion`)||z(e,`Condici_n_de_ocupaci_n/condicion_de_ocupacion`)),alertas:e._meta?.alertas||[],hasAlerts:e._meta?.hasAlerts||!1,isFlagged:e._meta?.flag_distance_gt_500,durMin:z(e,`durMin`),rawDist:z(e,`distance_m`),m:e._meta||{}};r.isRural=r.declaredSeg===`000`||r.declaredSeg===`0`,r.valHeader=r.isRural?`Validación de Sector`:`Validación de Segmento`,r.valLeftLabel=r.isRural?`Sector Declarado`:`Declarado`,r.valLeftVal=r.isRural?z(e,`sector`)||z(e,`S1/sector`)||`000`:r.declaredSeg||`N/A`,r.stControl=B(r.rawControl||null),r.stLinea=B(r.rawLinea||null),r.stSerie=B(r.rawSerie||null),r.stEstado=r.m.estado===`completada`?`<span class="px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-widest bg-brand-green/20 text-brand-green border border-brand-green/30">Completada (Efectiva)</span>`:`<span class="px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-widest bg-brand-orange/20 text-brand-orange border border-brand-orange/30">No Efectiva / Error</span>`,r.stDist=r.rawDist===null?`<span class="text-slate-500 font-medium italic">N/A</span>`:`<span class="font-outfit font-black ${r.isFlagged?`text-brand-red`:`text-brand-emerald`}">${Math.round(r.rawDist)} m</span>`;let i=H(r.rawControl,r.rawSerie,r.rawLinea),a=l.controlsIndex instanceof Map?l.controlsIndex.get(i):null,c=l.controlsIndex instanceof Map&&l.controlsIndex.size>0;r.ctrlPanelHtml=Fe({m:r.m,rawControl:r.rawControl,rawSerie:r.rawSerie,rawLinea:r.rawLinea,_padM:je,hasCtrlIndex:c,ctrlEntry:a,ctrlKey:i});let u=V(e[`start-geopoint`]),d=V(e[`group_sh53u78/ubicacion_i`]||e.ubicacion_i),f=V(e[`ubicacion_final/ubicacion_f`]||e.ubicacion_f),p=e.lat||r.m.lat||(e._geolocation?e._geolocation[0]:null),m=e.lng||r.m.lng||(e._geolocation?e._geolocation[1]:null),h=p&&m?{lat:parseFloat(p),lng:parseFloat(m)}:null;if(r.walkedDistance=d&&f?Ae(d,f):null,r.hasMapData=u||d||f||h,r.segmentMatchStatus=!r.valLeftVal||!r.actualSeg?`<i data-lucide="minus" class="text-slate-400 w-4 h-4"></i>`:o(r.valLeftVal,r.actualSeg)?`<i data-lucide="check" class="text-brand-emerald w-5 h-5"></i>`:`<i data-lucide="x" class="text-brand-red w-5 h-5"></i>`,r.actualSegClasses=r.actualSeg&&!o(r.valLeftVal,r.actualSeg)?`bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800/30`:`bg-slate-100 dark:bg-slate-900/50 border-slate-200 dark:border-slate-700`,r.actualSegText=r.actualSeg&&!o(r.valLeftVal,r.actualSeg)?`text-brand-red`:`text-slate-800 dark:text-slate-200`,r.alertsHtml=Pe(r.alertas,r.m),n.innerHTML=Ne(r)+Ie(e),window.lucide&&lucide.createIcons({root:n}),l.lastFocused=document.activeElement,t.classList.remove(`hidden`),window.innerWidth<768){let e=s(`detailModalPane`);e&&e.classList.contains(`max-w-7xl`)&&typeof window.toggleDetailModalExpand==`function`&&window.toggleDetailModalExpand()}setTimeout(()=>{t.querySelector(`#detailModalPane`)?.classList.remove(`scale-95`,`opacity-0`)},10),r.hasMapData&&setTimeout(()=>{Ge({displayLat:h?h.lat:d?d.lat:u?u.lat:f.lat,displayLng:h?h.lng:d?d.lng:u?u.lng:f.lng,declaredSeg:r.declaredSeg,actualSeg:r.actualSeg,ptStart:u,ptIni:d,ptFin:f,ptMain:h,isFlagged:r.isFlagged,rec:e})},300)}function qe(){let e=s(`detailModal`);e&&(e.querySelector(`#detailModalPane`)?.classList.add(`scale-95`,`opacity-0`),setTimeout(()=>{e.classList.add(`hidden`);let t=s(`detailModalPane`),n=s(`detailModalExpandIcon`),r=s(`detailModalBody`);if(t?.classList.contains(`max-w-none`)&&(t.classList.remove(`w-full`,`max-w-none`,`h-full`,`rounded-none`),t.classList.add(`max-w-7xl`,`w-11/12`,`rounded-2xl`,`p-0`),n&&n.setAttribute(`data-lucide`,`maximize`),r&&(r.classList.remove(`flex-1`,`max-h-none`),r.classList.add(`max-h-[75vh]`))),l.detailMiniMapObj&&=(l.detailMiniMapObj.remove(),null),l.lastFocused?.focus)try{l.lastFocused.focus()}catch{}},300))}var G=c((()=>{m(),e(),Me(),ze(),Ke(),window.toggleDetailModalExpand=function(){let e=s(`detailModalPane`),t=s(`detailModalExpandIcon`),n=s(`detailMapWrapper`),r=s(`detailModalBody`);!e||!t||(e.classList.contains(`max-w-7xl`)?(e.classList.remove(`max-w-7xl`,`w-11/12`,`rounded-2xl`,`p-0`),e.classList.add(`w-full`,`max-w-none`,`h-full`,`rounded-none`),t.setAttribute(`data-lucide`,`minimize`),n&&(n.classList.remove(`h-48`,`sm:h-64`,`md:h-96`),n.classList.add(`h-[60vh]`,`md:h-[75vh]`)),r&&(r.classList.remove(`max-h-[75vh]`),r.classList.add(`flex-1`,`max-h-none`))):(e.classList.remove(`w-full`,`max-w-none`,`h-full`,`rounded-none`),e.classList.add(`max-w-7xl`,`w-11/12`,`rounded-2xl`,`p-0`),t.setAttribute(`data-lucide`,`maximize`),n&&(n.classList.remove(`h-[60vh]`,`md:h-[75vh]`),n.classList.add(`h-48`,`sm:h-64`,`md:h-96`)),r&&(r.classList.remove(`flex-1`,`max-h-none`),r.classList.add(`max-h-[75vh]`))),window.lucide&&window.lucide.createIcons(),l.detailMiniMapObj&&setTimeout(()=>l.detailMiniMapObj.invalidateSize(),350))},window.viewTraceByRecord=function(e){let t=l.rawData.find(t=>t._uuid===e||t.uuid===e);t?W(t):console.warn(`[Modal] Registro con UUID ${e} no encontrado.`)},window.closeDetailModal=qe})),Je,Ye,Xe,Ze,Qe,$e,et=c((()=>{h(),Je=e=>{let t=e.getValue();return`<span style="color:${t===`completada`?`#10B981`:`#F59E0B`};font-weight:700;font-size:10px;letter-spacing:0.02em">${t===`completada`?`EFECTIVA`:`NO EFECTIVA`}</span>`},Ye=e=>{let t=e.getValue();return t===null?`—`:`<span style="color:${t<15?`#EF4444`:t<25?`#F59E0B`:`#10B981`};font-weight:800;font-family:Outfit,sans-serif;">${t}m</span>`},Xe=e=>{let t=e.getValue();return!t||t.length===0?`<span style="color:var(--text-muted);font-size:10px">—</span>`:t.map(e=>{let t=x[e],n=t?t.label:e;return`<span title="${t?t.detail.replace(/\n/g,` `):``}" style="display:inline-flex;align-items:center;gap:3px;background:rgba(239,68,68,0.15);color:#EF4444;border:1px solid rgba(239,68,68,0.3);border-radius:4px;padding:1px 5px;font-size:9px;font-weight:700;letter-spacing:0.02em;margin-right:3px;white-space:nowrap;">⚠ ${n}</span>`}).join(``)},Ze=e=>{let t=e.getData(),n=f.has(t.cedula)?`<span style="background:#3B82F6;color:white;font-size:8px;font-weight:900;padding:1px 4px;border-radius:4px;margin-left:6px;vertical-align:middle;">INE</span>`:``;return`<div><div style="font-weight:800;color:currentColor;font-size:12px;line-height:1.3;">${t.nombre||`Sin Nombre`}${n}</div><div style="font-size:9px;color:#94a3b8;font-weight:600;">${t.cedula||`N/A`}</div></div>`},Qe=e=>{let t=e.getValue(),n=t>=80?`#10B981`:t>=50?`#F59E0B`:`#EF4444`;return`<div style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:4px 0">
...
`}));function tt(e=[]){l.detailTable||(l.detailTable=new Tabulator(`#detailGrid`,{data:e,layout:`fitColumns`,height:`100%`,pagination:!0,paginationSize:25,paginationSizeSelector:[10,25,50,100],movableColumns:!0,responsiveLayout:`collapse`,clipboard:!0,placeholder:`<div style="padding:40px;text-align:center;color:var(--text-muted);font-size:14px;font-family:Inter,sans-serif;">Cargando base de datos...</div>`,columnHeaderVertAlign:`bottom`,columns:[{formatter:`responsiveCollapse`,width:30,minWidth:30,hozAlign:`center`,headerSort:!1,resizable:!1,responsive:0},{title:`Identificación`,frozen:!0,columns:[{title:`Cédula`,field:`cedula`,headerFilter:`input`,minWidth:90,responsive:0},{title:`Nombre`,field:`nombre`,headerFilter:`input`,minWidth:140,responsive:0},{title:`Control`,field:`control`,headerFilter:`input`,width:90,responsive:0}]},{title:`Contexto`,columns:[{title:`Fecha`,field:`fecha`,headerFilter:`input`,width:90,sorter:`date`,responsive:1},{title:`Municipio`,field:`mun`,headerFilter:`input`,width:90,responsive:2},{title:`Parroquia`,field:`par`,headerFilter:`input`,width:90,responsive:4},{title:`Segm.`,field:`segmento`,headerFilter:`input`,width:70,hozAlign:`center`,responsive:4},{title:`Sect.`,field:`sector`,headerFilter:`input`,width:70,hozAlign:`center`,responsive:4}]},{title:`Métricas`,columns:[{title:`Estado`,field:`estado`,width:100,responsive:0,formatter:Je,headerFilter:`list`,headerFilterParams:{valuesLookup:!0,clearable:!0}},{title:`Dur.`,field:`durMin`,width:70,hozAlign:`center`,responsive:2,formatter:Ye},{title:`Alertas`,field:`alertas`,minWidth:160,headerSort:!1,responsive:2,formatter:Xe}]},{title:`Social`,columns:[{title:`Hog.`,field:`hogares`,width:50,hozAlign:`center`,responsive:4},{title:`Pers.`,field:`personas`,width:50,hozAlign:`center`,responsive:4}]},{title:`Acciones`,width:120,headerSort:!1,hozAlign:`center`,responsive:0,formatter:$e,cellClick:(e,t)=>{e.stopPropagation();let n=e.target.closest(`button`);if(!n)return;let r=t.getData()._rec;r&&n.dataset.action===`view`&&W(r)}}],rowFormatter:e=>{let t=e.getData();t.estado===`completada`?e.getElement().classList.add(`row-complete`):t.estado===`no_efectiva`&&e.getElement().classList.add(`row-no-efectiva`),t.hasAlerts&&e.getElement().classList.add(`row-flagged`)}}),l.detailTable.on(`rowClick`,(e,t)=>{let n=t.getData()._rec;n&&W(n)}))}function nt(e=l.filtered){let t=e.map(e=>{let t=e._meta||{};return{_rec:e,id:t.control||e._uuid,cedula:t.cedula||``,nombre:t.nombre||``,control:t.control||``,fecha:t.fecha||``,mun:t.mun||``,par:t.par||``,nodo:t.nodo||``,segmento:t.segmento||``,sector:t.sector||``,estado:t.estado||``,durMin:t.durMin,alertas:t.alertas||[],hasAlerts:t.hasAlerts||!1,hogares:t.hogares||0,personas:t.totalPers||0}});if(!l.detailTable)tt(t);else try{l.detailTable.setData(t)}catch(e){console.warn(`Tabulator setData delayed:`,e.message),setTimeout(()=>l.detailTable&&l.detailTable.setData(t),100)}}var rt=c((()=>{m(),h(),G(),et()}));function it(e){if(console.log(`table.js: renderRankingTable() initializing leaderboard...`),typeof Tabulator>`u`){console.error(`table.js: CRITICAL - Tabulator library is NOT loaded.`);return}if(!document.querySelector(`#rankingTable`))return;if(!e){if(!l.filtered||!l.encMap)return;let t=l.filtered.filter(e=>e&&e._meta),n=new Set(t.map(e=>e._meta.cedula));e=Object.values(l.encMap).filter(e=>n.has(e.cedula));let r={encuestas:(e,t)=>(t.encuestas||0)-(e.encuestas||0),completadas:(e,t)=>(t.completadas||0)-(e.completadas||0),eficiencia:(e,t)=>(t.pctCompleta||0)-(e.pctCompleta||0),personas:(e,t)=>(t.personas||0)-(e.personas||0)};e.sort(r[l.currentSort]||r.eficiencia)}let t=e.map((e,t)=>({pos:t+1,nombre:e.nombre||`Sin Nombre`,cedula:e.cedula||`N/A`,encuestas:e.encuestas||0,completadas:e.completadas||0,pctCompleta:e.pctCompleta||0,personas:e.personas||0}));l.rankingTabulator?l.rankingTabulator.setData(t).then(()=>{l.rankingTabulator.redraw(!0)}):(l.rankingTabulator=new Tabulator(`#rankingTable`,{data:t,layout:`fitColumns`,height:`420px`,responsiveLayout:`collapse`,persistence:!1,placeholder:`<div style="padding:40px;text-align:center;color:#64748b;font-size:13px;font-family:Inter,sans-serif;">Sin datos disponibles</div>`,initialSort:[{column:`pctCompleta`,dir:`desc`}],columns:[{formatter:`responsiveCollapse`,width:30,minWidth:30,hozAlign:`center`,headerSort:!1,resizable:!1,responsive:0},{title:`#`,field:`pos`,width:55,hozAlign:`center`,headerSort:!1,frozen:!0,responsive:0,formatter:e=>`<span style="color:#64748b;font-weight:800;font-size:12px;">${e.getValue()}</span>`},{title:`Encuestador`,field:`nombre`,minWidth:140,frozen:!0,responsive:0,formatter:Ze},{title:`Volumen`,field:`encuestas`,hozAlign:`center`,width:90,sorter:`number`,responsive:0,formatter:e=>`<span style="font-weight:800;color:#3B82F6;font-size:14px">${e.getValue()}</span>`},{title:`% Efectividad`,field:`pctCompleta`,hozAlign:`center`,minWidth:120,sorter:`number`,responsive:0,formatter:Qe},{title:`Pers.`,field:`personas`,hozAlign:`center`,width:70,sorter:`number`,responsive:2,formatter:e=>`<span style="font-weight:600;color:#64748b">${e.getValue()}</span>`}]}),l.rankingTabulator.on(`rowClick`,(e,t)=>{let n=t.getData().cedula,r=document.getElementById(`filterEncuestador`);n&&r&&(r.value=n,typeof S==`function`&&S())}))}var at=c((()=>{m(),R(),et()})),ot=c((()=>{rt(),at(),et()})),st,ct,lt,K,ut=c((()=>{st=`modulepreload`,ct=function(e,t){return new URL(e,t).href},lt={},K=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=ct(t,n),t in lt)return;lt[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:st,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));async function dt(){if(!l.geoJSONData)try{let e=await fetch(`data/segmentos_monagas.geojson`);if(!e.ok)throw Error(`Error loading GeoJSON`);l.geoJSONData=await e.json();let{getPolygonBBox:t}=await K(async()=>{let{getPolygonBBox:e}=await import(`./helpers-CBT32SXN.js`).then(e=>(e.a(),e.i));return{getPolygonBBox:e}},[],import.meta.url);l.segmentBBoxes=l.geoJSONData.features.map(e=>{if(!e.geometry)return null;let n=[];return e.geometry.type===`Polygon`?n=e.geometry.coordinates[0]:e.geometry.type===`MultiPolygon`&&(n=e.geometry.coordinates.flatMap(e=>e[0])),n.length>0?{bbox:t(n),props:e.properties,feature:e}:null}).filter(e=>e!==null),ft()}catch(e){console.error(`FAILED TO LOAD GEOJSON:`,e)}}function ft(){if(!(!l.geoJSONData||!l.map||l.geoJSONLayer))try{l.geoJSONLayer=L.geoJSON(l.geoJSONData,{style:e=>{let t=e.properties,n=_[(`${t.cod_seg===`000`||t.cod_seg===`0`?t.cod_sc||`0`:t.cod_seg||`0`}`.split(``).reduce((e,t)=>e*31+t.charCodeAt(0),0)>>>0)*13%_.length];return{color:n,weight:2,opacity:.8,fillColor:n,fillOpacity:.15}},onEachFeature:(e,t)=>{let n=e.properties,r=n.cod_seg===`000`||n.cod_seg===`0`,i=_[(`${r?n.cod_sc||`0`:n.cod_seg||`0`}`.split(``).reduce((e,t)=>e*31+t.charCodeAt(0),0)>>>0)*13%_.length],a=r?`Sector`:`Segmento`,o=r?n.cod_sc||`N/A`:n.cod_seg||`N/A`;t.bindPopup(Be(a,o,i,n),{className:`custom-popup`}),t.on(`mouseover`,function(){this.setStyle({fillOpacity:.35,weight:3})}),t.on(`mouseout`,function(){this.setStyle({fillOpacity:.15,weight:2})})}}).addTo(l.map),l.layerControl&&l.layerControl.addOverlay(l.geoJSONLayer,`Segmentos Monagas`)}catch(e){console.error(`FAILED TO DRAW GEOJSON LAYER:`,e)}}async function pt(){if(!l.controlsIndex)try{let e=await fetch(`data/CONTROLES.geojson`);if(!e.ok)throw Error(`Error loading CONTROLES.geojson: ${e.status}`);l.controlsData=await e.json(),l.controlsIndex=new Map,l.validControls=new Set,l.validSeries=new Set,l.validLineas=new Set,l.controlDetails=new Map;let t=e=>{if(e==null)return null;let t=parseInt(String(e).trim(),10);return isNaN(t)?null:t};l.controlsData.features.forEach(e=>{let n=e.properties,r=t(n.LINEA),i=t(n.SERIE);if(r===null||i===null)return;let a=String(n.CONTROL||``).trim(),o=String(i),s=String(r);l.validControls.add(a),l.validSeries.add(o),l.validLineas.add(s),l.controlDetails.has(a)||l.controlDetails.set(a,{series:new Set,lineas:new Set}),l.controlDetails.get(a).series.add(o),l.controlDetails.get(a).lineas.add(s),l.controlsIndex.set(`${a}-${o}-${s}`,{COD_SEG:String(n.COD_SEG??``).trim(),COD_MANZA:String(n.COD_MANZA??``).trim()})}),l.map&&mt()}catch(e){console.error(`FAILED TO LOAD CONTROLES.geojson:`,e)}}function mt(){if(!(!l.controlsData||!l.map))try{l.controlsLayer&&(l.controlsLayer.remove(),l.layerControl&&l.layerControl.removeLayer(l.controlsLayer)),l.controlsLayer=L.geoJSON(l.controlsData,{pointToLayer:(e,t)=>L.circleMarker(t,{radius:3.5,fillColor:`#38BDF8`,color:`#ffffff`,weight:1,opacity:.9,fillOpacity:.85}),onEachFeature:(e,t)=>{t.bindTooltip(Ve(e.properties),{sticky:!0,opacity:.95})}}),l.layerControl&&l.layerControl.addOverlay(l.controlsLayer,`Viviendas`)}catch(e){console.error(`FAILED TO DRAW CONTROLS LAYER:`,e)}}var ht=c((()=>{m(),h(),U(),ut()}));function gt(){if(l.map)return;let e=L.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`&copy; OpenStreetMap contributors`}),t=L.tileLayer(`https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}`,{maxZoom:20,subdomains:[`mt0`,`mt1`,`mt2`,`mt3`],attribution:`&copy; Google`});l.map=L.map(`mapView`,{center:[10.4806,-66.8983],zoom:12,layers:[e],zoomControl:!1});let n={OpenStreetMap:e,"Google Satélite":t};l.layerControl=L.control.layers(n,{},{collapsed:window.innerWidth<768}).addTo(l.map),L.control.scale().addTo(l.map),l.markerCluster=L.markerClusterGroup({showCoverageOnHover:!1,zoomToBoundsOnClick:!0,spiderfyOnMaxZoom:!0}),l.map.addLayer(l.markerCluster),ft(),mt()}var _t=c((()=>{m(),ht()}));function vt(){l.agentRouteLayer&&=(l.map.removeLayer(l.agentRouteLayer),null)}function yt(e){if(vt(),!e||!l.map)return;let t=l.filtered.filter(t=>t._meta?.cedula===e&&t._meta.lat&&t._meta.lng).sort((e,t)=>new Date(e.start||0).getTime()-new Date(t.start||0).getTime());if(t.length===0)return;let n=s(`mapRouteAgentCount`);n&&(n.textContent=`${t.length} ptos`);let r=t.map(e=>[e._meta.lat,e._meta.lng]),i=[];i.push(L.polyline(r,{color:`#F97316`,weight:2.5,opacity:.85,dashArray:`6 4`})),t.forEach((e,t)=>{let n=e._meta,r=t+1,a=(e.start||``).slice(11,16)||`—`,o=n.durMin===null?`—`:`${Math.round(n.durMin)} min`,s=L.divIcon({className:``,html:Ue(r),iconSize:[22,22],iconAnchor:[11,11]}),c=L.marker([n.lat,n.lng],{icon:s});c.bindTooltip(We(r,a,n,o),{sticky:!0,opacity:.97}),c.on(`click`,()=>W(e)),i.push(c)}),l.agentRouteLayer=L.layerGroup(i).addTo(l.map);let a=L.latLngBounds(r);a.isValid()&&l.map.fitBounds(a,{padding:[60,60]})}function bt(){let e=document.getElementById(`filterEncuestador`),t=document.getElementById(`btnVerRutaEncuestador`),n=document.getElementById(`mapRouteAgentCount`);if(!e||!t||t._verRutaAttached)return;t._verRutaAttached=!0;let r=()=>{let r=!!e.value,i=r?l.filtered.filter(t=>t._meta?.cedula===e.value&&t._meta.lat&&t._meta.lng).length:0;if(t.disabled=!r,n&&(n.textContent=r&&i?`${i} pts`:`—`),!r){vt(),t.dataset.routeActive=`0`,t.classList.remove(`bg-brand-orange/20`,`border-brand-orange`);let e=t.querySelector(`.route-label`);e&&(e.textContent=`Ver Ruta`),l.map&&l.markerCluster&&!l.map.hasLayer(l.markerCluster)&&l.map.addLayer(l.markerCluster)}};r(),e.addEventListener(`change`,r),document.addEventListener(`filtersApplied`,r),t.addEventListener(`click`,()=>{let r=e.value;if(r)if(t.dataset.routeActive===`1`){vt(),t.dataset.routeActive=`0`,l.map&&l.markerCluster&&!l.map.hasLayer(l.markerCluster)&&l.map.addLayer(l.markerCluster),t.classList.remove(`bg-brand-orange/20`,`border-brand-orange`);let e=l.filtered.filter(e=>e._meta?.cedula===r&&e._meta.lat&&e._meta.lng).length;n&&(n.textContent=`${e} pts`);let i=t.querySelector(`.route-label`);i&&(i.textContent=`Ver Ruta`)}else{let e=document.querySelector(`[data-tab="tab-mapa"]`);e&&e.click(),setTimeout(()=>{yt(r),t.dataset.routeActive=`1`,l.map&&l.markerCluster&&l.map.hasLayer(l.markerCluster)&&l.map.removeLayer(l.markerCluster),t.classList.add(`bg-brand-orange/20`,`border-brand-orange`);let e=l.filtered.filter(e=>e._meta?.cedula===r&&e._meta.lat&&e._meta.lng).length;n&&(n.textContent=`${e} pts`);let i=t.querySelector(`.route-label`);i&&(i.textContent=`Ocultar Ruta`)},200)}})}var xt=c((()=>{m(),e(),R(),G(),U()}));function St(){if(!l.map||!l.markerCluster)return;l.markerCluster.clearLayers();let e=l.filtered.filter(e=>e._meta.lat&&e._meta.lng),t=e.filter(e=>e._meta&&e._meta.estado===`completada`).length,n=e.length-t,r=new Set(e.map(e=>e._meta.cedula)).size,i=e.filter(e=>e._meta.hasAlerts).length,a=new Set(e.map(e=>e._meta.mun).filter(e=>e&&e!==`N/A`)),o=new Set(e.map(e=>e._meta.par).filter(e=>e&&e!==`N/A`)),c=new Set(e.map(e=>e._meta.nodo).filter(e=>e&&e!==`N/A`));s(`mapKpiPoints`)&&(s(`mapKpiPoints`).textContent=e.length),s(`mapKpiComplete`)&&(s(`mapKpiComplete`).textContent=t),s(`mapKpiNoEfectiva`)&&(s(`mapKpiNoEfectiva`).textContent=n),s(`mapKpiAgents`)&&(s(`mapKpiAgents`).textContent=r),s(`mapKpiAlertas`)&&(s(`mapKpiAlertas`).textContent=i);let u=s(`mapCoverageBadge`);u&&e.length>0&&(u.classList.remove(`hidden`),s(`mapMunCount`)&&(s(`mapMunCount`).textContent=a.size),s(`mapParCount`)&&(s(`mapParCount`).textContent=o.size),s(`mapNodoCount`)&&(s(`mapNodoCount`).textContent=c.size));let d=e.map(e=>{let t=e._meta,n=t.estado===`completada`,r=t.hasAlerts,i=t.alertas||[],a,o,s;if(r){a=`#EF4444`,o=`#DC2626`;let e=x[i[0]];s=`⚠ ${e?e.label:`Alerta`}${i.length>1?` +${i.length-1}`:``}`}else n?(a=`#10B981`,o=`#059669`,s=`Efectiva`):(a=`#F59E0B`,o=`#D97706`,s=`No Efectiva`);let c=t.durMin===null?`—`:`${Math.round(t.durMin)} min`,l=t.distance_m===null?`—`:`${Math.round(t.distance_m)} m`,u=He(t,e._uuid,a,o,s,i,c,l);return L.circleMarker([t.lat,t.lng],{radius:7,fillColor:a,color:o,weight:2,opacity:.9,fillOpacity:.7}).bindPopup(u,{className:`custom-popup`,maxWidth:320})});if(l.markerCluster.addLayers(d),document.getElementById(`btnVerRutaEncuestador`)?.dataset?.routeActive===`1`){l.map.hasLayer(l.markerCluster)&&l.map.removeLayer(l.markerCluster);let e=document.getElementById(`filterEncuestador`);e&&e.value&&yt(e.value)}else if(d.length>0){let e=l.markerCluster.getBounds();e.isValid()&&l.map.fitBounds(e,{padding:[50,50]})}window.lucide&&lucide.createIcons()}var Ct=c((()=>{m(),e(),R(),h(),U(),xt(),window.setQuickFilter=function(e){l.quickFilterMode=e,Object.entries({all:{id:`btnMapFilterAll`,active:[`bg-brand-blue/10`,`dark:bg-brand-blue/20`,`border-brand-blue`,`ring-brand-blue/30`],inactive:`border-brand-blue`},efectivas:{id:`btnMapFilterEfectivas`,active:[`bg-brand-emerald/10`,`dark:bg-brand-emerald/20`,`border-brand-emerald`,`ring-brand-emerald/30`],inactive:`border-brand-emerald`},no_efectiva:{id:`btnMapFilterNoEfectiva`,active:[`bg-brand-orange/10`,`dark:bg-brand-orange/20`,`border-brand-orange`,`ring-brand-orange/30`],inactive:`border-brand-orange`},alertas:{id:`btnMapFilterAlertas`,active:[`bg-brand-red/10`,`dark:bg-brand-red/20`,`border-brand-red`,`ring-brand-red/30`],inactive:`border-brand-red`}}).forEach(([t,n])=>{let r=s(n.id);r&&(r.classList.remove(`bg-brand-blue/10`,`dark:bg-brand-blue/20`,`border-brand-blue`,`ring-brand-blue/30`,`bg-brand-emerald/10`,`dark:bg-brand-emerald/20`,`border-brand-emerald`,`ring-brand-emerald/30`,`bg-brand-orange/10`,`dark:bg-brand-orange/20`,`border-brand-orange`,`ring-brand-orange/30`,`bg-brand-red/10`,`dark:bg-brand-red/20`,`border-brand-red`,`ring-brand-red/30`,`ring-1`,`shadow-md`,`border-slate-400`),t===e?r.classList.add(...n.active,`ring-1`,`shadow-md`):r.classList.add(n.inactive))}),S()}})),wt=c((()=>{_t(),ht(),Ct(),xt()}));function q(e){if(typeof Tabulator>`u`){console.error(`Tabulator not found`);return}let t=(e||[]).map((e,t)=>{let n=[];e[`S1/P_nomsect`]&&n.push(e[`S1/P_nomsect`]);for(let t=1;t<=4;t++){let r=e[`S1/G_P9/gp10_${t}_etiq`],i=e[`S1/G_P9/GP10_${t}b`];r&&i&&n.push(`${r} ${i}`)}let r=e[`control_de_la_entrevista/in10`]||e[`control_entrevista/in10`];r&&n.push(`Nro: ${r}`);let i=e[`control_de_la_entrevista/in11`]||e[`control_entrevista/in11`];i&&n.push(`Ref: ${i}`);let a=n.length>0?n.join(`, `):e[`S1/direccion`]||e._meta.nota||`-`;return{linea:e[`group_sh53u78/n_linea`]||t+1,serie:e[`group_sh53u78/n_serie`]||`-`,manzana:e[`S1/manzana`]||`-`,parcela:e[`S1/parcela`]||`-`,edificacion:e[`S1/Edificaci_n`]||e[`S1/edificacion`]||`-`,estructura:e[`S1/estructura`]||e[`S1/unidad`]||`-`,uso:e[`S1/Uso_de_la_Unidad_inmobiliaria`]||e._meta.uso||`-`,ladoManz:e[`S1/lado_manz`]||`-`,direccion:a,razon:e[`Condici_n_de_ocupaci_n/condicion_de_ocupacion`]||e._meta.condicion||`-`,encuestador:e._meta.nombre?e._meta.nombre.split(` `)[0]:`N/A`}});t.sort((e,t)=>parseInt(e.linea)-parseInt(t.linea)),l.mm111Table?l.mm111Table.setData(t).then(()=>{l.mm111Table.redraw(!0)}):Tt(t)}function Tt(e){l.mm111Table=new Tabulator(`#mm111Grid`,{data:e,layout:`fitColumns`,height:`100%`,responsiveLayout:`collapse`,placeholder:`<div class='p-12 text-center text-slate-400 font-medium'>Seleccione un número de Control para visualizar el listado de las encuestas.</div>`,columns:[{title:`Línea`,field:`linea`,width:65,hozAlign:`center`,frozen:!0,formatter:e=>`<span class="font-mono font-bold text-slate-700 dark:text-slate-200">${e.getValue()}</span>`},{title:`Serie`,field:`serie`,width:60,hozAlign:`center`,formatter:e=>`<span class="font-mono opacity-70">${e.getValue()}</span>`},{title:`Manz.`,field:`manzana`,width:65,hozAlign:`center`},{title:`Parc.`,field:`parcela`,width:65,hozAlign:`center`},{title:`Edif.`,field:`edificacion`,width:65,hozAlign:`center`},{title:`Estr.`,field:`estructura`,width:65,hozAlign:`center`},{title:`Uso de la Unidad`,field:`uso`,minWidth:120,formatter:Et},{title:`Lado Manz.`,field:`ladoManz`,width:90,hozAlign:`center`},{title:`Dirección`,field:`direccion`,minWidth:250,formatter:`textarea`},{title:`Razón Inclusión`,field:`razon`,minWidth:180,formatter:Dt},{title:`Encuestador`,field:`encuestador`,width:100,hozAlign:`center`,formatter:e=>`<span class="text-[10px] font-black uppercase text-slate-400 tracking-wider">${e.getValue()}</span>`}]})}function Et(e){let t=String(e.getValue()).toUpperCase(),n=v.DEFAULT;for(let e in v)if(t.includes(e)){n=v[e];break}return`<span class="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-tight ${n.badge}">${t}</span>`}function Dt(e){let t=String(e.getValue()).toUpperCase(),n=t.replace(/_/g,` `),r=b.DEFAULT;for(let e in b)if(t.includes(e)){r=b[e];break}return`<span class="px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-tight ${r.badge}">${n}</span>`}function Ot(){[`mm111Entidad`,`mm111Municipio`,`mm111Parroquia`,`mm111CPoblado`].forEach(e=>{s(e)&&(s(e).textContent=`---`)}),[`mm111EntidadCod`,`mm111MunicipioCod`,`mm111ParroquiaCod`,`mm111CPobladoCod`].forEach(e=>{s(e)&&(s(e).textContent=`--`)}),[`mm111Segmento`,`mm111Sector`,`mm111Nodo`,`mm111Semana`,`mm111ControlMaestro`,`mm111Lote`].forEach(e=>{s(e)&&(s(e).textContent=`-`)}),s(`mm111ControlNro`)&&(s(`mm111ControlNro`).textContent=`0000`)}function kt(e,t){let n=s(`mm111ResultsList`);n&&(e.length>0?n.innerHTML=e.map((e,t)=>`
        ...
        </div>`}function Bt(e,t,n){let r=x[e]||{label:e},i=Vt[e]||{bg:`#64748b22`,border:`#64748b`,text:`#64748b`},a=n===e,o=a?`ring-2 ring-offset-1 dark:ring-offset-[#0B1120]`:``,s=a?`ring-color: ${i.border}; border-color: ${i.border};`:`border-color:${i.border}30;`;return`
