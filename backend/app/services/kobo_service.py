...
class KoboService:
    ...
    async def get_assets():
        ...
        # Nota: verify=False se usa para evitar problemas con certificados de servidores Kobo privados
    ...
    async def get_asset_data(asset_uid: str):
        """
        Descarga TODAS las respuestas de un formulario, siguiendo la paginación automáticamente.
        """
